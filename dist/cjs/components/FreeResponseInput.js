...
const ResponseInfoRow = ({ submissionTimestamp, draftTimestamp, wordCount, wordLimit }) => {
    ...
    const status = showDraft
        ? `Draft last saved ${(0, utils_1.formatTimestamp)(draftTimestamp)}`
        : submissionTimestamp !== undefined
            ? `Last submitted on ${(0, utils_1.formatTimestamp)(submissionTimestamp)}`
            : undefined;
    return ((0, jsx_runtime_1.jsxs)(InfoRow, { hasChildren: !!status, children: [status && (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)("span", { className: "last-submitted", children: status }) }), (0, jsx_runtime_1.jsxs)("div", { children: [wordCount >= wordLimit && (0, jsx_runtime_1.jsx)("span", { className: "word-limit-error-info", children: "Word limit reached" }), (0, jsx_runtime_1.jsxs)("span", { children: [" Remaining words: ", wordLimit - wordCount] })] })] }));
};
const FreeResponseInput = (props) => {
    var _a;
    const { is_completed, canAnswer, needsSaved, apiIsPending, free_response, submittedResponse, onAnswerChange, onAnswerSave, onNextStep, questionNumber, question, wordLimit, score, feedback_html, submissionTimestamp, draftTimestamp, cancelHandler, previewMode = false, onGradingSave, gradingTimestamp, } = props;
    ...
    const [originalSubmittedValue, setOriginalSubmittedValue] = (0, react_1.useState)((_a = submittedResponse !== null && submittedResponse !== void 0 ? submittedResponse : free_response) !== null && _a !== void 0 ? _a : '');
    ...
    (0, react_1.useLayoutEffect)(() => {
        ...
        if (isUpdateMode && !needsSaved) {
            setOriginalSubmittedValue((_a = submittedResponse !== null && submittedResponse !== void 0 ? submittedResponse : free_response) !== null && _a !== void 0 ? _a : '');
        }
