...
const FreeResponseInput = (props) => {
    ...
    const [lastSettledValue, setLastSettledValue] = (0, react_1.useState)(free_response || '');
    ...
    const originalSubmittedValue = submittedResponse !== null && submittedResponse !== void 0 ? submittedResponse : lastSettledValue;
