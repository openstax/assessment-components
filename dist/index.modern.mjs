...
`),Z.stepCardPadding(),B.card.body.background,((...e)=>s(T||(T=V`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(he||(he=fe`
    ...
    `),"8px")),$e=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:i,stepType:o,isHomework:s,availablePoints:l,unpadded:d,className:c,children:p,questionId:m,multipartBadge:h,leftHeaderChildren:u,rightHeaderChildren:b,headerTitleChildren:f}=r,g=_(r,re);return t(we,C({},g,{children:[h,t(ge,{className:c,children:[n&&s&&"exercise"===o&&t(xe,{children:[t("div",{children:[u,t("div",{className:"question-info",children:[f,e("span",{children:a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`}),i?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",m]})]})]}),t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]})]}),e(ve,{unpadded:d,children:p})]})]}))};$e.displayName="OSStepCard";const ye=t=>{let{step:r,questionNumber:a,numberOfQuestions:i,children:o,className:s}=t,l=_(t,ne);return e($e,C({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:i,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,availablePoints:r.available_points,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:o}))};ye.displayName="OSTaskStepCard";const ke=["disabled","isWaiting","waitingText","children"];let Ce;const _e=o.button(Ce||(Ce=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),B.palette.neutral,B.palette.neutralDark,e=>e.isOverWordLimit&&Ze,e=>e.isOverWordLimit&&s(De||(De=We`
    border: 2px solid ${0};
  `),B.palette.danger),e=>e.readOnly&&B.palette.neutralCool);Xe.displayName="OSFreeResponseTextArea";const et=t=>e(Ne,C({},t,{children:"Cancel"})),tt=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:i,infoRowChildren:o,isSubmitDisabled:s,pointsChildren:l,question:d,questionNumber:c,saveHandler:p,submitBtnLabel:m,textHasChanged:h,wordLimit:u}=r,b=k(i)>u,f={};return c&&(f["data-question-number"]=c),t(Ge,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(Ke,C({},f,{children:d.stem_html&&e(je,{type:"stem",html:d.stem_html,hidden:!1})})),e(Xe,C({},r,{isOverWordLimit:b,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(Ye,{hasChildren:!!o,children:[o,t("div",{children:[t("span",{children:[k(i)," words"]}),b&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(Qe,{children:[t("div",{className:"points",children:[t("strong",{children:["Points: ",n]}),l]}),t("div",{className:"controls",children:[e(et,{disabled:!h,onClick:a}),e(Ne,{"data-test-id":"submit-answer-btn",disabled:s||b,onClick:p,children:m})]})]})]})};tt.displayName="OSFreeResponse";let rt,nt,at,it,ot,st=e=>e;const lt=o.div(rt||(rt=st`
