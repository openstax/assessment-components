import{jsx as e,jsxs as t,Fragment as r}from"react/jsx-runtime.js";import n from"classnames";import a,{useRef as o,useState as i,useCallback as s,useEffect as l,createElement as c}from"react";import d,{css as p,createGlobalStyle as m}from"styled-components";import u from"scroll-to-element";import{debounce as h,once as b}from"lodash";import{memoize as f,isEmpty as g}from"lodash/fp.js";import w from"weak-map";import{FontAwesomeIcon as x}from"@fortawesome/react-fontawesome";import{faBookOpen as v,faTriangleExclamation as $,faQuestion as k,faPlus as y,faMinus as C,faEllipsisH as _}from"@fortawesome/free-solid-svg-icons";import{faBookOpen as N}from"@fortawesome/free-solid-svg-icons/faBookOpen";import{faTriangleExclamation as q}from"@fortawesome/free-solid-svg-icons/faTriangleExclamation";import{faCircleInfo as S}from"@fortawesome/free-solid-svg-icons/faCircleInfo";import{faCheck as A}from"@fortawesome/free-solid-svg-icons/faCheck";import{faXmark as I}from"@fortawesome/free-solid-svg-icons/faXmark";import{BulletList as M}from"react-content-loader";function E(){return E=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},E.apply(this,arguments)}function H(e,t){if(null==e)return{};var r,n,a={},o=Object.keys(e);for(n=0;n<o.length;n++)t.indexOf(r=o[n])>=0||(a[r]=e[r]);return a}const T="ABCDEFGHIJKLMNOPQRSTUVWXYZ",O=(e,t)=>e.id===t;function z(e){const t=e.trim().match(/\b[-?(\w+)?]+\b/gi);return t?t.length:0}const j=a.createContext(()=>{throw new Error("context not initialized")}),F=["html","component","block"],P=t=>{let{html:r,component:n,block:o=!1}=t,i=H(t,F);const s=a.useContext(j);return a.useEffect(()=>{s()},[s,r]),void 0!==n?a.cloneElement(n,E({html:r},i)):e(o?"div":"span",E({dangerouslySetInnerHTML:{__html:r}},i))},L=["id"],R=t=>e("aside",{children:e(P,{component:t.contentRenderer,className:n("question-feedback-content","has-html",t.className),html:t.children,block:!0})}),B=r=>{let{id:a}=r,o=H(r,L);const i=n("question-feedback",o.position||"bottom");return t("aside",{id:a,className:i,children:[e("div",{className:"arrow","aria-label":"Answer Feedback"}),e(R,E({},o,{children:o.children}))]})};let D,V,J,Q,U,W,Z,G,K,Y,X,ee,te,re=e=>e;const ne={red:"#ca2026",danger:"#c2002f",darkRed:"#c22032",lightRed:"#e298a0",green:"#77af42",lightGreen:"#8bc753",darkGreen:"#63a524",paleYellow:"#ffffbb",teal:"#0dc0de",blue:"#007da4",mediumBlue:"#026AA1",lightBlue:"#34bdd8",neutralLightBlue:"#0dc0dc",tangerine:"#ffbd3e",gray:"#5e5e5e",darkGray:"#757575",pale:"#d5d5d5",light:"#e4e4e4",white:"#ffffff",neutralLightest:"#f9f9f9",neutralCool:"#f6f7f8",neutralBright:"#f5f5f5",neutralLighter:"#f1f1f1",neutralLight:"#e5e5e5",neutralMedium:"#a0a0a0",neutral:"#818181",neutralThin:"#6f6f6f",neutralDark:"#5f6163",neutralFeedback:"#555",neutralDarker:"#424242",black:"#000000",orange:"#D4450C"},ae={palette:ne,answer:{neutral:ne.neutralThin,hover:"#026AA1",checked:"#026AA1",correct:"#0D7741",incorrect:"#C22032"},popover:{arrowOuterColor:"rgba(0, 0, 0, 0.25)",borderColor:"rgba(0, 0, 0, 0.2)"},card:{header:{background:"#daf3f8"},body:{background:"#fdfdfd"}},button:{background:ne.orange,backgroundHover:"#E74B0D",backgroundActive:"#C5400B"},freeResponse:{color:ne.neutralDarker,background:ne.neutralLighter}},oe=(...e)=>p(D||(D=re`@media(max-width: ${0}px) { ${0} }`),600,p(...e)),ie=(...e)=>p(V||(V=re`@media(max-width: ${0}px) { ${0} }`),999,p(...e)),se=(...e)=>p(J||(J=re`@media(min-width: ${0}px) { ${0} }`),1e3,p(...e)),le={answer:()=>p(U||(U=re`
    .answer-label {
      display: inline-flex;
    }
    color: ${0};
...
`),"2rem",oe(Ce||(Ce=Te`
  ...
  ${0}
`),ae.card.header.background,ae.palette.gray,se(Ne||(Ne=Te`
  ...
  `),"8px","8px"));je.displayName="StepCardHeader";const Fe=d.div(Ae||(Ae=Te`
  .step-card-body {
    ${0}
    overflow: auto;
    background: ${0};
...
`),le.stepCardPadding(),ae.card.body.background,((...e)=>p(Q||(Q=re`@media(max-width: ${0}px) { ${0} }`),600,p(...e)))(Ie||(Ie=Te`
        && .question-feedback {
            margin-left: 0;
    ...
    z-index: 2;
`)),Le=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:c,stepType:d,isHomework:p,availablePoints:m,unpadded:u,className:h,children:b,questionId:f,multipartBadge:g,leftHeaderChildren:w,rightHeaderChildren:x,headerTitleChildren:v,overlayChildren:$}=r,k=H(r,xe);const y=o(null),[C,_]=i(!1),N=a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`,q=s(()=>{_(!0)},[]),S=s(()=>{var e;Array.from((null==(e=document.getElementById("step-card"))?void 0:e.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'))||[]).forEach(e=>{e.setAttribute("tabindex","-1")})},[]);return l(()=>{const e=y.current;return e&&$&&(e.addEventListener("focus",q),S()),()=>{null==e||e.removeEventListener("focus",q)}},[$,y,q,S]),t(ze,E({},k,{children:[g,e(Oe,{className:h,children:t("div",E({ref:y},$?{onMouseOver:()=>_(!0),onMouseLeave:()=>_(!1),onBlur:e=>{y.current&&!y.current.contains(e.relatedTarget)&&_(!1)},tabIndex:0}:{},{children:[$&&C&&e(Pe,{id:"overlay-element",children:$}),t("div",{id:"step-card",children:[n&&p&&"exercise"===d&&t(je,{className:"step-card-header",children:[t("div",{children:[w,t("h2",{className:"question-info",children:[v,e("span",{children:N}),c?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",f]})]})]}),m||x?t("div",{children:[m&&t("div",{className:"points",children:[m," Points"]}),x]}):null]}),e(Fe,{unpadded:u,children:b})]})]}))})]}))};Le.displayName="OSStepCard";const Re=t=>{let{step:r,questionNumber:a,numberOfQuestions:o,children:i,className:s,overlayChildren:l}=t,c=H(t,ve);return e(Le,E({},c,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,overlayChildren:l,children:i}))};Re.displayName="OSTaskStepCard";const Be=["disabled","isWaiting","waitingText","children"];let De;const Ve=d.button(De||(De=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),ae.button.background,ae.palette.white,ae.button.backgroundHover,ae.button.backgroundActive),Je=t=>{const{disabled:r,isWaiting:n,waitingText:a,children:o}=t,i=H(t,Be);return e(Ve,E({},i,{disabled:n||r,children:n&&a||o}))};let Qe,Ue,We,Ze,Ge=e=>e;const Ke=m(Qe||(Qe=Ge`
  :root {
...
`),ae.palette.neutral,ae.palette.neutralDark,e=>e.isOverWordLimit&&wt,e=>e.isOverWordLimit&&p(ft||(ft=gt`
    border: 2px solid ${0};
  `),ae.palette.danger),e=>e.readOnly&&ae.palette.neutralCool);kt.displayName="OSFreeResponseTextArea";const yt=t=>e(Je,E({},t,{children:"Cancel"})),Ct=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:o,infoRowChildren:i,isSubmitDisabled:s,question:l,questionNumber:c,saveHandler:d,submitBtnLabel:p,textHasChanged:m,wordLimit:u}=r,h=z(o)>u,b={};return c&&(b["data-question-number"]=c),t(xt,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(vt,E({},b,{children:l.stem_html&&e(at,{type:"stem",html:l.stem_html,hidden:!1})})),e(kt,E({},r,{isOverWordLimit:h,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t($t,{hasChildren:!!i,children:[i,t("div",{children:[t("span",{children:[z(o)," words"]}),h&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(dt,{children:[n?e("div",{className:"points",role:"status",children:t("strong",{children:["Points: ",n]})}):null,t("div",{className:"controls",children:[e(yt,{disabled:!m,onClick:a}),e(Je,{"data-test-id":"submit-answer-btn",disabled:s||h,onClick:d,children:p})]})]})]})};Ct.displayName="OSFreeResponse";const _t=({count:e})=>t("div",{children:[e," attempt",1===e?"":"s"," left"]}),Nt=({published_comments:r})=>r?t("div",{children:[e("strong",{children:"Feedback:"})," ",r]}):null,qt=t=>e(Je,E({},t,{waitingText:"Saving…",isWaiting:t.isWaiting,"data-test-id":"submit-answer-btn",children:t.willContinue?"Submit & continue":0==t.attempt_number?"Submit":"Re-submit"})),St=t=>e(Je,E({},t,{"data-test-id":"continue-btn",children:t.canUpdateCurrentStep?"Continue":"Next"})),At=({free_response:t})=>t?e(r,{children:e("div",{className:"free-response",children:t})}):null,It=a.forwardRef((r,n)=>{const{question:o,task:i,answer_id_order:s,onAnswerChange:l,feedback_html:c,correct_answer_feedback_html:d,is_completed:p,correct_answer_id:m,incorrectAnswerId:u,choicesEnabled:h,questionNumber:b,answer_id:f,hasMultipleAttempts:g,attempts_remaining:w,published_comments:x,detailedSolution:v,canAnswer:$,needsSaved:k,attempt_number:y,apiIsPending:C,onAnswerSave:_,onNextStep:N,canUpdateCurrentStep:q,displaySolution:S,available_points:A,free_response:I,show_all_feedback:M,tableFeedbackEnabled:E,hasFeedback:H}=r,[T,O]=a.useState(!1);return a.useEffect(()=>{T&&p&&(N(b-1),O(!1))},[N,b,T,p]),t("div",{"data-test-id":"student-exercise-question",children:[e(nt,{ref:n,task:i,question:o,answerIdOrder:s,choicesEnabled:h,answer_id:f,questionNumber:b,onChange:l,feedback_html:c,correct_answer_feedback_html:d,correct_answer_id:p?m:null,incorrectAnswerId:u,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:S,show_all_feedback:M,tableFeedbackEnabled:E,children:e(At,{free_response:I})}),e(dt,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[t("div",{className:"points",role:"status",children:[A?t("strong",{children:["Points: ",A]}):null,e("span",{className:"attempts-left",children:g&&w>0&&e(_t,{count:w})}),e(Nt,{published_comments:x}),v&&t("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(P,{html:v})]})]}),e("div",{className:"controls",children:$&&k||T?e(qt,{disabled:C||!f||T,isWaiting:C||T,attempt_number:y,onClick:()=>{var e;_("string"==typeof(e=o.id)?parseInt(e,10):e),H||O(!0)},willContinue:!H}):e(St,{onClick:()=>N(b-1),canUpdateCurrentStep:q})})]})})]})}),Mt={extensions:[],showProcessingMessages:!1,skipStartupTypeset:!0,styles:{"#MathJax_MSIE_Frame":{left:"",right:0,visibility:"hidden"},"#MathJax_Message":{left:"",right:0,visibility:"hidden"}},tex2jax:{displayMath:[["‌‌‌","‌‌‌"]],inlineMath:[["​​​","​​​"]]}},Et=e=>{const t=(e=>Array.from(e.querySelectorAll(".MathJax math")))(e);return Array.from(e.querySelectorAll("math")).filter(e=>-1===t.indexOf(e))},Ht=e=>{const t=[];for(const r of Array.from(e.querySelectorAll("[data-math]:not(.math-rendered)"))){const e=r.getAttribute("data-math");r.classList.contains("math-marked")||(r.textContent="div"===r.tagName.toLowerCase()?`‌‌‌${e}‌‌‌`:`​​​${e}​​​`,r.classList.add("math-marked")),t.push(r)}return t},Tt=(e,t,r=5)=>{r>0&&(Ht(e).length||Et(e).length)?setTimeout(()=>{Tt(e,t,r-1)},200):t()},Ot=(e,t)=>new Promise(r=>{(function(e,t){const r=Ht(e);t.MathJax.Hub.Queue(((e,t)=>()=>{g(e)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e),(e=>()=>{const t=[];for(const r of e)t.push(r.className+=" math-rendered")})(e))})(r,t),((e,t)=>()=>{const r=Et(e);g(r)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e))})(e,t))})(e,t),t.MathJax.Hub.Queue(()=>{Tt(e,r)})}),zt=f((e,t)=>h(Ot,100,{leading:!0,trailing:!1}).bind(null,e,t));zt.cache=new w;const jt=b((e=window)=>new Promise(t=>{const r=()=>{e.MathJax.HTML.Cookie.prefix="mathjax",e.MathJax.Hub.Configured(),e.MathJax.Hub.Register.StartupHook("End",()=>{t()})};if(!document.getElementById("MathJax-Script")){const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&delayStartupUntil=configured",e.id="MathJax-Script",e.async=!0,document.head.appendChild(e)}e.MathJax&&e.MathJax.Hub?(e.MathJax.Hub.Config(Mt),e.MathJax.Hub.processSectionDelay=0,r()):(Mt.AuthorInit=r,e.MathJax=Mt)}));let Ft,Pt,Lt,Rt,Bt,Dt=e=>e;const Vt=d.div(Ft||(Ft=Dt`
  position: absolute;
  background: #fff;
  width: 4.5rem;
  border: 1px solid ${0};
  ...
  ${0}
`),ae.palette.light,"2rem","2rem",ae.palette.neutral,ae.palette.neutralDarker,ae.palette.neutralDarker,e=>!e.desktop&&p(Pt||(Pt=Dt`
    ${0}
    ${0}
  `),se(Lt||(Lt=Dt`
      display: none;
  ...
  `),ae.palette.neutral,ae.palette.light)),Jt=({icons:r})=>{var n,a;if(!r)return null;const o=Object.values(r),i=o.some(({location:e})=>{var t,r;return null==(t=null==e||null==(r=e.toolbar)?void 0:r.mobile)||t}),s=o.some(({location:e})=>{var t,r;return null!=(t=null==e||null==(r=e.toolbar)?void 0:r.desktop)&&t}),l=null==(n=r.topic)?void 0:n.url,c=null==(a=r.errata)?void 0:a.url;return t(Vt,E({},{mobile:i,desktop:s},{children:[l?t("a",{href:l,target:"_blank",children:[e(x,{icon:v}),e("span",{children:"View topic in textbook"})]}):null,c?t("a",{href:c,target:"_blank",children:[e(x,{icon:$}),e("span",{children:"Suggest a correction"})]}):null]}))};let Qt,Ut,Wt,Zt,Gt,Kt,Yt,Xt,er,tr=e=>e;const rr=d.div(Qt||(Qt=tr`
...
`)),Dr="box-shadow: 0px 1px 4px 0px #00000066;",Vr=d.button(jr||(jr=Lr`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",ae.palette.neutralDarker,e=>e.isActive?p(Fr||(Fr=Lr`
  ...
  `),Dr):null,e=>(e=>{switch(e){case"isStatus":return p(Hr||(Hr=Lr`
        background-color: ${0};
      `),ae.palette.neutralBright);case"isCorrect":return p(Tr||(Tr=Lr`
        color: ${0};
      ...
      `),ae.answer.incorrect);default:return p(zr||(zr=Lr`
        background-color: ${0};
      `),ae.palette.neutralBright)}})(e.variant),Dr),Jr=d(x)(Pr||(Pr=Lr`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Qr=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t&&"isIncomplete"!==t)return null;const r={isCorrect:{icon:A,color:ae.answer.correct,label:"Correct"},isIncorrect:{icon:I,color:ae.answer.incorrect,label:"Incorrect"},isIncomplete:{icon:k,color:ae.answer.neutral,label:"Incomplete"}}[t];return e(Jr,{icon:r.icon,color:r.color,height:"16px",width:"16px","aria-label":r.label,"aria-hidden":void 0})},Ur=({index:r,isActive:n,step:a,goToStep:o})=>t(Br,{children:[e(Vr,{variant:a.variant,isActive:n,onClick:()=>o(r,a),"aria-current":n?"location":"false","aria-label":"isStatus"===a.variant?"Assignment status":`Question ${r+1}`,children:"isStatus"===a.variant?e(Ar,{}):r+1}),e(Qr,{variant:a.variant})]}),Wr=({steps:t,activeIndex:r,goToStep:n})=>e(Rr,{"aria-label":"Breadcrumbs",children:t.map((t,a)=>e(Ur,{index:a,isActive:a===r,step:t,goToStep:n},a))});let Zr;const Gr=d.div(Zr||(Zr=(e=>e)`
  max-width: 1000px;
...
`),ae.palette.light),Kr=()=>e(Gr,{children:e(M,{uniqueKey:"OSLoader"})});let Yr,Xr,en,tn=e=>e;const rn=d.div(Yr||(Yr=tn`
  display: flex;
  width: fit-content;
