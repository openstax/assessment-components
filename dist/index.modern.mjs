import{jsx as e,jsxs as t,Fragment as r}from"react/jsx-runtime.js";import n from"classnames";import a,{createElement as o}from"react";import i,{css as s,createGlobalStyle as l}from"styled-components";import c from"scroll-to-element";import{debounce as d,once as p}from"lodash";import{memoize as m,isEmpty as u}from"lodash/fp.js";import h from"weak-map";import{FontAwesomeIcon as b}from"@fortawesome/react-fontawesome";import{faBookOpen as f,faTriangleExclamation as g}from"@fortawesome/free-solid-svg-icons";import{faBookOpen as w}from"@fortawesome/free-solid-svg-icons/faBookOpen";import{faTriangleExclamation as x}from"@fortawesome/free-solid-svg-icons/faTriangleExclamation";import{faCircleInfo as v}from"@fortawesome/free-solid-svg-icons/faCircleInfo";import{faCheck as $}from"@fortawesome/free-solid-svg-icons/faCheck";import{faXmark as k}from"@fortawesome/free-solid-svg-icons/faXmark";import{BulletList as y}from"react-content-loader";function C(){return C=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},C.apply(this,arguments)}function _(e,t){if(null==e)return{};var r,n,a={},o=Object.keys(e);for(n=0;n<o.length;n++)t.indexOf(r=o[n])>=0||(a[r]=e[r]);return a}const N="ABCDEFGHIJKLMNOPQRSTUVWXYZ",q=(e,t)=>e.id===t;function S(e){const t=e.trim().match(/\b[-?(\w+)?]+\b/gi);return t?t.length:0}const A=a.createContext(()=>{throw new Error("context not initialized")}),I=["html","component","block"],M=t=>{let{html:r,component:n,block:o=!1}=t,i=_(t,I);const s=a.useContext(A);return a.useEffect(()=>{s()},[s,r]),void 0!==n?a.cloneElement(n,C({html:r},i)):e(o?"div":"span",C({dangerouslySetInnerHTML:{__html:r}},i))},E=["id"],T=t=>e("aside",{children:e(M,{component:t.contentRenderer,className:n("question-feedback-content","has-html",t.className),html:t.children,block:!0})}),H=r=>{let{id:a}=r,o=_(r,E);const i=n("question-feedback",o.position||"bottom");return t("aside",{id:a,className:i,children:[e("div",{className:"arrow","aria-label":"Answer Feedback"}),e(T,C({},o,{children:o.children}))]})};let O,j,z,P,F,R,L,J,Q,V,B,D,W,U=e=>e;const Z={red:"#ca2026",danger:"#c2002f",darkRed:"#c22032",lightRed:"#e298a0",green:"#77af42",lightGreen:"#8bc753",darkGreen:"#63a524",paleYellow:"#ffffbb",teal:"#0dc0de",blue:"#007da4",mediumBlue:"#026AA1",lightBlue:"#34bdd8",neutralLightBlue:"#0dc0dc",tangerine:"#ffbd3e",gray:"#5e5e5e",darkGray:"#757575",pale:"#d5d5d5",light:"#e4e4e4",white:"#ffffff",neutralLightest:"#f9f9f9",neutralCool:"#f6f7f8",neutralBright:"#f5f5f5",neutralLighter:"#f1f1f1",neutralLight:"#e5e5e5",neutralMedium:"#a0a0a0",neutral:"#818181",neutralThin:"#6f6f6f",neutralDark:"#5f6163",neutralFeedback:"#555",neutralDarker:"#424242",black:"#000000",orange:"#D4450C"},G={palette:Z,answer:{neutral:Z.neutralThin,hover:"#026AA1",checked:"#026AA1",correct:"#0D7741",incorrect:"#C22032"},popover:{arrowOuterColor:"rgba(0, 0, 0, 0.25)",borderColor:"rgba(0, 0, 0, 0.2)"},card:{header:{background:"#daf3f8"},body:{background:"#fdfdfd"}},button:{background:Z.orange,backgroundHover:"#E74B0D",backgroundActive:"#C5400B"},freeResponse:{color:Z.neutralDarker,background:Z.neutralLighter}},K=(...e)=>s(O||(O=U`@media(max-width: ${0}px) { ${0} }`),600,s(...e)),Y=(...e)=>s(j||(j=U`@media(max-width: ${0}px) { ${0} }`),999,s(...e)),X=(...e)=>s(z||(z=U`@media(min-width: ${0}px) { ${0} }`),1e3,s(...e)),ee={answer:()=>s(F||(F=U`
  ...
  `),Z.neutralDarker,"3.6rem","3.6rem","3.6rem","3.6rem","3.6rem",G.answer.neutral,"0.1s ease-in-out","0.1s ease-in-out","0.1s ease-in-out",G.palette.white),answerColor:(e,t=!1)=>s(R||(R=U`
    .answer-letter-wrapper::before {
      color: ${0};
      border-color: ${0};
      ${0}
    }
  `),t?"#fff":e,e,t?`background-color: ${e};`:null),answerChecked:()=>ee.answerColor(G.answer.checked,!0),answerCorrect:e=>ee.answerColor(G.answer.correct,e),answerIncorrect:e=>ee.answerColor(G.answer.incorrect,e),answerHover:()=>s(L||(L=U`
    ${0};
    font-weight: bold;
  `),ee.answerColor(G.answer.hover)),answerCorrectAnswer:()=>ee.answerColor(G.answer.correct,!1),resetText:()=>s(J||(J=U`
...
`),ee.stepCardPadding(),G.card.body.background,((...e)=>s(P||(P=U`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(ke||(ke=_e`
    ...
    `),"8px")),Ie=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:o,stepType:i,isHomework:s,availablePoints:l,unpadded:c,className:d,children:p,questionId:m,multipartBadge:u,leftHeaderChildren:h,rightHeaderChildren:b,headerTitleChildren:f}=r,g=_(r,pe);return t(qe,C({},g,{children:[u,t(Ne,{className:d,children:[n&&s&&"exercise"===i&&t(Se,{children:[t("div",{children:[h,t("div",{className:"question-info",children:[f,e("span",{children:a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`}),o?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",m]})]})]}),l||b?t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]}):null]}),e(Ae,{unpadded:c,children:p})]})]}))};Ie.displayName="OSStepCard";const Me=t=>{let{step:r,questionNumber:a,numberOfQuestions:o,children:i,className:s}=t,l=_(t,me);return e(Ie,C({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:i}))};Me.displayName="OSTaskStepCard";const Ee=["disabled","isWaiting","waitingText","children"];let Te;const He=i.button(Te||(Te=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),G.button.background,G.palette.white,G.button.backgroundHover,G.button.backgroundActive),Oe=t=>{const{disabled:r,isWaiting:n,waitingText:a,children:o}=t,i=_(t,Ee);return e(He,C({},i,{disabled:n||r,children:n&&a||o}))};let je,ze,Pe,Fe,Re=e=>e;const Le=l(je||(je=Re`
  :root {
...
`)),Qe=i.h2(Pe||(Pe=Re`
  ...
  margin: 0;
`)),Ve=i(({numberOfQuestions:n,numberCompleted:a,handleClick:o,className:i})=>{const s=n===a,l=a>0,c=s?"Next":l?"Continue":"Start";return t(r,{children:[e(Le,{}),t(Je,{className:i,children:[e(Qe,{children:s?"You are done.":l?"Quiz is partially complete.":"No questions have been answered."}),e("p",{children:s?"Great job answering all the questions.":l?`You've completed ${a} of ${n} questions.`:"Begin working on the quiz."}),e(Oe,{"data-test-id":`${c.split(" ")[0].toLowerCase()}-btn`,onClick:()=>o(),children:c})]})]})})(Fe||(Fe=Re``));let Be;const De=i.div(Be||(Be=(e=>e)`
&.step-card-body {
  ${0};
}
...
`),ee.stepCardPadding(),G.palette.pale,G.palette.neutral,G.palette.neutralLightBlue,"1rem","2.5rem","1rem","1rem","1rem","1rem",G.palette.neutralLighter,G.palette.neutralLightest,ee.answer(),"1rem","1rem","0.1s ease-in-out",ee.answerHover(),ee.visuallyHidden(),ee.answerChecked(),G.answer.checked,ee.answerChecked(),ee.answerIncorrect(),ee.answerCorrect(!0),ee.answerCorrectAnswer(),ee.answerIncorrect(),ee.answerIncorrect(!0),ee.popover(),"370px","0.9rem","1.1rem"),We=a.forwardRef((r,a)=>{let o,i;const{question:s,correct_answer_id:l,incorrectAnswerId:c,exercise_uid:d,className:p,questionNumber:m,context:u,task:h,hidePreambles:b}=r,{stem_html:f,collaborator_solutions:g=[],formats:w,stimulus_html:x}=s,v=!!l,$=n("openstax-question",p,{"has-correct-answer":v&&!((null!=h?h.is_deleted:void 0)&&"homework"===(null!=h?h.type:void 0)),"has-incorrect-answer":!!c});return null!=d&&(o=e("div",{className:"exercise-uid",children:d})),(()=>{const{displaySolution:e}=r,{collaborator_solutions:t=[]}=s;return e&&t&&t.find(e=>void 0!==e.content_html)})()&&(i=t("div",{className:"detailed-solution",children:[e("div",{className:"header",children:"Detailed solution:"}),e(M,{className:"solution",block:!0,html:g.map(e=>e.content_html).join("")})]})),t(De,{ref:a,className:$,"data-question-number":m,"data-test-id":"question",children:[e(Ue,{type:"context",html:u,hidden:b}),e(Ue,{type:"stimulus",html:x,hidden:b}),e(Ue,{type:"stem",html:f,hidden:b,questionNumber:m}),r.children,e(de,C({},r,{onChangeAnswer:r.onChange,hasCorrectAnswer:v})),i,r.displayFormats?e(Ze,{formats:w}):void 0,o]})}),Ue=t=>{const{html:r="",type:n,hidden:a,questionNumber:o}=t;return!0!==a&&r.length>0?e(M,{html:r,"data-question-number":o,className:`question-${n}`,block:!0}):null},Ze=({formats:r=[]})=>t("div",{className:"formats-listing",children:[e("div",{className:"header",children:"Formats:"}),r.map((t,r)=>e("span",{children:t},r))]});let Ge,Ke,Ye=e=>e;const Xe=i.div(Ge||(Ge=Ye`
    ...
    ${0}
`),ee.stepCardPadding(),G.card.body.background,G.palette.pale,X(Ke||(Ke=Ye`
    ...
    `)));let et,tt,rt,nt,at,ot,it=e=>e;const st=s(et||(et=it`
...
`),ee.stepCardPadding()),ct=i.div(rt||(rt=it`
  font-size: 2rem;
  line-height: 1.68em;
  position: relative;
`)),dt=i.div(nt||(nt=it`
  ...
  color: ${0};
`),e=>e.hasChildren?"space-between":"flex-end",G.palette.danger,G.palette.neutralThin),pt=i.textarea(at||(at=it`
  display: block;
  font-family: inherit;
  font-size: 1.8rem;
  line-height: 3rem;
  ...
  ${0}
  background-color: ${0};
`),G.palette.neutral,G.palette.neutralDark,e=>e.isOverWordLimit&&st,e=>e.isOverWordLimit&&s(ot||(ot=it`
    border: 2px solid ${0};
  `),G.palette.danger),e=>e.readOnly&&G.palette.neutralCool);pt.displayName="OSFreeResponseTextArea";const mt=t=>e(Oe,C({},t,{children:"Cancel"})),ut=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:o,infoRowChildren:i,isSubmitDisabled:s,question:l,questionNumber:c,saveHandler:d,submitBtnLabel:p,textHasChanged:m,wordLimit:u}=r,h=S(o)>u,b={};return c&&(b["data-question-number"]=c),t(lt,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(ct,C({},b,{children:l.stem_html&&e(Ue,{type:"stem",html:l.stem_html,hidden:!1})})),e(pt,C({},r,{isOverWordLimit:h,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(dt,{hasChildren:!!i,children:[i,t("div",{children:[t("span",{children:[S(o)," words"]}),h&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(Xe,{children:[n?e("div",{className:"points",role:"status",children:t("strong",{children:["Points: ",n]})}):null,t("div",{className:"controls",children:[e(mt,{disabled:!m,onClick:a}),e(Oe,{"data-test-id":"submit-answer-btn",disabled:s||h,onClick:d,children:p})]})]})]})};ut.displayName="OSFreeResponse";const ht=({count:e})=>t("div",{children:[e," attempt",1===e?"":"s"," left"]}),bt=({published_comments:r})=>r?t("div",{children:[e("strong",{children:"Feedback:"})," ",r]}):null,ft=t=>e(Oe,C({},t,{waitingText:"Saving…",isWaiting:t.isWaiting,"data-test-id":"submit-answer-btn",children:t.willContinue?"Submit & continue":0==t.attempt_number?"Submit":"Re-submit"})),gt=t=>e(Oe,C({},t,{"data-test-id":"continue-btn",children:t.canUpdateCurrentStep?"Continue":"Next"})),wt=({free_response:t})=>t?e(r,{children:e("div",{className:"free-response",children:t})}):null,xt=a.forwardRef((r,n)=>{const{question:o,task:i,answer_id_order:s,onAnswerChange:l,feedback_html:c,correct_answer_feedback_html:d,is_completed:p,correct_answer_id:m,incorrectAnswerId:u,choicesEnabled:h,questionNumber:b,answer_id:f,hasMultipleAttempts:g,attempts_remaining:w,published_comments:x,detailedSolution:v,canAnswer:$,needsSaved:k,attempt_number:y,apiIsPending:C,onAnswerSave:_,onNextStep:N,canUpdateCurrentStep:q,displaySolution:S,available_points:A,free_response:I,show_all_feedback:E,tableFeedbackEnabled:T,hasFeedback:H}=r,[O,j]=a.useState(!1);return a.useEffect(()=>{O&&p&&(N(b-1),j(!1))},[N,b,O,p]),t("div",{"data-test-id":"student-exercise-question",children:[e(We,{ref:n,task:i,question:o,answerIdOrder:s,choicesEnabled:h,answer_id:f,questionNumber:b,onChange:l,feedback_html:c,correct_answer_feedback_html:d,correct_answer_id:p?m:null,incorrectAnswerId:u,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:S,show_all_feedback:E,tableFeedbackEnabled:T,children:e(wt,{free_response:I})}),e(Xe,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[t("div",{className:"points",role:"status",children:[A?t("strong",{children:["Points: ",A]}):null,e("span",{className:"attempts-left",children:g&&w>0&&e(ht,{count:w})}),e(bt,{published_comments:x}),v&&t("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(M,{html:v})]})]}),e("div",{className:"controls",children:$&&k||O?e(ft,{disabled:C||!f||O,isWaiting:C||O,attempt_number:y,onClick:()=>{var e;_("string"==typeof(e=o.id)?parseInt(e,10):e),H||j(!0)},willContinue:!H}):e(gt,{onClick:()=>N(b-1),canUpdateCurrentStep:q})})]})})]})}),vt={extensions:[],showProcessingMessages:!1,skipStartupTypeset:!0,styles:{"#MathJax_MSIE_Frame":{left:"",right:0,visibility:"hidden"},"#MathJax_Message":{left:"",right:0,visibility:"hidden"}},tex2jax:{displayMath:[["‌‌‌","‌‌‌"]],inlineMath:[["​​​","​​​"]]}},$t=e=>{const t=(e=>Array.from(e.querySelectorAll(".MathJax math")))(e);return Array.from(e.querySelectorAll("math")).filter(e=>-1===t.indexOf(e))},kt=e=>{const t=[];for(const r of Array.from(e.querySelectorAll("[data-math]:not(.math-rendered)"))){const e=r.getAttribute("data-math");r.classList.contains("math-marked")||(r.textContent="div"===r.tagName.toLowerCase()?`‌‌‌${e}‌‌‌`:`​​​${e}​​​`,r.classList.add("math-marked")),t.push(r)}return t},yt=(e,t,r=5)=>{r>0&&(kt(e).length||$t(e).length)?setTimeout(()=>{yt(e,t,r-1)},200):t()},Ct=(e,t)=>new Promise(r=>{(function(e,t){const r=kt(e);t.MathJax.Hub.Queue(((e,t)=>()=>{u(e)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e),(e=>()=>{const t=[];for(const r of e)t.push(r.className+=" math-rendered")})(e))})(r,t),((e,t)=>()=>{const r=$t(e);u(r)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e))})(e,t))})(e,t),t.MathJax.Hub.Queue(()=>{yt(e,r)})}),_t=m((e,t)=>d(Ct,100,{leading:!0,trailing:!1}).bind(null,e,t));_t.cache=new h;const Nt=p((e=window)=>new Promise(t=>{const r=()=>{e.MathJax.HTML.Cookie.prefix="mathjax",e.MathJax.Hub.Configured(),e.MathJax.Hub.Register.StartupHook("End",()=>{t()})};if(!document.getElementById("MathJax-Script")){const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&delayStartupUntil=configured",e.id="MathJax-Script",e.async=!0,document.head.appendChild(e)}e.MathJax&&e.MathJax.Hub?(e.MathJax.Hub.Config(vt),e.MathJax.Hub.processSectionDelay=0,r()):(vt.AuthorInit=r,e.MathJax=vt)}));let qt,St,At,It,Mt,Et=e=>e;const Tt=i.div(qt||(qt=Et`
  position: absolute;
  background: #fff;
  width: 4.5rem;
  border: 1px solid ${0};
  ...
  ${0}
`),G.palette.light,"2rem","2rem",G.palette.neutral,G.palette.neutralDarker,G.palette.neutralDarker,e=>!e.desktop&&s(St||(St=Et`
    ${0}
    ${0}
  `),X(At||(At=Et`
      display: none;
  ...
  `),G.palette.neutral,G.palette.light)),Ht=({icons:r})=>{var n,a;if(!r)return null;const o=Object.values(r),i=o.some(({location:e})=>{var t,r;return null==(t=null==e||null==(r=e.toolbar)?void 0:r.mobile)||t}),s=o.some(({location:e})=>{var t,r;return null!=(t=null==e||null==(r=e.toolbar)?void 0:r.desktop)&&t}),l=null==(n=r.topic)?void 0:n.url,c=null==(a=r.errata)?void 0:a.url;return t(Tt,C({},{mobile:i,desktop:s},{children:[l?t("a",{href:l,target:"_blank",children:[e(b,{icon:f}),e("span",{children:"View topic in textbook"})]}):null,c?t("a",{href:c,target:"_blank",children:[e(b,{icon:g}),e("span",{children:"Suggest a correction"})]}):null]}))};let Ot,jt,zt,Pt,Ft,Rt,Lt,Jt,Qt,Vt=e=>e;const Bt=i.div(Ot||(Ot=Vt`
  ...
  ${0}
  ${0}
`),G.palette.mediumBlue,e=>!e.desktop&&s(jt||(jt=Vt`
    ${0}
    ${0}
  `),X(zt||(zt=Vt`
      display: none;
...
`)),Wt=i.div(Lt||(Lt=Vt`
  ...
  font-size: 1.2rem;
  line-height: 1.8rem;
`),ee.popover),Ut=r=>e(Bt,C({},r.wrapperProps,{mobile:r.mobile,desktop:r.desktop,"aria-label":r.text,children:t(Dt,{children:[r.children,t(Wt,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),Zt=i.div(Jt||(Jt=Vt`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),Gt=i(b)(Qt||(Qt=Vt`
  color: ${0};
  height: 1em;
`),G.palette.darkGray),Kt=({exercise:t,icons:r})=>{const n={desktop:!0,mobile:!1},a=[],o=t.questions.every(e=>e.answers.length>0);let i;var s,l,c;return o&&t.questions.find(e=>e.formats.includes("free-response"))?i="In a two-step question, OpenStax asks for your own answer first, then gives multiple-choice options to help you assess your learnings. Recalling the answer to a question from memory helps you to retain things longer.":o&&(i="Select the best answer from the given list of distractors. Your instructor may or may not allow multiple attempts."),r.topic&&a.push(e(Ut,C({text:"View topic in textbook",wrapperProps:{as:"a",href:r.topic.url,target:"_blank"}},(null==(s=r.topic.location)?void 0:s.header)||n,{children:e(Gt,{icon:w})}),"topic")),r.errata&&a.push(e(Ut,C({text:"Suggest a correction",wrapperProps:{as:"a",href:r.errata.url,target:"_blank"}},(null==(l=r.errata.location)?void 0:l.header)||n,{children:e(Gt,{icon:x})}),"errata")),r.info&&i&&a.push(e(Ut,C({text:i},(null==(c=r.info.location)?void 0:c.header)||n,{children:e(Gt,{icon:v,height:"16px",width:"16px"})}),"type")),e(Zt,{children:a})},Yt=["numberOfQuestions","questionNumber","step","exercise","show_all_feedback","scrollToQuestion","exerciseIcons"];let Xt,er,tr,rr,nr,ar,or,ir,sr,lr,cr=e=>e;const dr=i(Me)(Xt||(Xt=cr`
  font-size: calc(1.8rem * var(--content-text-scale));
...
`)),mr=i.div(tr||(tr=cr`
  ...
  ${0}
`),e=>e.desktopToolbarEnabled&&s(rr||(rr=cr`
    ${0}
    ${0}
    ${0}
  `),X(nr||(nr=cr`
    ...
    `),dr)),e=>e.mobileToolbarEnabled&&s(ir||(ir=cr`
    ${0}
  `),K(sr||(sr=cr`
      ${0} + ${0} ${0} {
...
`)),Ir="box-shadow: 0px 1px 4px 0px #00000066;",Mr=i.button(Cr||(Cr=qr`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",G.palette.neutralDarker,e=>e.isActive?s(_r||(_r=qr`
    ${0}
    & + [data-icon] {
      bottom: 0;
      right: 0;
    }
  `),Ir):null,e=>(e=>{switch(e){case"isStatus":return s(vr||(vr=qr`
        background-color: ${0};
      `),G.palette.neutralBright);case"isCorrect":return s($r||($r=qr`
        color: ${0};
        background-color: #E8F4D8;
      `),G.answer.correct);case"isIncorrect":return s(kr||(kr=qr`
        color: ${0};
        background-color: #F8E8EA;
      `),G.answer.incorrect);default:return s(yr||(yr=qr`
        background-color: ${0};
      `),G.palette.neutralBright)}})(e.variant),Ir),Er=i(b)(Nr||(Nr=qr`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Tr=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const r={isCorrect:{icon:$,color:G.answer.correct,label:"Correct"},isIncorrect:{icon:k,color:G.answer.incorrect,label:"Incorrect"}}[t];return e(Er,{icon:r.icon,color:r.color,height:"16px",width:"16px","aria-label":r.label,"aria-hidden":void 0})},Hr=({index:r,isActive:n,step:a,goToStep:o})=>t(Ar,{children:[e(Mr,{variant:a.variant,isActive:n,onClick:()=>o(r,a),"aria-current":n?"location":"false","aria-label":"isStatus"===a.variant?"Assignment status":`Question ${r+1}`,children:"isStatus"===a.variant?e(fr,{}):r+1}),e(Tr,{variant:a.variant})]}),Or=({steps:t,activeIndex:r,goToStep:n})=>e(Sr,{"aria-label":"Breadcrumbs",children:t.map((t,a)=>e(Hr,{index:a,isActive:a===r,step:t,goToStep:n},a))});let jr;const zr=i.div(jr||(jr=(e=>e)`
  max-width: 1000px;
...
`),G.palette.light),Pr=()=>e(zr,{children:e(y,{uniqueKey:"OSLoader"})});export{le as Answer,de as AnswersTable,Ve as CompletionStatus,br as Exercise,Ht as ExerciseToolbar,ut as FreeResponseInput,pt as FreeResponseTextArea,Ne as InnerStepCard,Pr as Loader,qe as OuterStepCard,Or as ProgressBar,Hr as ProgressBarItem,We as Question,Ue as QuestionHtml,Ie as StepCard,Mr as StyledItem,Tt as StyledToolbar,Me as TaskStepCard};
