...
`),K.stepCardPadding(),D.card.body.background,((...e)=>s(T||(T=F`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(de||(de=me`
    ...
    `),"8px")),we=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:o,stepType:i,isHomework:s,availablePoints:l,unpadded:d,className:c,children:p,questionId:m,multipartBadge:h,leftHeaderChildren:u,rightHeaderChildren:b,headerTitleChildren:g}=r,w=k(r,Y);return t(ue,v({},w,{children:[h,t(he,{className:c,children:[n&&s&&"exercise"===i&&t(be,{children:[t("div",{children:[u,t("div",{className:"question-info",children:[g,e("span",{children:a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`}),o?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",m]})]})]}),t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]})]}),e(ge,{unpadded:d,children:p})]})]}))};we.displayName="OSStepCard";const fe=t=>{let{step:r,questionNumber:a,numberOfQuestions:o,children:i,className:s}=t,l=k(t,X);return e(we,v({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,availablePoints:r.available_points,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:i}))};fe.displayName="OSTaskStepCard";const xe=["disabled","isWaiting","waitingText","children"];let $e;const ye=i.button($e||($e=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),D.button.background,D.palette.white,D.button.backgroundHover,D.button.backgroundActive),ve=t=>{const{disabled:r,isWaiting:n,waitingText:a,children:o}=t,i=k(t,xe);return e(ye,v({},i,{disabled:n||r,children:n&&a||o}))};let ke,Ce,_e=e=>e;const Ne=i(he)(ke||(ke=_e`
  padding: 88px 72px;
  font-size: 1.8rem;
  line-height: 3rem;
  display: block;
...
`)),qe=i.h2(Ce||(Ce=_e`
  font-size: 2.4rem;
  margin: 0;
`)),Se=({numberOfQuestions:r,numberCompleted:n,handleClick:a})=>{const o=r===n,i=n>0,s=o?"Next":i?"Continue":"Start";return t(Ne,{children:[e(qe,{children:o?"You are done.":i?"Quiz is partially complete.":"No questions have been answered."}),e("p",{children:o?"Great job answering all the questions.":i?`You've completed ${n} of ${r} questions.`:"Begin working on the quiz."}),e(ve,{"data-test-id":`${s.split(" ")[0].toLowerCase()}-btn`,onClick:()=>a(),children:s})]})},Ae={extensions:[],showProcessingMessages:!1,skipStartupTypeset:!0,styles:{"#MathJax_MSIE_Frame":{left:"",right:0,visibility:"hidden"},"#MathJax_Message":{left:"",right:0,visibility:"hidden"}},tex2jax:{displayMath:[["‌‌‌","‌‌‌"]],inlineMath:[["​​​","​​​"]]}},Me=e=>{const t=(e=>Array.from(e.querySelectorAll(".MathJax math")))(e);return Array.from(e.querySelectorAll("math")).filter(e=>-1===t.indexOf(e))},He=e=>{const t=[];for(const r of Array.from(e.querySelectorAll("[data-math]:not(.math-rendered)"))){const e=r.getAttribute("data-math");r.classList.contains("math-marked")||(r.textContent="div"===r.tagName.toLowerCase()?`‌‌‌${e}‌‌‌`:`​​​${e}​​​`,r.classList.add("math-marked")),t.push(r)}return t},Ie=(e,t,r=5)=>{r>0&&(He(e).length||Me(e).length)?setTimeout(()=>{Ie(e,t,r-1)},200):t()},Oe=(e,t)=>new Promise(r=>{(function(e,t){const r=He(e);t.MathJax.Hub.Queue(((e,t)=>()=>{p(e)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e),(e=>()=>{const t=[];for(const r of e)t.push(r.className+=" math-rendered")})(e))})(r,t),((e,t)=>()=>{const r=Me(e);p(r)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e))})(e,t))})(e,t),t.MathJax.Hub.Queue(()=>{Ie(e,r)})}),Te=c((e,t)=>l(Oe,100,{leading:!0,trailing:!1}).bind(null,e,t));Te.cache=new m;const je=d((e=window)=>new Promise(t=>{const r=()=>{e.MathJax.HTML.Cookie.prefix="mathjax",e.MathJax.Hub.Configured(),e.MathJax.Hub.Register.StartupHook("End",()=>{t()})};if(!document.getElementById("MathJax-Script")){const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&delayStartupUntil=configured",e.id="MathJax-Script",e.async=!0,document.head.appendChild(e)}e.MathJax&&e.MathJax.Hub?(e.MathJax.Hub.Config(Ae),e.MathJax.Hub.processSectionDelay=0,r()):(Ae.AuthorInit=r,e.MathJax=Ae)}));let Le;const Pe=i.div(Le||(Le=(e=>e)`
&.step-card-body {
  ${0};
}
...
`),K.stepCardPadding(),D.palette.pale,D.palette.neutral,D.palette.neutralLightBlue,"1rem","2.5rem","1rem","1rem","1rem","1rem",D.palette.neutralLighter,D.palette.neutralLightest,K.answer(),"1rem","3.6rem","1rem","0.1s ease-in-out",K.answerHover(),K.answerChecked(),K.answerChecked(),K.answerIncorrect(),K.answerCorrect(),K.answerCorrectAnswer(),K.answerIncorrect(),K.popover(),"370px","0.9rem","1.1rem"),Ee=a.forwardRef((r,o)=>{let i,s;const{question:l,correct_answer_id:d,incorrectAnswerId:c,exercise_uid:p,className:m,questionNumber:h,context:u,task:b,hidePreambles:g}=r,{stem_html:w,collaborator_solutions:f=[],formats:x,stimulus_html:$}=l,y=!!d,k=n("openstax-question",m,{"has-correct-answer":y&&!((null!=b?b.is_deleted:void 0)&&"homework"===(null!=b?b.type:void 0)),"has-incorrect-answer":!!c});null!=p&&(i=e("div",{className:"exercise-uid",children:p})),(()=>{const{displaySolution:e}=r,{collaborator_solutions:t=[]}=l;return e&&t&&t.find(e=>void 0!==e.content_html)})()&&(s=t("div",{className:"detailed-solution",children:[e("div",{className:"header",children:"Detailed solution:"}),e(_,{className:"solution",block:!0,html:f.map(e=>e.content_html).join("")})]}));const C=a.useRef(null);return a.useEffect(()=>{C.current&&(async(e,t=window)=>{await je(),t&&t.MathJax&&t.MathJax.Hub?e.querySelector("[data-math]:not(.math-rendered), math:not(.math-rendered)")?Te(e,t)():Promise.resolve():(console.warn("Warning: Expected MathJax to be initialized."),Promise.resolve())})(C.current)},[l,r.correct_answer_feedback_html,r.feedback_html]),e("div",{ref:C,children:t(Pe,{ref:o,className:k,"data-question-number":h,"data-test-id":"question",children:[e(ze,{type:"context",html:u,hidden:g}),e(ze,{type:"stimulus",html:$,hidden:g}),e(ze,{type:"stem",html:w,hidden:g,questionNumber:h}),r.children,e(M,v({},r,{onChangeAnswer:r.onChange,hasCorrectAnswer:y})),s,r.displayFormats?e(Je,{formats:x}):void 0,i]})})}),ze=t=>{const{html:r="",type:n,hidden:a,questionNumber:o}=t;return!0!==a&&r.length>0?e(_,{html:r,"data-question-number":o,className:`question-${n}`,block:!0}):null},Je=({formats:r=[]})=>t("div",{className:"formats-listing",children:[e("div",{className:"header",children:"Formats:"}),r.map((t,r)=>e("span",{children:t},r))]});let Re,Be,Qe=e=>e;const Ve=i.div(Re||(Re=Qe`
    ${0}
    display: flex;
    flex-wrap: wrap;
    justify-content: space-between;
    ...
    ${0}
`),K.stepCardPadding(),D.card.body.background,D.palette.pale,Z(Be||(Be=Qe`
    ...
    `)));let Fe,Ue,De,We,Ge,Ze,Ke=e=>e;const Ye=s(Fe||(Fe=Ke`
...
`),K.stepCardPadding()),et=i.div(De||(De=Ke`
  font-size: 2rem;
  line-height: 1.68em;
  position: relative;
`)),tt=i.div(We||(We=Ke`
  ...
  color: ${0};
`),e=>e.hasChildren?"space-between":"flex-end",D.palette.danger,D.palette.neutralThin),rt=i.textarea(Ge||(Ge=Ke`
  display: block;
  font-family: inherit;
  font-size: 1.8rem;
  line-height: 3rem;
  ...
  ${0}
  background-color: ${0};
`),D.palette.neutral,D.palette.neutralDark,e=>e.isOverWordLimit&&Ye,e=>e.isOverWordLimit&&s(Ze||(Ze=Ke`
    border: 2px solid ${0};
  `),D.palette.danger),e=>e.readOnly&&D.palette.neutralCool);rt.displayName="OSFreeResponseTextArea";const nt=t=>e(ve,v({},t,{children:"Cancel"})),at=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:o,infoRowChildren:i,isSubmitDisabled:s,pointsChildren:l,question:d,questionNumber:c,saveHandler:p,submitBtnLabel:m,textHasChanged:h,wordLimit:u}=r,b=y(o)>u,g={};return c&&(g["data-question-number"]=c),t(Xe,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(et,v({},g,{children:d.stem_html&&e(ze,{type:"stem",html:d.stem_html,hidden:!1})})),e(rt,v({},r,{isOverWordLimit:b,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(tt,{hasChildren:!!i,children:[i,t("div",{children:[t("span",{children:[y(o)," words"]}),b&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(Ve,{children:[t("div",{className:"points",children:[t("strong",{children:["Points: ",n]}),l]}),t("div",{className:"controls",children:[e(nt,{disabled:!h,onClick:a}),e(ve,{"data-test-id":"submit-answer-btn",disabled:s||b,onClick:p,children:m})]})]})]})};at.displayName="OSFreeResponse";let ot,it,st,lt,dt,ct=e=>e;const pt=i.div(ot||(ot=ct`
...
`),D.palette.mediumBlue),mt=i.div(it||(it=ct`
  position: relative;
  display: flex;
`)),ht=i.div(st||(st=ct`
  ${0}
  ...
  font-size: 1.2rem;
  line-height: 1.8rem;
`),K.popover),ut=r=>e(pt,v({},r.wrapperProps,{children:t(mt,{children:[r.children,t(ht,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),bt=i.div(lt||(lt=ct`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),gt=i(w)(dt||(dt=ct`
  color: ${0};
  height: 1em;
`),D.palette.darkGray),wt=({exercise:t,topicUrl:r,errataUrl:n})=>{const a=[],o=t.questions.every(e=>e.answers.length>0);let i;return o&&t.questions.find(e=>e.formats.includes("free-response"))?i="In a two-step question, OpenStax asks for your own answer first, then gives multiple-choice options to help you assess your learnings. Recalling the answer to a question from memory helps you to retain things longer.":o&&(i="Select the best answer from the given list of distractors. Your instructor may or may not allow multiple attempts."),r&&a.push(e(ut,{text:"View topic in textbook",wrapperProps:{as:"a",href:r,target:"_blank"},children:e(gt,{icon:u})},"topic")),a.push(e(ut,{text:"Suggest a correction",wrapperProps:{as:"a",href:n,target:"_blank"},children:e(gt,{icon:b})},"errata")),i&&a.push(e(ut,{text:i,children:e(gt,{icon:g,height:"16px",width:"16px"})},"type")),e(bt,{children:a})},ft=({count:e})=>t("div",{children:[e," attempt",1===e?"":"s"," left"]}),xt=({published_comments:r})=>r?t("div",{children:[e("strong",{children:"Feedback:"})," ",r]}):null,$t=t=>e(ve,v({},t,{waitingText:"Saving…",isWaiting:t.isWaiting,"data-test-id":"submit-answer-btn",children:0==t.attempt_number?"Submit":"Re-submit"})),yt=t=>e(ve,v({},t,{"data-test-id":"continue-btn",children:t.canUpdateCurrentStep?"Continue":"Next"})),vt=({free_response:t})=>t?e(r,{children:e("div",{className:"free-response",children:t})}):null,kt=a.forwardRef((r,n)=>{const{question:a,task:o,answer_id_order:i,onAnswerChange:s,feedback_html:l,correct_answer_feedback_html:d,is_completed:c,correct_answer_id:p,incorrectAnswerId:m,choicesEnabled:h,questionNumber:u,answer_id:b,hasMultipleAttempts:g,attempts_remaining:w,published_comments:f,detailedSolution:x,canAnswer:$,needsSaved:y,attempt_number:v,apiIsPending:k,onAnswerSave:C,onNextStep:N,canUpdateCurrentStep:q,displaySolution:S,available_points:A,free_response:M,show_all_feedback:H,tableFeedbackEnabled:I}=r;return t("div",{"data-test-id":"student-exercise-question",children:[e(Ee,{ref:n,task:o,question:a,answerIdOrder:i,choicesEnabled:h,answer_id:b,questionNumber:u,onChange:s,feedback_html:l,correct_answer_feedback_html:d,correct_answer_id:c?p:null,incorrectAnswerId:m,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:S,show_all_feedback:H,tableFeedbackEnabled:I,children:e(vt,{free_response:M})}),e(Ve,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[t("div",{className:"points",children:[t("strong",{children:["Points: ",A]}),e("span",{className:"attempts-left",children:g&&w>0&&e(ft,{count:w})}),e(xt,{published_comments:f}),x&&t("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(_,{html:x})]})]}),e("div",{className:"controls",children:$&&y?e($t,{disabled:k||!b,isWaiting:k,attempt_number:v,onClick:()=>{return C("string"==typeof(e=a.id)?parseInt(e,10):e);var e}}):e(yt,{onClick:()=>N(u-1),canUpdateCurrentStep:q})})]})})]})}),Ct=["numberOfQuestions","questionNumber","step","exercise","show_all_feedback","scrollToQuestion"];let _t;const Nt=i(fe)(_t||(_t=(e=>e)`
  font-size: 1.8rem;
  line-height: 2.8rem;
`)),qt=({exercise:n})=>t(r,{children:[n.context&&e(_,{className:"step-card-body exercise-context",block:!0,html:n.context}),n.stimulus_html&&e(_,{className:"step-card-body exercise-stimulus",block:!0,html:n.stimulus_html})]}),St=r=>{let{numberOfQuestions:n,questionNumber:i,step:s,exercise:l,show_all_feedback:d,scrollToQuestion:c}=r,p=k(r,Ct);const m="feedback_html"in s,u=a.useRef([]);return a.useEffect(()=>{const e=c&&u.current[c];e&&h(e)},[c,l]),t(Nt,{step:s,questionNumber:i,numberOfQuestions:m?n:l.questions.length,rightHeaderChildren:p.showExerciseIcons?e(wt,{exercise:l,topicUrl:p.topicUrl,errataUrl:p.errataUrl}):null,showTotalQuestions:m,children:[e(qt,{exercise:l}),l.questions.map((e,t)=>{var r;const n=v({},m?s:p.questionStates[e.id]);return o(kt,v({},p,n,{ref:e=>u.current[i+t]=e,exercise_uid:l.uid,key:e.id,question:e,questionNumber:i+t,choicesEnabled:n.canAnswer,displaySolution:!0,detailedSolution:null==(r=n.solution)?void 0:r.content_html,show_all_feedback:d,tableFeedbackEnabled:d&&!m,canUpdateCurrentStep:"canUpdateCurrentStep"in p?p.canUpdateCurrentStep:!(t+1===l.questions.length)}))})]})},At=()=>e("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",xmlns:"http://www.w3.org/2000/svg",children:e("path",{d:"M14.556 2.09149C15.2296 1.78355 16 2.26721 16 2.99824V10.5951C16 10.9241 15.8362 11.2328 15.5605 11.4188C14.4229 12.1864 13.2007 12.6956 11.6715 12.6956C9.53267 12.6956 8.12768 11.6087 6.42651 11.6087C4.81213 11.6087 3.69241 11.923 2.79365 12.3V15.25C2.79365 15.6642 2.45254 16 2.03175 16H1.52381C1.10302 16 0.761905 15.6642 0.761905 15.25V3.18577C0.301492 2.86952 0 2.34455 0 1.74999C0 0.75924 0.836349 -0.0391985 1.852 0.00148899C2.75575 0.0376765 3.49578 0.75049 3.55203 1.63912C3.56854 1.8998 3.52632 2.1488 3.43819 2.37543C4.09648 2.13699 4.80613 1.99999 5.59835 1.99999C7.73718 1.99999 9.14216 3.08696 10.8433 3.08696C12.1289 3.08696 13.4659 2.5899 14.556 2.09149ZM2.79365 4.20718V6.40999C3.71429 6.07656 4.41841 5.85281 5.13016 5.75656V3.51999C4.38413 3.5878 3.84635 3.82593 2.79365 4.20718ZM9.80317 4.49437C8.96454 4.34837 8.21949 4.05752 7.46667 3.82749V5.93437C8.23413 6.14393 8.9767 6.44824 9.80317 6.63156V4.49437ZM5.13016 5.75656V7.94531C6.1713 7.85224 6.84159 7.92546 7.46667 8.06406V5.93437C6.66517 5.71452 5.98791 5.6399 5.13016 5.75656ZM7.46667 10.2012C8.30279 10.3466 9.04546 10.6365 9.80317 10.8681V8.76156C9.03248 8.55074 8.29397 8.24749 7.46667 8.06406V10.2012ZM2.79365 10.6906C3.54349 10.4284 4.31079 10.2581 5.13016 10.1731V7.94531C4.30127 8.01874 3.62667 8.19656 2.79365 8.48781V10.6906ZM14.4762 3.76562C13.8 4.04218 12.9971 4.31687 12.1397 4.4678V6.71499C13.0067 6.57874 13.7279 6.27437 14.4762 5.96843V3.76562ZM14.4762 10.3269V8.12406C13.7717 8.56781 12.9276 8.83062 12.1397 8.93718V11.1741C12.9356 11.0997 13.679 10.8291 14.4762 10.3269ZM9.80317 6.63156V8.76156C10.6179 8.9845 11.283 9.05349 12.1397 8.93718V6.71499C11.3143 6.84584 10.5542 6.79862 9.80317 6.63156Z",fill:"currentColor"})});let Mt,Ht,It,Ot,Tt,jt,Lt,Pt,Et=e=>e;const zt=i.div(Mt||(Mt=Et`
  display: flex;
...
`)),Rt=i.button(Pt||(Pt=Et`
  ...
  cursor: pointer;
  ${0}
`),e=>e.isActive?"3.0rem":"2.4rem",e=>e.isActive?"3.0rem":"2.4rem",e=>e.isActive?"0":"0 0.3rem",e=>((e,t)=>{switch(e){case"isStatus":return s(Ot||(Ot=Et`
        color: ${0};
        background-color: ${0};
        border: none;
        box-shadow: ${0};
...
`),D.palette.light),Ut=()=>e(Ft,{children:e(f,{uniqueKey:"OSLoader"})});export{S as Answer,M as AnswersTable,Se as CompletionStatus,St as Exercise,at as FreeResponseInput,rt as FreeResponseTextArea,he as InnerStepCard,Ut as Loader,ue as OuterStepCard,Qt as ProgressBar,Bt as ProgressBarItem,Ee as Question,ze as QuestionHtml,we as StepCard,Rt as StyledItem,fe as TaskStepCard};
