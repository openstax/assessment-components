import{jsx as e,jsxs as t,Fragment as r}from"react/jsx-runtime.js";import n from"classnames";import a,{createElement as i}from"react";import o,{css as s}from"styled-components";import l from"scroll-to-element";import{faBookOpen as c}from"@fortawesome/free-solid-svg-icons/faBookOpen";import{faTriangleExclamation as d}from"@fortawesome/free-solid-svg-icons/faTriangleExclamation";import{faCircleInfo as p}from"@fortawesome/free-solid-svg-icons/faCircleInfo";import{FontAwesomeIcon as h}from"@fortawesome/react-fontawesome";import{debounce as m,once as u}from"lodash";import{memoize as b,isEmpty as f}from"lodash/fp.js";import g from"weak-map";import{faCheck as w}from"@fortawesome/free-solid-svg-icons/faCheck";import{faXmark as x}from"@fortawesome/free-solid-svg-icons/faXmark";import{BulletList as v}from"react-content-loader";const $="ABCDEFGHIJKLMNOPQRSTUVWXYZ",y=function(e,t){return e.id===t};function k(e){const t=e.trim().match(/\b[-?(\w+)?]+\b/gi);return t?t.length:0}function C(){return C=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e},C.apply(this,arguments)}function _(e,t){if(null==e)return{};var r,n,a={},i=Object.keys(e);for(n=0;n<i.length;n++)t.indexOf(r=i[n])>=0||(a[r]=e[r]);return a}const N=a.createContext(()=>{throw new Error("context not initialized")}),q=["html","component","block"],A=t=>{let{html:r,component:n,block:i=!1}=t,o=_(t,q);const s=a.useContext(N);return a.useEffect(()=>{s()},[s,r]),void 0!==n?a.cloneElement(n,C({html:r},o)):e(i?"div":"span",C({dangerouslySetInnerHTML:{__html:r}},o))},S=t=>e("aside",{children:e(A,{component:t.contentRenderer,className:n("question-feedback-content","has-html",t.className),html:t.children,block:!0})}),M=r=>{const a=n("question-feedback",r.position||"bottom");return t("aside",{className:a,children:[e("div",{className:"arrow","aria-label":"Answer Feedback"}),e(S,C({},r,{children:r.children}))]})};let I,H,O,T,E,j,P,z,L,J,Q,R,V=e=>e;const B={red:"#ca2026",danger:"#c2002f",darkRed:"#c22032",lightRed:"#e298a0",green:"#77af42",lightGreen:"#8bc753",darkGreen:"#63a524",paleYellow:"#ffffbb",teal:"#0dc0de",blue:"#007da4",mediumBlue:"#026AA1",lightBlue:"#34bdd8",neutralLightBlue:"#0dc0dc",tangerine:"#ffbd3e",gray:"#5e5e5e",darkGray:"#757575",pale:"#d5d5d5",light:"#e4e4e4",white:"#ffffff",neutralLightest:"#f9f9f9",neutralCool:"#f6f7f8",neutralBright:"#f5f5f5",neutralLighter:"#f1f1f1",neutralLight:"#e5e5e5",neutralMedium:"#a0a0a0",neutral:"#818181",neutralThin:"#6f6f6f",neutralDark:"#5f6163",neutralFeedback:"#555",neutralDarker:"#424242",black:"#000000",orange:"#D4450C"},F={palette:B,answer:{neutral:B.neutralThin,hover:"#026AA1",checked:"#026AA1",correct:"#0D7741",incorrect:"#C22032"},popover:{arrowOuterColor:"rgba(0, 0, 0, 0.25)",borderColor:"rgba(0, 0, 0, 0.2)"},card:{header:{background:"#daf3f8"},body:{background:"#fdfdfd"}},button:{background:B.orange,backgroundHover:"#E74B0D",backgroundActive:"#C5400B"},freeResponse:{color:B.neutralDarker,background:B.neutralLighter}},U=(...e)=>s(I||(I=V`@media(max-width: ${0}px) { ${0} }`),600,s(...e)),D=(...e)=>s(H||(H=V`@media(max-width: ${0}px) { ${0} }`),999,s(...e)),W=(...e)=>s(O||(O=V`@media(min-width: ${0}px) { ${0} }`),1e3,s(...e)),Z={answer:()=>s(E||(E=V`
  ...
  font-size: 1.1rem;
  font-weight: bold;
`),e=>e.state?F.answer.correct:F.answer.incorrect),Y=({isCorrect:e,isIncorrect:r})=>{if(!e&&!r)return null;const n=e||!1===r;return t(K,{state:n,children:[n?"Correct":"Incorrect"," Answer"]})},X=a=>{const{type:i,iter:o,answer:s,disabled:l,onKeyPress:c,qid:d,chosenAnswer:p,correctAnswerId:h,incorrectAnswerId:m,hasCorrectAnswer:u,answered_count:b,contentRenderer:f,show_all_feedback:g,tableFeedbackEnabled:w}=a;let x,v,k;const C=((e,t)=>Boolean((t||[]).find(t=>t==e.id)))(s,p),_=function(e,t){if(!e.id&&!t)return e.isCorrect;let r=e.id===t;return null!=e.correctness&&(r="1.0"===e.correctness),r}(s,h),N=y(s,m),q=e("div",{className:"correct-incorrect",children:_&&a.correctIncorrectIcon}),M=p.every(e=>void 0===e)&&(!m&&_||N),I=n("answers-answer",{disabled:l,"answer-checked":C||M,"answer-correct":_&&"student-mpp"!==i,"answer-incorrect":m&&y(s,m)});let H,O,T=`${C?"Selected ":""}Choice ${$[o]}`;u&&(T+=`(${_?"Correct":"Incorrect"} Answer)`),T+=":";const E=()=>H&&H(s);if(u||"teacher-review"===i||"teacher-preview"===i||"student-mpp"===i||({onChangeAnswer:H}=a),H&&(O=e("input",{type:"radio",className:"answer-input-box",checked:C,id:`${d}-option-${o}`,name:`${d}-options`,onChange:E,disabled:l})),g&&s.feedback_html&&!w&&(v=e(S,{contentRenderer:f,children:s.feedback_html},"question-mc-feedback")),"teacher-review"===i){let r=0;s.selected_count&&b&&(r=Math.round(s.selected_count/b*100)),k=e("span",{className:"selected-count","data-percent":`${r}`,children:s.selected_count}),x=t("div",{className:"review-wrapper",children:[t("div",{className:n("review-count",{green:_,red:!_}),children:[k,e("span",{className:n("letter",{green:_,red:!_}),children:$[o]})]}),t("div",{className:"answer-answer",children:[e(A,{className:"answer-content",component:f,html:s.content_html}),v]})]})}else x=t(r,{children:["teacher-preview"===i&&q,k,O,t("label",{onKeyPress:c,htmlFor:`${d}-option-${o}`,className:"answer-label",children:[e("span",{className:"answer-letter-wrapper",children:e("button",{onClick:E,"aria-label":T,className:"answer-letter",disabled:l||N,"data-test-id":`answer-choice-${$[o]}`,children:$[o]})}),t("div",{className:"answer-answer",children:[e(Y,{isCorrect:_,isIncorrect:N}),e(A,{className:"answer-content",component:f,html:s.content_html}),v]})]})]});return e("div",{className:"openstax-answer",children:e("section",{role:"region",className:I,children:x})})};X.displayName="OSAnswer";const ee="student",te=r=>{let n=0;const{question:a,hideAnswers:i,type:o=ee,answered_count:s,choicesEnabled:l,correct_answer_id:c,incorrectAnswerId:d,answer_id:p,feedback_html:h,correct_answer_feedback_html:m,show_all_feedback:u=!1,tableFeedbackEnabled:b,hasCorrectAnswer:f,onChangeAnswer:g,onKeyPress:w,answerIdOrder:x,instructions:v}=r;if(i)return null;const{id:$}=a,y=[],k={qid:$||"auto-"+n++,correctAnswerId:c,incorrectAnswerId:d,hasCorrectAnswer:f,chosenAnswer:[p],onChangeAnswer:g,type:o,answered_count:s,disabled:!l,show_all_feedback:u,tableFeedbackEnabled:b,onKeyPress:w},_=(x?(e=>{const{answers:t}=a;return t.slice().sort((t,r)=>e.indexOf(t.id)-e.indexOf(r.id))})(x):a.answers).map((t,r)=>{const n={answer:C({},t,{question_id:"string"==typeof a.id?parseInt(a.id,10):a.id}),iter:r,key:`${k.qid}-option-${r}`},i=Object.assign({},n,k);return u&&t.feedback_html&&b?y.push({index:r,html:t.feedback_html}):t.id===d&&h?y.push({index:r,html:h}):t.id===c&&m&&y.push({index:r,html:m}),e(X,C({},i))});return y.forEach((t,n)=>{const a=t.index+n+1;_.splice(a,0,e(M,{contentRenderer:r.contentRenderer,children:t.html},a))}),t("div",{className:"answers-table",children:[v,_]})},re=["questionNumber","numberOfQuestions","showTotalQuestions","stepType","isHomework","availablePoints","unpadded","className","children","questionId","multipartBadge","leftHeaderChildren","rightHeaderChildren","headerTitleChildren"],ne=["step","questionNumber","numberOfQuestions","children","className"];let ae,ie,oe,se,le,ce,de,pe,he,me,ue,be,fe=e=>e;const ge=o.div(ae||(ae=fe`
  position: relative;
  display: flex;
...
`),Z.stepCardPadding(),F.card.body.background,((...e)=>s(T||(T=V`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(me||(me=fe`
    ...
    `),"8px")),$e=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:i,stepType:o,isHomework:s,availablePoints:l,unpadded:c,className:d,children:p,questionId:h,multipartBadge:m,leftHeaderChildren:u,rightHeaderChildren:b,headerTitleChildren:f}=r,g=_(r,re);return t(we,C({},g,{children:[m,t(ge,{className:d,children:[n&&s&&"exercise"===o&&t(xe,{children:[t("div",{children:[u,t("div",{className:"question-info",children:[f,e("span",{children:a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`}),i?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",h]})]})]}),t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]})]}),e(ve,{unpadded:c,children:p})]})]}))};$e.displayName="OSStepCard";const ye=t=>{let{step:r,questionNumber:a,numberOfQuestions:i,children:o,className:s}=t,l=_(t,ne);return e($e,C({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:i,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,availablePoints:r.available_points,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:o}))};ye.displayName="OSTaskStepCard";const ke=["disabled","isWaiting","waitingText","children"];let Ce;const _e=o.button(Ce||(Ce=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),Z.stepCardPadding(),F.palette.pale,F.palette.neutral,F.palette.neutralLightBlue,"1rem","2.5rem","1rem","1rem","1rem","1rem",F.palette.neutralLighter,F.palette.neutralLightest,Z.answer(),"1rem","1rem","0.1s ease-in-out",Z.answerHover(),Z.answerChecked(),Z.answerChecked(),Z.answerIncorrect(),Z.answerCorrect(!0),Z.answerCorrectAnswer(),Z.answerIncorrect(),Z.answerIncorrect(!0),Z.popover(),"370px","0.9rem","1.1rem"),Ee=a.forwardRef((r,a)=>{let i,o;const{question:s,correct_answer_id:l,incorrectAnswerId:c,exercise_uid:d,className:p,questionNumber:h,context:m,task:u,hidePreambles:b}=r,{stem_html:f,collaborator_solutions:g=[],formats:w,stimulus_html:x}=s,v=!!l,$=n("openstax-question",p,{"has-correct-answer":v&&!((null!=u?u.is_deleted:void 0)&&"homework"===(null!=u?u.type:void 0)),"has-incorrect-answer":!!c});return null!=d&&(i=e("div",{className:"exercise-uid",children:d})),(()=>{const{displaySolution:e}=r,{collaborator_solutions:t=[]}=s;return e&&t&&t.find(e=>void 0!==e.content_html)})()&&(o=t("div",{className:"detailed-solution",children:[e("div",{className:"header",children:"Detailed solution:"}),e(A,{className:"solution",block:!0,html:g.map(e=>e.content_html).join("")})]})),t(Te,{ref:a,className:$,"data-question-number":h,"data-test-id":"question",children:[e(je,{type:"context",html:m,hidden:b}),e(je,{type:"stimulus",html:x,hidden:b}),e(je,{type:"stem",html:f,hidden:b,questionNumber:h}),r.children,e(te,C({},r,{onChangeAnswer:r.onChange,hasCorrectAnswer:v})),o,r.displayFormats?e(Pe,{formats:w}):void 0,i]})}),je=t=>{const{html:r="",type:n,hidden:a,questionNumber:i}=t;return!0!==a&&r.length>0?e(A,{html:r,"data-question-number":i,className:`question-${n}`,block:!0}):null},Pe=({formats:r=[]})=>t("div",{className:"formats-listing",children:[e("div",{className:"header",children:"Formats:"}),r.map((t,r)=>e("span",{children:t},r))]});let ze,Le,Je=e=>e;const Qe=o.div(ze||(ze=Je`
    ${0}
    display: flex;
    flex-wrap: wrap;
    justify-content: space-between;
...
`),F.palette.neutral,F.palette.neutralDark,e=>e.isOverWordLimit&&Ze,e=>e.isOverWordLimit&&s(De||(De=We`
    border: 2px solid ${0};
  `),F.palette.danger),e=>e.readOnly&&F.palette.neutralCool);Xe.displayName="OSFreeResponseTextArea";const et=t=>e(Ne,C({},t,{children:"Cancel"})),tt=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:i,infoRowChildren:o,isSubmitDisabled:s,pointsChildren:l,question:c,questionNumber:d,saveHandler:p,submitBtnLabel:h,textHasChanged:m,wordLimit:u}=r,b=k(i)>u,f={};return d&&(f["data-question-number"]=d),t(Ge,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(Ke,C({},f,{children:c.stem_html&&e(je,{type:"stem",html:c.stem_html,hidden:!1})})),e(Xe,C({},r,{isOverWordLimit:b,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(Ye,{hasChildren:!!o,children:[o,t("div",{children:[t("span",{children:[k(i)," words"]}),b&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(Qe,{children:[t("div",{className:"points",children:[t("strong",{children:["Points: ",n]}),l]}),t("div",{className:"controls",children:[e(et,{disabled:!m,onClick:a}),e(Ne,{"data-test-id":"submit-answer-btn",disabled:s||b,onClick:p,children:h})]})]})]})};tt.displayName="OSFreeResponse";let rt,nt,at,it,ot,st=e=>e;const lt=o.div(rt||(rt=st`
...
`)),dt=o.div(at||(at=st`
  ...
  font-size: 1.2rem;
  line-height: 1.8rem;
`),Z.popover),pt=r=>e(lt,C({},r.wrapperProps,{children:t(ct,{children:[r.children,t(dt,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),ht=o.div(it||(it=st`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),mt=o(h)(ot||(ot=st`
...
`)),Dt="box-shadow: 0px 1px 4px 0px #00000066;",Wt=o.button(Qt||(Qt=Bt`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",F.palette.neutralDarker,e=>e.isActive?s(Rt||(Rt=Bt`
    ${0}
    & + [data-icon] {
      bottom: 0;
      right: 0;
    }
  `),Dt):null,e=>(e=>{switch(e){case"isStatus":return s(Pt||(Pt=Bt`
        background-color: ${0};
      `),F.palette.neutralBright);case"isCorrect":return s(zt||(zt=Bt`
        color: ${0};
        background-color: #E8F4D8;
      `),F.answer.correct);case"isIncorrect":return s(Lt||(Lt=Bt`
        color: ${0};
        background-color: #F8E8EA;
      `),F.answer.incorrect);default:return s(Jt||(Jt=Bt`
        background-color: ${0};
      `),F.palette.neutralBright)}})(e.variant),Dt),Zt=o(h)(Vt||(Vt=Bt`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Gt=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const r={isCorrect:{icon:w,color:F.answer.correct},isIncorrect:{icon:x,color:F.answer.incorrect}}[t];return e(Zt,{icon:r.icon,color:r.color,height:"16px",width:"16px"})},Kt=({index:r,isActive:n,step:a,goToStep:i})=>t(Ut,{children:[e(Wt,{variant:a.variant,isActive:n,onClick:()=>i(r,a),children:"isStatus"===a.variant?e(Ot,{}):r+1}),e(Gt,{variant:a.variant})]}),Yt=({steps:t,activeIndex:r,goToStep:n})=>e(Ft,{children:t.map((t,a)=>e(Kt,{index:a,isActive:a===r,step:t,goToStep:n},a))});let Xt;const er=o.div(Xt||(Xt=(e=>e)`
  max-width: 1000px;
