...
`),ee.stepCardPadding(),G.card.body.background,((...e)=>s(P||(P=U`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(ke||(ke=_e`
    ...
    `),"8px")),Ie=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:o,stepType:i,isHomework:s,availablePoints:l,unpadded:c,className:d,children:p,questionId:m,multipartBadge:u,leftHeaderChildren:h,rightHeaderChildren:b,headerTitleChildren:f}=r,g=_(r,pe);return t(qe,C({},g,{children:[u,t(Ne,{className:d,children:[n&&s&&"exercise"===i&&t(Se,{children:[t("div",{children:[h,t("div",{className:"question-info",role:"heading","aria-level":2,children:[f,e("span",{children:a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`}),o?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",m]})]})]}),l||b?t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]}):null]}),e(Ae,{unpadded:c,children:p})]})]}))};Ie.displayName="OSStepCard";const Me=t=>{let{step:r,questionNumber:a,numberOfQuestions:o,children:i,className:s}=t,l=_(t,me);return e(Ie,C({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:i}))};Me.displayName="OSTaskStepCard";const Ee=["disabled","isWaiting","waitingText","children"];let Te;const He=i.button(Te||(Te=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`)),ur=i.div(rr||(rr=dr`
  ...
  ${0}
`),e=>e.desktopToolbarEnabled&&s(nr||(nr=dr`
    ${0}
    ${0}
    ${0}
  `),X(ar||(ar=dr`
    ...
    `),pr)),e=>e.mobileToolbarEnabled&&s(sr||(sr=dr`
    ${0}
  `),K(lr||(lr=dr`
      ${0} + ${0} ${0} {
...
`)),Mr="box-shadow: 0px 1px 4px 0px #00000066;",Er=i.button(_r||(_r=Sr`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",G.palette.neutralDarker,e=>e.isActive?s(Nr||(Nr=Sr`
    ${0}
    & + [data-icon] {
      bottom: 0;
      right: 0;
    }
  `),Mr):null,e=>(e=>{switch(e){case"isStatus":return s($r||($r=Sr`
        background-color: ${0};
      `),G.palette.neutralBright);case"isCorrect":return s(kr||(kr=Sr`
        color: ${0};
        background-color: #E8F4D8;
      `),G.answer.correct);case"isIncorrect":return s(yr||(yr=Sr`
        color: ${0};
        background-color: #F8E8EA;
      `),G.answer.incorrect);default:return s(Cr||(Cr=Sr`
        background-color: ${0};
      `),G.palette.neutralBright)}})(e.variant),Mr),Tr=i(b)(qr||(qr=Sr`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Hr=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const r={isCorrect:{icon:$,color:G.answer.correct,label:"Correct"},isIncorrect:{icon:k,color:G.answer.incorrect,label:"Incorrect"}}[t];return e(Tr,{icon:r.icon,color:r.color,height:"16px",width:"16px","aria-label":r.label,"aria-hidden":void 0})},Or=({index:r,isActive:n,step:a,goToStep:o})=>t(Ir,{children:[e(Er,{variant:a.variant,isActive:n,onClick:()=>o(r,a),"aria-current":n?"location":"false","aria-label":"isStatus"===a.variant?"Assignment status":`Question ${r+1}`,children:"isStatus"===a.variant?e(gr,{}):r+1}),e(Hr,{variant:a.variant})]}),jr=({steps:t,activeIndex:r,goToStep:n})=>e(Ar,{"aria-label":"Breadcrumbs",children:t.map((t,a)=>e(Or,{index:a,isActive:a===r,step:t,goToStep:n},a))});let zr;const Pr=i.div(zr||(zr=(e=>e)`
  max-width: 1000px;
...
`),G.palette.light),Fr=()=>e(Pr,{children:e(y,{uniqueKey:"OSLoader"})});export{le as Answer,de as AnswersTable,Ve as CompletionStatus,fr as Exercise,Ot as ExerciseToolbar,ht as FreeResponseInput,mt as FreeResponseTextArea,Ne as InnerStepCard,Fr as Loader,qe as OuterStepCard,jr as ProgressBar,Or as ProgressBarItem,We as Question,Ue as QuestionHtml,Ie as StepCard,Er as StyledItem,Ht as StyledToolbar,Me as TaskStepCard};
