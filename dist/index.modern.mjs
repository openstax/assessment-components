...
`),G.card.header.background,G.palette.gray,X(ue||(ue=$e`
  ...
  `),"8px","8px"));Ce.displayName="StepCardHeader";const Ne=l.div(ge||(ge=$e`
  .step-card-body {
    ${0}
    overflow: auto;
    background: ${0};
...
`),ee.stepCardPadding(),G.card.body.background,((...e)=>c(L||(L=U`@media(max-width: ${0}px) { ${0} }`),600,c(...e)))(we||(we=$e`
    ...
    `),"8px")),_e=r=>{let{questionNumber:n,numberOfQuestions:o,showTotalQuestions:a,stepType:i,isHomework:s,availablePoints:l,unpadded:c,className:d,children:p,questionId:m,multipartBadge:h,leftHeaderChildren:u,rightHeaderChildren:b,headerTitleChildren:f}=r,g=M(r,se);return t(ye,A({},g,{children:[h,t(ke,{className:d,children:[n&&s&&"exercise"===i&&t(Ce,{children:[t("div",{children:[u,t("div",{className:"question-info",children:[f,e("span",{children:o>1?`Questions ${n} - ${n+o-1}`:`Question ${n}`}),a?t("span",{className:"num-questions",children:[" / ",o]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",m]})]})]}),l||b?t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]}):null]}),e(Ne,{unpadded:c,children:p})]})]}))};_e.displayName="OSStepCard";const qe=t=>{let{step:r,questionNumber:o,numberOfQuestions:a,children:i,className:s}=t,l=M(t,le);return e(_e,A({},l,{unpadded:!0,questionNumber:o,numberOfQuestions:a,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:i}))};qe.displayName="OSTaskStepCard";const Se=["disabled","isWaiting","waitingText","children"];let Ae;const Me=l.button(Ae||(Ae=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),G.button.background,G.palette.white,G.button.backgroundHover,G.button.backgroundActive),Ie=t=>{const{disabled:r,isWaiting:n,waitingText:o,children:a}=t,i=M(t,Se);return e(Me,A({},i,{disabled:n||r,children:n&&o||a}))};let Te,Oe,Ee,He,je=e=>e;const Pe=d(Te||(Te=je`
  :root {
...
`)),Le=l.h2(Ee||(Ee=je`
  ...
  margin: 0;
`)),Je=l(({numberOfQuestions:n,numberCompleted:o,handleClick:a,className:i})=>{const s=n===o,l=o>0,c=s?"Next":l?"Continue":"Start";return t(r,{children:[e(Pe,{}),t(ze,{className:i,children:[e(Le,{children:s?"You are done.":l?"Quiz is partially complete.":"No questions have been answered."}),e("p",{children:s?"Great job answering all the questions.":l?`You've completed ${o} of ${n} questions.`:"Begin working on the quiz."}),e(Ie,{"data-test-id":`${c.split(" ")[0].toLowerCase()}-btn`,onClick:()=>a(),children:c})]})]})})(He||(He=je``));let Qe;const Ve=l.div(Qe||(Qe=(e=>e)`
&.step-card-body {
  ${0};
}
...
`)),Bt=l.div(Pt||(Pt=Jt`
  ...
  font-size: 1.2rem;
  line-height: 1.8rem;
`),ee.popover),Ft=r=>e(Qt,A({},r.wrapperProps,{mobile:r.mobile,desktop:r.desktop,"aria-label":r.text,children:t(Vt,{children:[r.children,t(Bt,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),Rt=l.div(zt||(zt=Jt`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),Dt=l(g)(Lt||(Lt=Jt`
...
`)),_r="box-shadow: 0px 1px 4px 0px #00000066;",qr=l.button(vr||(vr=yr`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",G.palette.neutralDarker,e=>e.isActive?c($r||($r=yr`
  ...
  `),_r):null,e=>(e=>{switch(e){case"isStatus":return c(fr||(fr=yr`
        background-color: ${0};
      ...
      `),G.answer.incorrect);default:return c(xr||(xr=yr`
        background-color: ${0};
      `),G.palette.neutralBright)}})(e.variant),_r),Sr=l(g)(kr||(kr=yr`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Ar=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const r={isCorrect:{icon:y,color:G.answer.correct},isIncorrect:{icon:C,color:G.answer.incorrect}}[t];return e(Sr,{icon:r.icon,color:r.color,height:"16px",width:"16px"})},Mr=({index:r,isActive:n,step:o,goToStep:a})=>t(Nr,{children:[e(qr,{variant:o.variant,isActive:n,onClick:()=>a(r,o),"aria-current":n?"location":"false","aria-label":"isStatus"===o.variant?"Assignment status":`Question ${r+1}`,children:"isStatus"===o.variant?e(mr,{}):r+1}),e(Ar,{variant:o.variant})]}),Ir=({steps:t,activeIndex:r,goToStep:n})=>e(Cr,{"aria-label":"Breadcrumbs",children:t.map((t,o)=>e(Mr,{index:o,isActive:o===r,step:t,goToStep:n},o))});let Tr;const Or=l.div(Tr||(Tr=(e=>e)`
  max-width: 1000px;
...
`),G.palette.light),Er=()=>e(Or,{children:e(N,{uniqueKey:"OSLoader"})});export{oe as Answer,ie as AnswersTable,Je as CompletionStatus,pr as Exercise,Mt as ExerciseToolbar,ct as FreeResponseInput,st as FreeResponseTextArea,ke as InnerStepCard,Er as Loader,ye as OuterStepCard,Ir as ProgressBar,Mr as ProgressBarItem,Be as Question,Fe as QuestionHtml,_e as StepCard,qr as StyledItem,At as StyledToolbar,qe as TaskStepCard};
