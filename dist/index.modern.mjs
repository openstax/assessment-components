...
`)),Wt=i.div(Jt||(Jt=Vt`
  ...
  font-size: 1.2rem;
  line-height: 1.8rem;
`),ee.popover),Ut=r=>e(Bt,C({},r.wrapperProps,{mobile:r.mobile,desktop:r.desktop,"aria-label":r.text,children:t(Dt,{children:[r.children,t(Wt,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),Zt=i.div(Rt||(Rt=Vt`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),Gt=i(b)(Qt||(Qt=Vt`
