...
`),oe.card.header.background,oe.palette.gray,le(qe||(qe=He`
  ...
  `),"8px","8px"));Fe.displayName="StepCardHeader";const Le=c.div(Me||(Me=He`
  .step-card-body {
    ${0}
    overflow: auto;
    background: ${0};
...
`),de.stepCardPadding(),oe.card.body.background,((...e)=>p(U||(U=ne`@media(max-width: ${0}px) { ${0} }`),600,p(...e)))(Ie||(Ie=He`
        && .question-feedback {
            margin-left: 0;
    ...
    z-index: 2;
`)),Re=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:d,stepType:c,isHomework:p,availablePoints:u,unpadded:m,className:h,children:b,questionId:g,multipartBadge:f,leftHeaderChildren:w,rightHeaderChildren:x,headerTitleChildren:v,overlayChildren:k}=r,$=T(r,ve);const y=o(null),[C,_]=i(!1),N=a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`,q=s(()=>{_(!0)},[]),A=s(()=>{var e;Array.from((null==(e=document.getElementById("step-card"))?void 0:e.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'))||[]).forEach(e=>{e.setAttribute("tabindex","-1")})},[]);return l(()=>{const e=y.current;return e&&k&&(e.addEventListener("focus",q),A()),()=>{null==e||e.removeEventListener("focus",q)}},[k,y,q,A]),t(je,z({},$,{children:[f,e(Oe,{className:h,children:t("div",z({ref:y},k?{onMouseOver:()=>_(!0),onMouseLeave:()=>_(!1),onBlur:e=>{y.current&&!y.current.contains(e.relatedTarget)&&_(!1)},tabIndex:0}:{},{children:[k&&C&&e(Pe,{id:"overlay-element",children:k}),t("div",{id:"step-card",children:[n&&p&&"exercise"===c&&t(Fe,{className:"step-card-header",children:[t("div",{children:[w,t("h2",{className:"question-info",children:[v,e("span",{children:N}),d?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",g]})]})]}),u||x?t("div",{children:[u&&t("div",{className:"points",children:[u," Points"]}),x]}):null]}),e(Le,{unpadded:m,children:b})]})]}))})]}))};Re.displayName="OSStepCard";const Be=t=>{let{step:r,questionNumber:a,numberOfQuestions:o,children:i,className:s,overlayChildren:l}=t,d=T(t,ke);return e(Re,z({},d,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,overlayChildren:l,children:i}))};Be.displayName="OSTaskStepCard";const Qe=["disabled","isWaiting","waitingText","children"];let De;const Je=c.button(De||(De=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),oe.button.background,oe.palette.white,oe.button.backgroundHover,oe.button.backgroundActive),Ve=t=>{const{disabled:r,isWaiting:n,waitingText:a,children:o}=t,i=T(t,Qe);return e(Je,z({},i,{disabled:n||r,children:n&&a||o}))};let Ue,We,Ze,Ye,Ge,Ke,Xe,et=e=>e;const tt=u(Ue||(Ue=et`
  :root {
...
`),oe.palette.white,oe.palette.black,oe.palette.pale,oe.palette.neutralBright,oe.palette.black,oe.palette.pale,oe.palette.neutralLight,oe.palette.black,oe.palette.pale),st=c(({numberOfQuestions:n,numberCompleted:a,handleClick:o,className:i,scoreSoFar:s,savedScore:l,handleRetry:d})=>{const c=n===a,p=a>0,u=c||0===a&&d||p&&d?"Next":p?"Continue":"Start",m=c?"Retry Quiz":"Resume Quiz",h=c?d:o;return t(r,{children:[e(tt,{}),t(rt,{className:i,children:[e(nt,{children:c?"You are done.":p?"Quiz is partially complete.":"No questions have been answered."}),d?t("div",{children:[e("p",{children:c?"Attempts for this quiz are unlimited. Your highest score will be saved.":"You are in the middle of a quiz attempt. Attempts for this quiz are unlimited. Your highest score will be saved."}),e(ot,{children:t("p",{children:[e("b",{children:"Current Score:"})," ",null!=s?s:"Score unavailable"," | ",e("b",{children:"Saved Score:"})," ",null!=l?l:"Score unavailable"]})})]}):e("p",{children:c?"Great job answering all the questions.":p?`You've completed ${a} of ${n} questions.`:"Begin working on the quiz."}),t(at,{children:[d?e(it,{"data-test-id":"retry-resume-btn",onClick:h,children:m}):null,e(Ve,{"data-test-id":`${u.split(" ")[0].toLowerCase()}-btn`,onClick:()=>o(),children:u})]})]})]})})(Xe||(Xe=et``));let lt;const dt=c.div(lt||(lt=(e=>e)`
&.step-card-body {
  ${0};
}
...
`),oe.palette.neutral,oe.palette.neutralDark,e=>e.isOverWordLimit&&_t,e=>e.isOverWordLimit&&p(yt||(yt=Ct`
    border: 2px solid ${0};
  `),oe.palette.danger),e=>e.readOnly&&oe.palette.neutralCool);St.displayName="OSFreeResponseTextArea";const Mt=t=>e(Ve,z({},t,{children:"Cancel"})),It=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:o,infoRowChildren:i,isSubmitDisabled:s,question:l,questionNumber:d,saveHandler:c,submitBtnLabel:p,textHasChanged:u,wordLimit:m}=r,h=j(o)>m,b={};return d&&(b["data-question-number"]=d),t(Nt,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(qt,z({},b,{children:l.stem_html&&e(pt,{type:"stem",html:l.stem_html,hidden:!1})})),e(St,z({},r,{isOverWordLimit:h,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(At,{hasChildren:!!i,children:[i,t("div",{children:[t("span",{children:[j(o)," words"]}),h&&t("span",{className:"word-limit-error-info",children:["Maximum ",m," words"]})]})]})]}),t(ft,{children:[n?e("div",{className:"points",role:"status",children:t("strong",{children:["Points: ",n]})}):null,t("div",{className:"controls",children:[e(Mt,{disabled:!u,onClick:a}),e(Ve,{"data-test-id":"submit-answer-btn",disabled:s||h,onClick:c,children:p})]})]})]})};It.displayName="OSFreeResponse";const Et=({count:e})=>t("div",{children:[e," attempt",1===e?"":"s"," left"]}),zt=()=>e("div",{children:"Unlimited quiz attempts left"}),Tt=({published_comments:r})=>r?t("div",{children:[e("strong",{children:"Feedback:"})," ",r]}):null,Ht=t=>e(Ve,z({},t,{waitingText:"Saving…",isWaiting:t.isWaiting,"data-test-id":"submit-answer-btn",children:t.willContinue?"Submit & continue":0==t.attempt_number?"Submit":"Re-submit"})),Ot=t=>e(Ve,z({},t,{"data-test-id":"continue-btn",children:t.canUpdateCurrentStep?"Continue":"Next"})),jt=({free_response:t})=>t?e(r,{children:e("div",{className:"free-response",children:t})}):null,Ft=a.forwardRef((r,n)=>{const{question:o,task:i,answer_id_order:s,onAnswerChange:l,feedback_html:d,correct_answer_feedback_html:c,is_completed:p,correct_answer_id:u,incorrectAnswerId:m,choicesEnabled:h,questionNumber:b,answer_id:g,hasMultipleAttempts:f,hasUnlimitedAttempts:w,attempts_remaining:x,published_comments:v,detailedSolution:k,canAnswer:$,needsSaved:y,attempt_number:C,apiIsPending:_,onAnswerSave:N,onNextStep:q,canUpdateCurrentStep:A,displaySolution:S,available_points:M,free_response:I,labelAnswers:E,show_all_feedback:z,tableFeedbackEnabled:T,hasFeedback:H,previewMode:O}=r,[j,F]=a.useState(!1);return a.useEffect(()=>{j&&p&&(q(b-1),F(!1))},[q,b,j,p]),t("div",{"data-test-id":"student-exercise-question",children:[e(ct,{ref:n,task:i,question:o,answerIdOrder:s,choicesEnabled:h,answer_id:g,questionNumber:b,onChange:l,feedback_html:d,correct_answer_feedback_html:c,correct_answer_id:p?u:null,incorrectAnswerId:m,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:S,labelAnswers:E,show_all_feedback:z,tableFeedbackEnabled:T,previewMode:O,children:e(jt,{free_response:I})}),O&&k||!O?e(ft,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[t("div",{className:"points",role:"status",children:[M?t("strong",{children:["Points: ",M]}):null,t("span",{className:"attempts-left",children:[f&&x>0&&e(Et,{count:x}),w?e(zt,{}):null]}),e(Tt,{published_comments:v}),k&&t("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(P,{html:k})]})]}),e("div",{className:"controls",children:$&&y||j?e(Ht,{disabled:_||!g||j,isWaiting:_||j,attempt_number:C,onClick:()=>{var e;N("string"==typeof(e=o.id)?parseInt(e,10):e),H||F(!0)},willContinue:!H}):e(Ot,{onClick:()=>q(b-1),canUpdateCurrentStep:A})})]})}):null]})}),Lt={extensions:[],showProcessingMessages:!1,skipStartupTypeset:!0,styles:{"#MathJax_MSIE_Frame":{left:"",right:0,visibility:"hidden"},"#MathJax_Message":{left:"",right:0,visibility:"hidden"}},tex2jax:{displayMath:[["‌‌‌","‌‌‌"]],inlineMath:[["​​​","​​​"]]}},Pt=e=>{const t=(e=>Array.from(e.querySelectorAll(".MathJax math")))(e);return Array.from(e.querySelectorAll("math")).filter(e=>-1===t.indexOf(e))},Rt=e=>{const t=[];for(const r of Array.from(e.querySelectorAll("[data-math]:not(.math-rendered)"))){const e=r.getAttribute("data-math");r.classList.contains("math-marked")||(r.textContent="div"===r.tagName.toLowerCase()?`‌‌‌${e}‌‌‌`:`​​​${e}​​​`,r.classList.add("math-marked")),t.push(r)}return t},Bt=(e,t,r=5)=>{r>0&&(Rt(e).length||Pt(e).length)?setTimeout(()=>{Bt(e,t,r-1)},200):t()},Qt=(e,t)=>new Promise(r=>{(function(e,t){const r=Rt(e);t.MathJax.Hub.Queue(((e,t)=>()=>{f(e)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e),(e=>()=>{const t=[];for(const r of e)t.push(r.className+=" math-rendered")})(e))})(r,t),((e,t)=>()=>{const r=Pt(e);f(r)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e))})(e,t))})(e,t),t.MathJax.Hub.Queue(()=>{Bt(e,r)})}),Dt=g((e,t)=>h(Qt,100,{leading:!0,trailing:!1}).bind(null,e,t));Dt.cache=new w;const Jt=b((e=window)=>new Promise(t=>{const r=()=>{e.MathJax.HTML.Cookie.prefix="mathjax",e.MathJax.Hub.Configured(),e.MathJax.Hub.Register.StartupHook("End",()=>{t()})};if(!document.getElementById("MathJax-Script")){const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&delayStartupUntil=configured",e.id="MathJax-Script",e.async=!0,document.head.appendChild(e)}e.MathJax&&e.MathJax.Hub?(e.MathJax.Hub.Config(Lt),e.MathJax.Hub.processSectionDelay=0,r()):(Lt.AuthorInit=r,e.MathJax=Lt)}));let Vt,Ut,Wt,Zt,Yt,Gt=e=>e;const Kt=c.div(Vt||(Vt=Gt`
  position: absolute;
  background: #fff;
  width: 4.5rem;
  border: 1px solid ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",oe.palette.neutralDarker,e=>e.isActive?p(Ur||(Ur=Zr`
  ...
  `),Kr):null,e=>(e=>{switch(e){case"isStatus":return p(Rr||(Rr=Zr`
        background-color: ${0};
      `),oe.palette.neutralBright);case"isCorrect":return p(Br||(Br=Zr`
        color: ${0};
        background-color: #E8F4D8;
      `),oe.answer.correct);case"isIncorrect":return p(Qr||(Qr=Zr`
        color: ${0};
        background-color: #F8E8EA;
      `),oe.answer.incorrect);case"isIncomplete":return p(Dr||(Dr=Zr`
        background-color: ${0};
