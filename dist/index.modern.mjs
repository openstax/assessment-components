...
`),oe.card.header.background,oe.card.header.background,oe.palette.white,oe.palette.neutralDarker),ur=["numberOfQuestions","questionNumber","step","exercise","show_all_feedback","scrollToQuestion","exerciseIcons","overlayChildren","labelAnswers","previewMode"];let mr,hr,br,fr,gr,wr,xr,vr,kr,$r,yr=e=>e;const Cr=d(De)(mr||(mr=yr`
  font-size: calc(1.8rem * var(--content-text-scale));
...
`),e=>e.desktopToolbarEnabled&&p(fr||(fr=yr`
  ...
  `),ie(kr||(kr=yr`
    ...
    `),Qt,je,ze))),qr=r=>t(Nr,{desktopToolbarEnabled:r.desktopToolbarEnabled,mobileToolbarEnabled:r.mobileToolbarEnabled,children:[e(Vt,{icons:r.exerciseIcons}),e(Cr,T({overlayChildren:r.overlayChildren},r))]}),Ar=({exercise:n})=>t(r,{children:[n.context&&e(P,{className:"step-card-body exercise-context",block:!0,html:n.context}),n.stimulus_html&&e(P,{className:"step-card-body exercise-stimulus",block:!0,html:n.stimulus_html})]}),Sr=d(r=>{let{numberOfQuestions:n,questionNumber:o,step:i,exercise:s,show_all_feedback:l,scrollToQuestion:d,exerciseIcons:p,overlayChildren:u,labelAnswers:h=!0,previewMode:b=!1}=r,f=H(r,ur);const g="feedback_html"in i,w=a.useRef([]),x=a.useRef(null),v=a.useCallback(()=>{x.current&&(async(e,t=window)=>{await Ft(),t&&t.MathJax&&t.MathJax.Hub?e.querySelector("[data-math]:not(.math-rendered), math:not(.math-rendered)")?jt(e,t)():Promise.resolve():(console.warn("Warning: Expected MathJax to be initialized."),Promise.resolve())})(x.current)},[]);a.useEffect(()=>{const e=d&&w.current[d];e&&m(e)},[d,s]);const k=Object.values(p||{}).some(({location:e})=>{var t;return null==e||null==(t=e.toolbar)?void 0:t.desktop}),$=Object.values(p||{}).some(({location:e})=>{var t;return null==e||null==(t=e.toolbar)?void 0:t.mobile});return t(F.Provider,{value:v,children:[e(_r,{}),e(qr,T({step:i,questionNumber:o,numberOfQuestions:g?n:s.questions.length,rightHeaderChildren:p?e(cr,{exercise:s,icons:p}):null,showTotalQuestions:g,desktopToolbarEnabled:k,mobileToolbarEnabled:$},p?{exerciseIcons:p}:null,{className:f.className,overlayChildren:u,children:t("div",{ref:x,children:[e(Ar,{exercise:s}),s.questions.map((e,t)=>{var r;const n=T({},g?i:f.questionStates[e.id]);return c(It,T({},f,T({},n,{available_points:void 0}),{ref:e=>w.current[o+t]=e,exercise_uid:s.uid,key:e.id,question:e,questionNumber:o+t,choicesEnabled:n.canAnswer,displaySolution:!0,detailedSolution:null==(r=n.solution)?void 0:r.content_html,show_all_feedback:l,labelAnswers:h,tableFeedbackEnabled:l&&!g,canUpdateCurrentStep:"canUpdateCurrentStep"in f?f.canUpdateCurrentStep:!(t+1===s.questions.length),previewMode:b}))})]})}))]})})($r||($r=yr`
  ${0}
