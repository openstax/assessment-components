...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",F.palette.neutralDarker,e=>e.isActive?"box-shadow: 0px 1px 4px 0px #00000066;":null,e=>(e=>{switch(e){case"isStatus":return s(Pt||(Pt=Vt`
      ...
      `),F.answer.incorrect);default:return s(Jt||(Jt=Vt`
        background-color: ${0};
      `),F.palette.neutralBright)}})(e.variant)),Dt=o(h)(Rt||(Rt=Vt`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Wt=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const r={isCorrect:{icon:w,color:F.answer.correct},isIncorrect:{icon:x,color:F.answer.incorrect}}[t];return e(Dt,{icon:r.icon,color:r.color,height:"16px",width:"16px"})},Zt=({index:r,isActive:n,step:a,goToStep:i})=>t(Ft,{children:[e(Ut,{variant:a.variant,isActive:n,onClick:()=>i(r,a),children:"isStatus"===a.variant?e(Ot,{}):r+1}),e(Wt,{variant:a.variant})]}),Gt=({steps:t,activeIndex:r,goToStep:n})=>e(Bt,{children:t.map((t,a)=>e(Zt,{index:a,isActive:a===r,step:t,goToStep:n},a))});let Kt;const Yt=o.div(Kt||(Kt=(e=>e)`
  max-width: 1000px;
...
`),F.palette.light),Xt=()=>e(Yt,{children:e(v,{uniqueKey:"OSLoader"})});export{X as Answer,te as AnswersTable,He as CompletionStatus,Ht as Exercise,tt as FreeResponseInput,Xe as FreeResponseTextArea,ge as InnerStepCard,Xt as Loader,we as OuterStepCard,Gt as ProgressBar,Zt as ProgressBarItem,Ee as Question,je as QuestionHtml,$e as StepCard,Ut as StyledItem,ye as TaskStepCard};
