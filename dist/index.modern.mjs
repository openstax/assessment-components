...
`),K.stepCardPadding(),D.palette.pale,D.palette.neutral,D.palette.neutralLightBlue,"1rem","2.5rem","1rem","1rem","1rem","1rem",D.palette.neutralLighter,D.palette.neutralLightest,K.answer(),"1rem","3.6rem","1rem","0.1s ease-in-out",K.answerHover(),K.answerChecked(),K.answerChecked(),K.answerIncorrect(),K.answerCorrect(),K.answerCorrectAnswer(),K.answerIncorrect(),K.popover(),"370px","0.9rem","1.1rem"),He=a.forwardRef((r,a)=>{let o,i;const{question:s,correct_answer_id:l,incorrectAnswerId:d,exercise_uid:c,className:p,questionNumber:m,context:h,task:u,hidePreambles:b}=r,{stem_html:g,collaborator_solutions:w=[],formats:f,stimulus_html:x}=s,$=!!l,y=n("openstax-question",p,{"has-correct-answer":$&&!((null!=u?u.is_deleted:void 0)&&"homework"===(null!=u?u.type:void 0)),"has-incorrect-answer":!!d});return null!=c&&(o=e("div",{className:"exercise-uid",children:c})),(()=>{const{displaySolution:e}=r,{collaborator_solutions:t=[]}=s;return e&&t&&t.find(e=>void 0!==e.content_html)})()&&(i=t("div",{className:"detailed-solution",children:[e("div",{className:"header",children:"Detailed solution:"}),e(_,{className:"solution",block:!0,html:w.map(e=>e.content_html).join("")})]})),t(Me,{ref:a,className:y,"data-question-number":m,"data-test-id":"question",children:[e(Ie,{type:"context",html:h,hidden:b}),e(Ie,{type:"stimulus",html:x,hidden:b}),e(Ie,{type:"stem",html:g,hidden:b,questionNumber:m}),r.children,e(M,v({},r,{onChangeAnswer:r.onChange,hasCorrectAnswer:$})),i,r.displayFormats?e(Oe,{formats:f}):void 0,o]})}),Ie=t=>{const{html:r="",type:n,hidden:a,questionNumber:o}=t;return!0!==a&&r.length>0?e(_,{html:r,"data-question-number":o,className:`question-${n}`,block:!0}):null},Oe=({formats:r=[]})=>t("div",{className:"formats-listing",children:[e("div",{className:"header",children:"Formats:"}),r.map((t,r)=>e("span",{children:t},r))]});let Te,je,Le=e=>e;const Pe=i.div(Te||(Te=Le`
    ${0}
    display: flex;
    flex-wrap: wrap;
    justify-content: space-between;
...
`),D.palette.neutral,D.palette.neutralDark,e=>e.isOverWordLimit&&Fe,e=>e.isOverWordLimit&&s(Qe||(Qe=Ve`
    border: 2px solid ${0};
  `),D.palette.danger),e=>e.readOnly&&D.palette.neutralCool);Ge.displayName="OSFreeResponseTextArea";const Ze=t=>e(ve,v({},t,{children:"Cancel"})),Ke=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:o,infoRowChildren:i,isSubmitDisabled:s,pointsChildren:l,question:d,questionNumber:c,saveHandler:p,submitBtnLabel:m,textHasChanged:h,wordLimit:u}=r,b=y(o)>u,g={};return c&&(g["data-question-number"]=c),t(Ue,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(De,v({},g,{children:d.stem_html&&e(Ie,{type:"stem",html:d.stem_html,hidden:!1})})),e(Ge,v({},r,{isOverWordLimit:b,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(We,{hasChildren:!!i,children:[i,t("div",{children:[t("span",{children:[y(o)," words"]}),b&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(Pe,{children:[t("div",{className:"points",children:[t("strong",{children:["Points: ",n]}),l]}),t("div",{className:"controls",children:[e(Ze,{disabled:!h,onClick:a}),e(ve,{"data-test-id":"submit-answer-btn",disabled:s||b,onClick:p,children:m})]})]})]})};Ke.displayName="OSFreeResponse";let Ye,Xe,et,tt,rt,nt=e=>e;const at=i.div(Ye||(Ye=nt`
