...
`),oe.button.background,oe.palette.white,oe.button.backgroundHover,oe.button.backgroundActive),Ve=t=>{const{disabled:r,isWaiting:n,waitingText:a,children:o}=t,i=O(t,Qe);return e(Je,T({},i,{disabled:n||r,children:n&&a||o}))};let Ue,We,Ze,Ge,Ke=e=>e;const Ye=u(Ue||(Ue=Ke`
  :root {
...
`),oe.palette.neutral,oe.palette.neutralDark,e=>e.isOverWordLimit&&xt,e=>e.isOverWordLimit&&p(gt||(gt=wt`
  ...
  ${0}
`),oe.palette.light,"2rem","2rem",oe.palette.neutral,oe.palette.neutralDarker,oe.palette.neutralDarker,e=>!e.desktop&&p(Lt||(Lt=Rt`
    ${0}
    ${0}
  `),le(Bt||(Bt=Rt`
      display: none;
...
`)),Jr="box-shadow: 0px 1px 4px 0px #00000066;",Vr=d.button(Pr||(Pr=Dr`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",oe.palette.neutralDarker,e=>e.isActive?p(Lr||(Lr=Dr`
  ...
  `),Jr):null,e=>(e=>{switch(e){case"isStatus":return p(Or||(Or=Dr`
        background-color: ${0};
      ...
      `),oe.palette.neutralBright);default:return p(Fr||(Fr=Dr`
        background-color: ${0};
      `),oe.palette.neutralLight)}})(e.variant),Jr),Ur=d(x)(Br||(Br=Dr`
  color: ${0};
  position: absolute;
  bottom: 0.4rem;
  right: 0.3rem;
