...
`)),Wt="box-shadow: 0px 1px 4px 0px #00000066;",Zt=o.button(Rt||(Rt=Ft`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",F.palette.neutralDarker,e=>e.isActive?Wt:null,e=>(e=>{switch(e){case"isStatus":return s(zt||(zt=Ft`
        background-color: ${0};
      ...
      `),F.answer.incorrect);default:return s(Qt||(Qt=Ft`
        background-color: ${0};
      `),F.palette.neutralBright)}})(e.variant),Wt),Gt=o(t=>{let r=_(t,Tt);return e(h,C({},r))})(Vt||(Vt=Ft`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
...
`),e=>e.color,e=>e.isActive?s(Bt||(Bt=Ft`
    bottom: 0;
    right: 0;
  `)):null),Kt=({variant:t,isActive:r})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const n={isCorrect:{icon:w,color:F.answer.correct},isIncorrect:{icon:x,color:F.answer.incorrect}}[t];return e(Gt,{icon:n.icon,color:n.color,height:"16px",width:"16px",isActive:r})},Yt=({index:r,isActive:n,step:i,goToStep:a})=>t(Dt,{children:[e(Zt,{variant:i.variant,isActive:n,onClick:()=>a(r,i),children:"isStatus"===i.variant?e(Ot,{}):r+1}),e(Kt,{variant:i.variant,isActive:n})]}),Xt=({steps:t,activeIndex:r,goToStep:n})=>e(Ut,{children:t.map((t,i)=>e(Yt,{index:i,isActive:i===r,step:t,goToStep:n},i))});let er;const tr=o.div(er||(er=(e=>e)`
  max-width: 1000px;
...
`),F.palette.light),rr=()=>e(tr,{children:e(v,{uniqueKey:"OSLoader"})});export{X as Answer,te as AnswersTable,He as CompletionStatus,Ht as Exercise,tt as FreeResponseInput,Xe as FreeResponseTextArea,ge as InnerStepCard,rr as Loader,we as OuterStepCard,Xt as ProgressBar,Yt as ProgressBarItem,Ee as Question,je as QuestionHtml,$e as StepCard,Zt as StyledItem,ye as TaskStepCard};
