import{jsx as e,jsxs as r,Fragment as t}from"react/jsx-runtime.js";import n from"classnames";import a,{createElement as o}from"react";import i,{css as s}from"styled-components";const l="abcdefghijklmnopqrstuvwxyz",d=function(e,r){return e.id===r};function c(e){const r=e.trim().match(/\b[-?(\w+)?]+\b/gi);return r?r.length:0}function p(){return p=Object.assign?Object.assign.bind():function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e},p.apply(this,arguments)}function m(e,r){if(null==e)return{};var t,n,a={},o=Object.keys(e);for(n=0;n<o.length;n++)r.indexOf(t=o[n])>=0||(a[t]=e[t]);return a}const h=["html","component","block"],u=r=>{let{html:t,component:n,block:o=!1}=r,i=m(r,h);return void 0!==n?a.cloneElement(n,p({html:t},i)):e(o?"div":"span",p({dangerouslySetInnerHTML:{__html:t}},i))},b=r=>e("aside",{children:e(u,{component:r.contentRenderer,className:n("question-feedback-content","has-html",r.className),html:r.children,block:!0})}),g=t=>{const a=n("question-feedback",t.position||"bottom");return r("aside",{className:a,children:[e("div",{className:"arrow","aria-label":"Answer Feedback"}),e(b,p({},t,{children:t.children}))]})},w=a=>{const{type:o,iter:i,answer:s,disabled:c,onKeyPress:p,qid:m,chosenAnswer:h,correctAnswerId:g,incorrectAnswerId:w,hasCorrectAnswer:f,answered_count:x,contentRenderer:$,show_all_feedback:k}=a;let v,y,_;const N=((e,r)=>Boolean((r||[]).find(r=>r==e.id)))(s,h),C=function(e,r){if(!e.id&&!r)return e.isCorrect;let t=e.id===r;return null!=e.correctness&&(t="1.0"===e.correctness),t}(s,g),q=d(s,w),S=e("div",{className:"correct-incorrect",children:C&&a.correctIncorrectIcon}),A=n("answers-answer",{disabled:c,"answer-checked":N,"answer-correct":C&&"student-mpp"!==o,"answer-incorrect":w&&d(s,w)});let I,O,T=`${N?"Selected ":""}Choice ${l[i]}`;f&&(T+=`(${C?"Correct":"Incorrect"} Answer)`),T+=":";const H=()=>I&&I(s);if(f||"teacher-review"===o||"teacher-preview"===o||"student-mpp"===o||({onChangeAnswer:I}=a),I&&(O=e("input",{type:"radio",className:"answer-input-box",checked:N,id:`${m}-option-${i}`,name:`${m}-options`,onChange:H,disabled:c})),k&&s.feedback_html&&(y=e(b,{contentRenderer:$,children:s.feedback_html},"question-mc-feedback")),"teacher-review"===o){let t=0;s.selected_count&&x&&(t=Math.round(s.selected_count/x*100)),_=e("span",{className:"selected-count","data-percent":`${t}`,children:s.selected_count}),v=r("div",{className:"review-wrapper",children:[r("div",{className:n("review-count",{green:C,red:!C}),children:[_,e("span",{className:n("letter",{green:C,red:!C}),children:l[i]})]}),r("div",{className:"answer-answer",children:[e(u,{className:"answer-content",component:$,html:s.content_html}),y]})]})}else v=r(t,{children:["teacher-preview"===o&&S,_,O,r("label",{onKeyPress:p,htmlFor:`${m}-option-${i}`,className:"answer-label",children:[e("span",{className:"answer-letter-wrapper",children:e("button",{onClick:H,"aria-label":T,className:"answer-letter",disabled:c||q,"data-test-id":`answer-choice-${l[i]}`,children:l[i]})}),r("div",{className:"answer-answer",children:[e(u,{className:"answer-content",component:$,html:s.content_html}),y]})]})]});return e("div",{className:"openstax-answer",children:e("section",{role:"region",className:A,children:v})})};w.displayName="OSAnswer";const f="student",x=t=>{let n=0;const{question:a,hideAnswers:o,type:i=f,answered_count:s,choicesEnabled:l,correct_answer_id:d,incorrectAnswerId:c,answer_id:m,feedback_html:h,correct_answer_feedback_html:u,show_all_feedback:b=!1,hasCorrectAnswer:x,onChangeAnswer:$,onKeyPress:k,answerIdOrder:v,instructions:y}=t;if(o)return null;const{id:_}=a,N=[],C={qid:_||"auto-"+n++,correctAnswerId:d,incorrectAnswerId:c,hasCorrectAnswer:x,chosenAnswer:[m],onChangeAnswer:$,type:i,answered_count:s,disabled:!l,show_all_feedback:b,onKeyPress:k},q=(v?(e=>{const{answers:r}=a;return r.slice().sort((r,t)=>e.indexOf(r.id)-e.indexOf(t.id))})(v):a.answers).map((r,t)=>{const n={answer:p({},r,{question_id:"string"==typeof a.id?parseInt(a.id,10):a.id}),iter:t,key:`${C.qid}-option-${t}`},o=Object.assign({},n,C);return r.id===c&&h?N.push({index:t,html:h}):r.id===d&&u&&N.push({index:t,html:u}),e(w,p({},o))});return N.forEach((r,n)=>{const a=r.index+n+1;q.splice(a,0,e(g,{contentRenderer:t.contentRenderer,children:r.html},a))}),r("div",{className:"answers-table",children:[y,q]})};let $,k,v,y,_,N,C,q,S,A,I,O,T,H=e=>e;const P={red:"#ca2026",danger:"#c2002f",darkRed:"#c22032",lightRed:"#e298a0",green:"#77af42",lightGreen:"#8bc753",darkGreen:"#63a524",paleYellow:"#ffffbb",teal:"#0dc0de",blue:"#007da4",lightBlue:"#34bdd8",neutralLightBlue:"#0dc0dc",tangerine:"#ffbd3e",gray:"#5e5e5e",darkGray:"#757575",pale:"#d5d5d5",light:"#e4e4e4",white:"#ffffff",neutralLightest:"#f9f9f9",neutralCool:"#f6f7f8",neutralBright:"#f5f5f5",neutralLighter:"#f1f1f1",neutralLight:"#e5e5e5",neutralMedium:"#a0a0a0",neutral:"#818181",neutralThin:"#6f6f6f",neutralDark:"#5f6163",neutralFeedback:"#555",neutralDarker:"#424242",black:"#000000",orange:"#D4450C"},j={palette:P,answer:{color:P.lightBlue,correct:{color:P.green,background:"#77af42"},incorrect:{color:P.red,background:P.red},checked:P.lightBlue,hover:P.neutralDark,label:{color:P.neutralMedium,colorHover:P.neutralDark,colorSelected:P.lightBlue},feedback:{arrowOuterColor:"rgba(0, 0, 0, 0.25)",popover:{borderColor:"rgba(0, 0, 0, 0.2)"}}},card:{background:"#daf3f8"},button:{background:P.orange,backgroundHover:"#E74B0D",backgroundActive:"#C5400B"},freeResponse:{color:P.neutralDark,background:P.neutralLighter}},z=(...e)=>s($||($=H`@media(max-width: ${0}px) { ${0} }`),600,s(...e)),L=(...e)=>s(k||(k=H`@media(max-width: ${0}px) { ${0} }`),999,s(...e)),R=(...e)=>s(v||(v=H`@media(min-width: ${0}px) { ${0} }`),1e3,s(...e)),B={answer:()=>s(_||(_=H`
  ...
  `),e.color,e.color,e.background,j.palette.white),answerChecked:()=>B.answerColor({color:j.answer.checked,background:j.answer.checked}),answerCorrect:()=>B.answerColor(j.answer.correct),answerIncorrect:()=>B.answerColor(j.answer.incorrect),answerHover:()=>s(C||(C=H`
    color: ${0};
    .answer-letter {
      border-color: ${0};
    }
  ...
  `),j.answer.correct.color,j.answer.correct.color,j.answer.correct.color,B.answerCorrectText(),999,999,B.answerCorrectText()),resetText:()=>s(A||(A=H`
...
`),B.stepCardPadding(),j.palette.pale,j.palette.neutral,j.palette.neutralLightBlue,"1rem","2.5rem","1.5rem","1rem","1.5rem","1rem",j.palette.neutralLighter,j.palette.neutralLightest,B.answer(),"1rem","1.5rem","0.1s ease-in-out",B.answerHover(),B.answerChecked(),B.answerChecked(),B.answerIncorrect(),B.answerCorrect(),B.answerCorrectAnswer(),B.answerIncorrect(),B.resetText(),"1px",j.answer.feedback.popover.borderColor,j.palette.white,"370px","15px","1rem","1rem",j.palette.neutral,"20px","15px","15px","1px","20px","15px","20px",j.answer.feedback.popover.borderColor,"1px",j.palette.white,"2rem","2rem"),F=t=>{let a,o;const{question:i,correct_answer_id:s,incorrectAnswerId:l,exercise_uid:d,className:c,questionNumber:m,context:h,task:b,hidePreambles:g}=t,{stem_html:w,collaborator_solutions:f=[],formats:$,stimulus_html:k}=i,v=!!s,y=n("openstax-question",c,{"has-correct-answer":v&&!((null!=b?b.is_deleted:void 0)&&"homework"===(null!=b?b.type:void 0)),"has-incorrect-answer":!!l});return null!=d&&(a=e("div",{className:"exercise-uid",children:d})),(()=>{const{displaySolution:e}=t,{collaborator_solutions:r=[]}=i;return e&&r&&r.find(e=>void 0!==e.content_html)})()&&(o=r("div",{className:"detailed-solution",children:[e("div",{className:"header",children:"Detailed solution:"}),e(u,{className:"solution",block:!0,html:f.map(e=>e.content_html).join("")})]})),r(E,{className:y,"data-question-number":m,"data-test-id":"question",children:[e(Q,{type:"context",html:h,hidden:g}),e(Q,{type:"stimulus",html:k,hidden:g}),e(Q,{type:"stem",html:w,hidden:g,questionNumber:m}),t.children,e(x,p({},t,{onChangeAnswer:t.onChange,hasCorrectAnswer:v})),o,t.displayFormats?e(U,{formats:$}):void 0,a]})},Q=r=>{const{html:t="",type:n,hidden:a,questionNumber:o}=r;return!0!==a&&t.length>0?e(u,{html:t,"data-question-number":o,className:`question-${n}`,block:!0}):null},U=({formats:t=[]})=>r("div",{className:"formats-listing",children:[e("div",{className:"header",children:"Formats:"}),t.map((r,t)=>e("span",{children:r},t))]}),W=["disabled","isWaiting","waitingText","children"];let M;const G=i.button(M||(M=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),j.button.background,j.palette.white,j.button.backgroundHover,j.button.backgroundActive),K=r=>{const{disabled:t,isWaiting:n,waitingText:a,children:o}=r,i=m(r,W);return e(G,p({},i,{disabled:n||t,children:n&&a||o}))};let V,Y,J=e=>e;const X=i.div(V||(V=J`
    ...
    ${0}
`),B.stepCardPadding(),j.palette.pale,R(Y||(Y=J`
...
`),B.stepCardPadding()),le=i.div(re||(re=oe`
  font-size: 2rem;
  line-height: 1.68em;
  position: relative;
`)),de=i.div(te||(te=oe`
...
`),j.palette.neutral,j.palette.neutralDark,e=>e.isOverWordLimit&&ie,e=>e.isOverWordLimit&&s(ae||(ae=oe`
    border: 2px solid ${0};
  `),j.palette.danger),e=>e.readOnly&&j.palette.neutralCool);ce.displayName="OSFreeResponseTextArea";const pe=r=>e(K,p({},r,{children:"Cancel"})),me=t=>{const{availablePoints:n,cancelHandler:a,defaultValue:o,infoRowChildren:i,isSubmitDisabled:s,pointsChildren:l,question:d,questionNumber:m,saveHandler:h,submitBtnLabel:u,textHasChanged:b,wordLimit:g}=t,w=c(o)>g,f={};return m&&(f["data-question-number"]=m),r(se,{"data-test-id":"student-free-response",children:[r("div",{className:"step-card-body",children:[e(le,p({},f,{children:d.stem_html&&e(Q,{type:"stem",html:d.stem_html,hidden:!1})})),e(ce,p({},t,{isOverWordLimit:w,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),r(de,{hasChildren:!!i,children:[i,r("div",{children:[r("span",{children:[c(o)," words"]}),w&&r("span",{className:"word-limit-error-info",children:["Maximum ",g," words"]})]})]})]}),r(X,{children:[r("div",{className:"points",children:[r("strong",{children:["Points: ",n]}),l]}),r("div",{className:"controls",children:[e(pe,{disabled:!b,onClick:a}),e(K,{"data-test-id":"submit-answer-btn",disabled:s||w,onClick:h,children:u})]})]})]})};me.displayName="OSFreeResponse";const he=["questionNumber","numberOfQuestions","stepType","isHomework","availablePoints","unpadded","className","children","questionId","multipartBadge","leftHeaderChildren","rightHeaderChildren","headerTitleChildren"],ue=["step","questionNumber","numberOfQuestions","children","className"];let be,ge,we,fe,xe,$e,ke,ve,ye,_e,Ne,Ce,qe=e=>e;const Se=i.div(be||(be=qe`
  position: relative;
  display: flex;
  flex-direction: column;
  flex: 1 1 auto;
...
`),j.card.background,j.palette.gray,R($e||($e=qe`
  ...
  `),"8px","8px"));Ie.displayName="StepCardHeader";const Oe=i.div(ye||(ye=qe`
  .step-card-body {
    ${0}
...
`),B.stepCardPadding(),((...e)=>s(y||(y=H`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(_e||(_e=qe`
        && .question-feedback {
            margin-left: 0;
    ...
    `),"8px")),Te=t=>{let{questionNumber:n,numberOfQuestions:a,stepType:o,isHomework:i,availablePoints:s,unpadded:l,className:d,children:c,questionId:h,multipartBadge:u,leftHeaderChildren:b,rightHeaderChildren:g,headerTitleChildren:w}=t,f=m(t,he);return r(Ae,p({},f,{children:[u,r(Se,{className:d,children:[n&&i&&"exercise"===o&&r(Ie,{children:[r("div",{children:[b,r("div",{className:"question-info",children:[w,e("span",{children:a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`}),r("span",{className:"num-questions",children:[" / ",a]}),e("span",{className:"separator",children:"|"}),r("span",{className:"question-id",children:["ID: ",h]})]})]}),r("div",{children:[s&&r("div",{className:"points",children:[s," Points"]}),g]})]}),e(Oe,{unpadded:l,children:c})]})]}))};Te.displayName="OSStepCard";const He=r=>{let{step:t,questionNumber:a,numberOfQuestions:o,children:i,className:s}=r,l=m(r,ue);return e(Te,p({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in t?t.type:"exercise",isHomework:!("task"in t)||void 0===t.task||"homework"===t.task.type,"data-task-step-id":t.id,availablePoints:t.available_points,className:n(`${"type"in t?t.type:"exercise"}-step`,s),questionId:t.uid,children:i}))};He.displayName="OSTaskStepCard";const Pe=({count:e})=>r("div",{children:[e," attempt",1===e?"":"s"," left"]}),je=({published_comments:t})=>t?r("div",{children:[e("strong",{children:"Feedback:"})," ",t]}):null,ze=r=>e(K,p({},r,{waitingText:"Saving…",isWaiting:r.isWaiting,"data-test-id":"submit-answer-btn",children:0==r.attempt_number?"Submit":"Re-submit"})),Le=r=>e(K,{onClick:r.onNextStep,"data-test-id":"continue-btn",children:r.canUpdateCurrentStep?"Continue":"Next"}),Re=({free_response:r})=>r?e(t,{children:e("div",{className:"free-response",children:r})}):null,Be=t=>{const{question:n,task:a,answer_id_order:o,onAnswerChange:i,feedback_html:s,correct_answer_feedback_html:l,is_completed:d,correct_answer_id:c,incorrectAnswerId:p,choicesEnabled:m,questionNumber:h,answer_id:b,hasMultipleAttempts:g,attempts_remaining:w,published_comments:f,detailedSolution:x,canAnswer:$,needsSaved:k,attempt_number:v,apiIsPending:y,onAnswerSave:_,onNextStep:N,canUpdateCurrentStep:C,displaySolution:q,available_points:S,free_response:A,show_all_feedback:I}=t;return r("div",{"data-test-id":"student-exercise-question",children:[e(F,{task:a,question:n,answerIdOrder:o,choicesEnabled:m,answer_id:b,questionNumber:h,onChange:i,feedback_html:s,correct_answer_feedback_html:l,correct_answer_id:d?c:null,incorrectAnswerId:p,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:q,show_all_feedback:I,children:e(Re,{free_response:A})}),e(X,{className:"step-card-footer",children:r("div",{className:"step-card-footer-inner",children:[r("div",{className:"points",children:[r("strong",{children:["Points: ",S]}),e("span",{className:"attempts-left",children:g&&w>0&&e(Pe,{count:w})}),e(je,{published_comments:f}),x&&r("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(u,{html:x})]})]}),e("div",{className:"controls",children:$&&k?e(ze,{disabled:y||!b,isWaiting:y,attempt_number:v,onClick:()=>{return _("string"==typeof(e=n.id)?parseInt(e,10):e);var e}}):e(Le,{onNextStep:N,canUpdateCurrentStep:C})})]})})]})},De=["numberOfQuestions","questionNumber","step","exercise","show_all_feedback"];let Ee;const Fe=i(He)(Ee||(Ee=(e=>e)`
  font-size: 1.8rem;
  line-height: 3rem;
`)),Qe=({exercise:n})=>r(t,{children:[n.context&&e(u,{className:"step-card-body exercise-context",block:!0,html:n.context}),n.stimulus_html&&e(u,{className:"step-card-body exercise-stimulus",block:!0,html:n.stimulus_html})]}),Ue=t=>{let{numberOfQuestions:n,questionNumber:a,step:i,exercise:s,show_all_feedback:l}=t,d=m(t,De);const c="feedback_html"in i;return r(Fe,{step:i,questionNumber:a,numberOfQuestions:c?n:s.questions.length,children:[e(Qe,{exercise:s}),s.questions.map((e,r)=>{var t;const n=p({},c?i:d.questionStates[e.id]);return o(Be,p({},d,n,{exercise_uid:s.uid,key:e.id,question:e,questionNumber:a,choicesEnabled:n.canAnswer,displaySolution:!0,detailedSolution:null==(t=n.solution)?void 0:t.content_html,show_all_feedback:l,canUpdateCurrentStep:"canUpdateCurrentStep"in d?d.canUpdateCurrentStep:!(r+1===s.questions.length)}))})]})};let We,Me,Ge,Ke,Ve,Ye,Je,Xe,Ze=e=>e;const er=i.div(We||(We=Ze`
  display: flex;
