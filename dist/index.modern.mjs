...
`),Y.stepCardPadding(),U.palette.pale,U.palette.neutral,U.palette.neutralLightBlue,"1rem","2.5rem","1rem","1rem","1rem","1rem",U.palette.neutralLighter,U.palette.neutralLightest,Y.answer(),"1rem","1rem","0.1s ease-in-out",Y.answerHover(),Y.answerChecked(),Y.answerChecked(),Y.answerIncorrect(),Y.answerCorrect(!0),Y.answerCorrectAnswer(),Y.answerIncorrect(),Y.answerIncorrect(!0),Y.popover(),"370px","0.9rem","1.1rem"),Qe=o.forwardRef((r,o)=>{let a,i;const{question:s,correct_answer_id:l,incorrectAnswerId:c,exercise_uid:d,className:p,questionNumber:m,context:u,task:h,hidePreambles:b}=r,{stem_html:f,collaborator_solutions:g=[],formats:w,stimulus_html:x}=s,v=!!l,$=n("openstax-question",p,{"has-correct-answer":v&&!((null!=h?h.is_deleted:void 0)&&"homework"===(null!=h?h.type:void 0)),"has-incorrect-answer":!!c});return null!=d&&(a=e("div",{className:"exercise-uid",children:d})),(()=>{const{displaySolution:e}=r,{collaborator_solutions:t=[]}=s;return e&&t&&t.find(e=>void 0!==e.content_html)})()&&(i=t("div",{className:"detailed-solution",children:[e("div",{className:"header",children:"Detailed solution:"}),e(I,{className:"solution",block:!0,html:g.map(e=>e.content_html).join("")})]})),t(Je,{ref:o,className:$,"data-question-number":m,"data-test-id":"question",children:[e(Ve,{type:"context",html:u,hidden:b}),e(Ve,{type:"stimulus",html:x,hidden:b}),e(Ve,{type:"stem",html:f,hidden:b,questionNumber:m}),r.children,e(oe,q({},r,{onChangeAnswer:r.onChange,hasCorrectAnswer:v})),i,r.displayFormats?e(Be,{formats:w}):void 0,a]})}),Ve=t=>{const{html:r="",type:n,hidden:o,questionNumber:a}=t;return!0!==o&&r.length>0?e(I,{html:r,"data-question-number":a,className:`question-${n}`,block:!0}):null},Be=({formats:r=[]})=>t("div",{className:"formats-listing",children:[e("div",{className:"header",children:"Formats:"}),r.map((t,r)=>e("span",{children:t},r))]});let Fe,Re,De,We=e=>e;const Ue=i.div(Fe||(Fe=We`
    ...
    ${0}
`),Y.stepCardPadding(),U.card.body.background,U.palette.pale,Z(Re||(Re=We`
            justify-content: center;
            flex-wrap: wrap;
        `)),K(De||(De=We`
    ...
    `)));let Ze,Ge,Ke,Ye,Xe,et,tt=e=>e;const rt=s(Ze||(Ze=tt`
...
`),Y.stepCardPadding()),ot=i.div(Ke||(Ke=tt`
  font-size: 2rem;
  line-height: 1.68em;
  position: relative;
`)),at=i.div(Ye||(Ye=tt`
  ...
  color: ${0};
`),e=>e.hasChildren?"space-between":"flex-end",U.palette.danger,U.palette.neutralThin),it=i.textarea(Xe||(Xe=tt`
  display: block;
  font-family: inherit;
  font-size: 1.8rem;
  line-height: 3rem;
  ...
  ${0}
  background-color: ${0};
`),U.palette.neutral,U.palette.neutralDark,e=>e.isOverWordLimit&&rt,e=>e.isOverWordLimit&&s(et||(et=tt`
    border: 2px solid ${0};
  `),U.palette.danger),e=>e.readOnly&&U.palette.neutralCool);it.displayName="OSFreeResponseTextArea";const st=t=>e(Ae,q({},t,{children:"Cancel"})),lt=r=>{const{availablePoints:n,cancelHandler:o,defaultValue:a,infoRowChildren:i,isSubmitDisabled:s,question:l,questionNumber:c,saveHandler:d,submitBtnLabel:p,textHasChanged:m,wordLimit:u}=r,h=_(a)>u,b={};return c&&(b["data-question-number"]=c),t(nt,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(ot,q({},b,{children:l.stem_html&&e(Ve,{type:"stem",html:l.stem_html,hidden:!1})})),e(it,q({},r,{isOverWordLimit:h,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(at,{hasChildren:!!i,children:[i,t("div",{children:[t("span",{children:[_(a)," words"]}),h&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(Ue,{children:[n?e("div",{className:"points",role:"status",children:t("strong",{children:["Points: ",n]})}):null,t("div",{className:"controls",children:[e(st,{disabled:!m,onClick:o}),e(Ae,{"data-test-id":"submit-answer-btn",disabled:s||h,onClick:d,children:p})]})]})]})};lt.displayName="OSFreeResponse";const ct=({count:e})=>t("div",{children:[e," attempt",1===e?"":"s"," left"]}),dt=({published_comments:r})=>r?t("div",{children:[e("strong",{children:"Feedback:"})," ",r]}):null,pt=t=>e(Ae,q({},t,{waitingText:"Saving…",isWaiting:t.isWaiting,"data-test-id":"submit-answer-btn",children:t.willContinue?"Submit & continue":0==t.attempt_number?"Submit":"Re-submit"})),mt=t=>e(Ae,q({},t,{"data-test-id":"continue-btn",children:t.canUpdateCurrentStep?"Continue":"Next"})),ut=({free_response:t})=>t?e(r,{children:e("div",{className:"free-response",children:t})}):null,ht=o.forwardRef((r,n)=>{const{question:a,task:i,answer_id_order:s,onAnswerChange:l,feedback_html:c,correct_answer_feedback_html:d,is_completed:p,correct_answer_id:m,incorrectAnswerId:u,choicesEnabled:h,questionNumber:b,answer_id:f,hasMultipleAttempts:g,attempts_remaining:w,published_comments:x,detailedSolution:v,canAnswer:$,needsSaved:k,attempt_number:y,apiIsPending:C,onAnswerSave:N,onNextStep:_,canUpdateCurrentStep:q,displaySolution:S,available_points:A,free_response:M,show_all_feedback:T,tableFeedbackEnabled:E,hasFeedback:O}=r,[H,j]=o.useState(!1);return o.useEffect(()=>{H&&p&&(_(b-1),j(!1))},[_,b,H,p]),t("div",{"data-test-id":"student-exercise-question",children:[e(Qe,{ref:n,task:i,question:a,answerIdOrder:s,choicesEnabled:h,answer_id:f,questionNumber:b,onChange:l,feedback_html:c,correct_answer_feedback_html:d,correct_answer_id:p?m:null,incorrectAnswerId:u,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:S,show_all_feedback:T,tableFeedbackEnabled:E,children:e(ut,{free_response:M})}),e(Ue,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[t("div",{className:"points",role:"status",children:[A?t("strong",{children:["Points: ",A]}):null,e("span",{className:"attempts-left",children:g&&w>0&&e(ct,{count:w})}),e(dt,{published_comments:x}),v&&t("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(I,{html:v})]})]}),e("div",{className:"controls",children:$&&k||H?e(pt,{disabled:C||!f||H,isWaiting:C||H,attempt_number:y,onClick:()=>{var e;N("string"==typeof(e=a.id)?parseInt(e,10):e),O||j(!0)},willContinue:!O}):e(mt,{onClick:()=>_(b-1),canUpdateCurrentStep:q})})]})})]})}),bt={extensions:[],showProcessingMessages:!1,skipStartupTypeset:!0,styles:{"#MathJax_MSIE_Frame":{left:"",right:0,visibility:"hidden"},"#MathJax_Message":{left:"",right:0,visibility:"hidden"}},tex2jax:{displayMath:[["‌‌‌","‌‌‌"]],inlineMath:[["​​​","​​​"]]}},ft=e=>{const t=(e=>Array.from(e.querySelectorAll(".MathJax math")))(e);return Array.from(e.querySelectorAll("math")).filter(e=>-1===t.indexOf(e))},gt=e=>{const t=[];for(const r of Array.from(e.querySelectorAll("[data-math]:not(.math-rendered)"))){const e=r.getAttribute("data-math");r.classList.contains("math-marked")||(r.textContent="div"===r.tagName.toLowerCase()?`‌‌‌${e}‌‌‌`:`​​​${e}​​​`,r.classList.add("math-marked")),t.push(r)}return t},wt=(e,t,r=5)=>{r>0&&(gt(e).length||ft(e).length)?setTimeout(()=>{wt(e,t,r-1)},200):t()},xt=(e,t)=>new Promise(r=>{(function(e,t){const r=gt(e);t.MathJax.Hub.Queue(((e,t)=>()=>{u(e)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e),(e=>()=>{const t=[];for(const r of e)t.push(r.className+=" math-rendered")})(e))})(r,t),((e,t)=>()=>{const r=ft(e);u(r)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e))})(e,t))})(e,t),t.MathJax.Hub.Queue(()=>{wt(e,r)})}),vt=m((e,t)=>d(xt,100,{leading:!0,trailing:!1}).bind(null,e,t));vt.cache=new h;const $t=p((e=window)=>new Promise(t=>{const r=()=>{e.MathJax.HTML.Cookie.prefix="mathjax",e.MathJax.Hub.Configured(),e.MathJax.Hub.Register.StartupHook("End",()=>{t()})};if(!document.getElementById("MathJax-Script")){const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&delayStartupUntil=configured",e.id="MathJax-Script",e.async=!0,document.head.appendChild(e)}e.MathJax&&e.MathJax.Hub?(e.MathJax.Hub.Config(bt),e.MathJax.Hub.processSectionDelay=0,r()):(bt.AuthorInit=r,e.MathJax=bt)}));let kt,yt,Ct,Nt,_t,qt=e=>e;const St=i.div(kt||(kt=qt`
  position: absolute;
  background: #fff;
  width: 4.5rem;
  border: 1px solid ${0};
  ...
  ${0}
`),U.palette.light,"2rem","2rem",U.palette.neutral,U.palette.neutralDarker,U.palette.neutralDarker,e=>!e.desktop&&s(yt||(yt=qt`
    ${0}
    ${0}
  `),K(Ct||(Ct=qt`
      display: none;
  ...
  `),U.palette.neutral,U.palette.light)),At=({icons:r})=>{var n,o;if(!r)return null;const a=Object.values(r),i=a.some(({location:e})=>{var t,r;return null==(t=null==e||null==(r=e.toolbar)?void 0:r.mobile)||t}),s=a.some(({location:e})=>{var t,r;return null!=(t=null==e||null==(r=e.toolbar)?void 0:r.desktop)&&t}),l=null==(n=r.topic)?void 0:n.url,c=null==(o=r.errata)?void 0:o.url;return t(St,q({},{mobile:i,desktop:s},{children:[l?t("a",{href:l,target:"_blank",children:[e(b,{icon:f}),e("span",{children:"View topic in textbook"})]}):null,c?t("a",{href:c,target:"_blank",children:[e(b,{icon:g}),e("span",{children:"Suggest a correction"})]}):null]}))};let Mt,It,Tt,Et,Ot,Ht,jt,zt,Pt,Lt=e=>e;const Jt=i.div(Mt||(Mt=Lt`
  ...
  ${0}
  ${0}
`),U.palette.mediumBlue,e=>!e.desktop&&s(It||(It=Lt`
    ${0}
    ${0}
  `),K(Tt||(Tt=Lt`
      display: none;
...
`)),Vt=i.div(jt||(jt=Lt`
  ...
  font-size: 1.2rem;
  line-height: 1.8rem;
`),Y.popover),Bt=r=>e(Jt,q({},r.wrapperProps,{mobile:r.mobile,desktop:r.desktop,"aria-label":r.text,children:t(Qt,{children:[r.children,t(Vt,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),Ft=i.div(zt||(zt=Lt`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),Rt=i(b)(Pt||(Pt=Lt`
  color: ${0};
  height: 1em;
`),U.palette.darkGray),Dt=({exercise:t,icons:r})=>{const n={desktop:!0,mobile:!1},o=[],a=t.questions.every(e=>e.answers.length>0);let i;var s,l,c;return a&&t.questions.find(e=>e.formats.includes("free-response"))?i="In a two-step question, OpenStax asks for your own answer first, then gives multiple-choice options to help you assess your learnings. Recalling the answer to a question from memory helps you to retain things longer.":a&&(i="Select the best answer from the given list of distractors. Your instructor may or may not allow multiple attempts."),r.topic&&o.push(e(Bt,q({text:"View topic in textbook",wrapperProps:{as:"a",href:r.topic.url,target:"_blank"}},(null==(s=r.topic.location)?void 0:s.header)||n,{children:e(Rt,{icon:w})}),"topic")),r.errata&&o.push(e(Bt,q({text:"Suggest a correction",wrapperProps:{as:"a",href:r.errata.url,target:"_blank"}},(null==(l=r.errata.location)?void 0:l.header)||n,{children:e(Rt,{icon:x})}),"errata")),r.info&&i&&o.push(e(Bt,q({text:i},(null==(c=r.info.location)?void 0:c.header)||n,{children:e(Rt,{icon:v,height:"16px",width:"16px"})}),"type")),e(Ft,{children:o})},Wt=["numberOfQuestions","questionNumber","step","exercise","show_all_feedback","scrollToQuestion","exerciseIcons"];let Ut,Zt,Gt,Kt,Yt,Xt,er,tr,rr,nr,or=e=>e;const ar=i(Ne)(Ut||(Ut=or`
  font-size: calc(1.8rem * var(--content-text-scale));
...
`)),sr=i.div(Gt||(Gt=or`
  ...
  ${0}
`),e=>e.desktopToolbarEnabled&&s(Kt||(Kt=or`
    ${0}
    ${0}
    ${0}
  `),K(Yt||(Yt=or`
    ...
    `),ar)),e=>e.mobileToolbarEnabled&&s(tr||(tr=or`
    ${0}
  `),Z(rr||(rr=or`
      ${0} + ${0} ${0} {
...
`)),Nr="box-shadow: 0px 1px 4px 0px #00000066;",_r=i.button(xr||(xr=kr`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",U.palette.neutralDarker,e=>e.isActive?s(vr||(vr=kr`
    ${0}
    & + [data-icon] {
      bottom: 0;
      right: 0;
    }
  `),Nr):null,e=>(e=>{switch(e){case"isStatus":return s(br||(br=kr`
        background-color: ${0};
      `),U.palette.neutralBright);case"isCorrect":return s(fr||(fr=kr`
        color: ${0};
        background-color: #E8F4D8;
      `),U.answer.correct);case"isIncorrect":return s(gr||(gr=kr`
        color: ${0};
        background-color: #F8E8EA;
      `),U.answer.incorrect);default:return s(wr||(wr=kr`
        background-color: ${0};
      `),U.palette.neutralBright)}})(e.variant),Nr),qr=i(b)($r||($r=kr`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Sr=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const r={isCorrect:{icon:$,color:U.answer.correct},isIncorrect:{icon:k,color:U.answer.incorrect}}[t];return e(qr,{icon:r.icon,color:r.color,height:"16px",width:"16px"})},Ar=({index:r,isActive:n,step:o,goToStep:a})=>t(Cr,{children:[e(_r,{variant:o.variant,isActive:n,onClick:()=>a(r,o),"aria-current":n?"location":"false","aria-label":"isStatus"===o.variant?"Assignment status":`Question ${r+1}`,children:"isStatus"===o.variant?e(pr,{}):r+1}),e(Sr,{variant:o.variant})]}),Mr=({steps:t,activeIndex:r,goToStep:n})=>e(yr,{"aria-label":"Breadcrumbs",children:t.map((t,o)=>e(Ar,{index:o,isActive:o===r,step:t,goToStep:n},o))});let Ir;const Tr=i.div(Ir||(Ir=(e=>e)`
  max-width: 1000px;
...
`),U.palette.light),Er=()=>e(Tr,{children:e(y,{uniqueKey:"OSLoader"})});export{re as Answer,oe as AnswersTable,Pe as CompletionStatus,dr as Exercise,At as ExerciseToolbar,lt as FreeResponseInput,it as FreeResponseTextArea,ve as InnerStepCard,Er as Loader,$e as OuterStepCard,Mr as ProgressBar,Ar as ProgressBarItem,Qe as Question,Ve as QuestionHtml,Ce as StepCard,_r as StyledItem,St as StyledToolbar,Ne as TaskStepCard};
