...
`),j.button.background,j.palette.white,j.button.backgroundHover,j.button.backgroundActive),K=r=>{const{disabled:t,isWaiting:n,waitingText:a,children:o}=r,i=m(r,M);return e(G,p({},i,{disabled:n||t,children:n&&a||o}))};let V,Y,J=e=>e;const X=i.div(V||(V=J`
    ${0}
...
`),E.stepCardPadding(),((...e)=>s(y||(y=P`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(_e||(_e=qe`
    ...
    `),"8px")),He=t=>{let{questionNumber:n,numberOfQuestions:a,stepType:o,isHomework:i,availablePoints:s,unpadded:l,className:d,children:c,questionId:h,multipartBadge:u,leftHeaderChildren:b,rightHeaderChildren:w,headerTitleChildren:g,wrapsExercise:f}=t,x=m(t,he);return r(Ae,p({},x,{children:[u,r(Se,{className:d,children:[n&&i&&"exercise"===o&&r(Oe,{children:[r("div",{children:[b,r("div",{className:"question-info",children:[g,r("span",{children:[f?"Exercise":"Question"," ",n]}),r("span",{className:"num-questions",children:[" / ",a]}),e("span",{className:"separator",children:"|"}),r("span",{className:"question-id",children:["ID: ",h]})]})]}),r("div",{children:[s&&r("div",{className:"points",children:[s," Points"]}),w]})]}),e(Ie,{unpadded:l,children:c})]})]}))};He.displayName="OSStepCard";const Pe=r=>{let{step:t,questionNumber:a,numberOfQuestions:o,children:i,className:s}=r,l=m(r,ue);return e(He,p({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in t?t.type:"exercise",isHomework:!("task"in t)||void 0===t.task||"homework"===t.task.type,"data-task-step-id":t.id,availablePoints:t.available_points,className:n(`${"type"in t?t.type:"exercise"}-step`,s),questionId:t.uid,children:i}))};Pe.displayName="OSTaskStepCard";const Te=({count:e})=>r("div",{children:[e," attempt",1===e?"":"s"," left"]}),je=({published_comments:t})=>t?r("div",{children:[e("strong",{children:"Feedback:"})," ",t]}):null,ze=r=>e(K,p({},r,{waitingText:"Saving…",isWaiting:r.isWaiting,"data-test-id":"submit-answer-btn",children:0==r.attempt_number?"Submit":"Re-submit"})),Le=r=>e(K,{onClick:r.onNextStep,"data-test-id":"continue-btn",children:r.canUpdateCurrentStep?"Continue":"Next"}),Re=({free_response:r})=>r?e(t,{children:e("div",{className:"free-response",children:r})}):null,Ee=t=>{const{question:n,task:a,answer_id_order:o,onAnswerChange:i,feedback_html:s,correct_answer_feedback_html:l,is_completed:d,correct_answer_id:c,incorrectAnswerId:p,choicesEnabled:m,questionNumber:h,answer_id:b,hasMultipleAttempts:w,attempts_remaining:g,published_comments:f,detailedSolution:x,canAnswer:$,needsSaved:k,attempt_number:v,apiIsPending:y,onAnswerSave:_,onNextStep:N,canUpdateCurrentStep:C,displaySolution:q,available_points:S,free_response:A,show_all_feedback:O}=t;return r("div",{"data-test-id":"student-exercise-question",children:[e(F,{task:a,question:n,answerIdOrder:o,choicesEnabled:m,answer_id:b,questionNumber:h,onChange:i,feedback_html:s,correct_answer_feedback_html:l,correct_answer_id:d?c:null,incorrectAnswerId:p,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:q,show_all_feedback:O,children:e(Re,{free_response:A})}),r(X,{className:"step-card-footer",children:[r("div",{className:"points",children:[r("strong",{children:["Points: ",S]}),e("span",{className:"attempts-left",children:w&&g>0&&e(Te,{count:g})}),e(je,{published_comments:f}),x&&r("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(u,{html:x})]})]}),e("div",{className:"controls",children:$&&k?e(ze,{disabled:y||!b,isWaiting:y,attempt_number:v,onClick:_}):e(Le,{onNextStep:N,canUpdateCurrentStep:C})})]})]})},Be=["numberOfQuestions","questionNumber","step","exercise","canAnswer","needsSaved","show_all_feedback"];let De;const Fe=i(Pe)(De||(De=(e=>e)`
  font-size: 1.8rem;
  line-height: 3rem;
`)),Qe=({exercise:n})=>r(t,{children:[n.context&&e(u,{className:"step-card-body exercise-context",block:!0,html:n.context}),n.stimulus_html&&e(u,{className:"step-card-body exercise-stimulus",block:!0,html:n.stimulus_html})]}),We=t=>{let{numberOfQuestions:n,questionNumber:a,step:i,exercise:s,canAnswer:l,needsSaved:d,show_all_feedback:c}=t,h=m(t,Be);return r(Fe,{step:i,questionNumber:a,numberOfQuestions:n,wrapsExercise:!("feedback_html"in i),children:[e(Qe,{exercise:s}),s.questions.map(e=>{var r;const t=p({},"feedback_html"in i?i:h.questionStates[e.id]);return o(Ee,p({},h,t,{exercise_uid:s.uid,key:e.id,question:e,questionNumber:a,choicesEnabled:l,canAnswer:l,needsSaved:d,canUpdateCurrentStep:l,displaySolution:!0,detailedSolution:null==(r=t.solution)?void 0:r.content_html,show_all_feedback:c}))})]})};let Me,Ue,Ge,Ke,Ve,Ye,Je,Xe,Ze=e=>e;i.div(Me||(Me=Ze`
  display: flex;
