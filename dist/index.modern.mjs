...
`),Z.stepCardPadding(),F.card.body.background,((...e)=>s(T||(T=V`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(he||(he=fe`
        && .question-feedback {
            margin-left: 0;
    ...
    `),"8px")),$e=r=>{let{questionNumber:n,numberOfQuestions:a,showTotalQuestions:i,stepType:o,isHomework:s,availablePoints:l,unpadded:c,className:d,children:p,questionId:m,multipartBadge:h,leftHeaderChildren:u,rightHeaderChildren:b,headerTitleChildren:f}=r,g=_(r,re);return t(we,C({},g,{children:[h,t(ge,{className:d,children:[n&&s&&"exercise"===o&&t(xe,{children:[t("div",{children:[u,t("div",{className:"question-info",children:[f,e("span",{children:a>1?`Questions ${n} - ${n+a-1}`:`Question ${n}`}),i?t("span",{className:"num-questions",children:[" / ",a]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",m]})]})]}),t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]})]}),e(ve,{unpadded:c,children:p})]})]}))};$e.displayName="OSStepCard";const ye=t=>{let{step:r,questionNumber:a,numberOfQuestions:i,children:o,className:s}=t,l=_(t,ne);return e($e,C({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:i,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,availablePoints:r.available_points,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:o}))};ye.displayName="OSTaskStepCard";const ke=["disabled","isWaiting","waitingText","children"];let Ce;const _e=o.button(Ce||(Ce=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),F.button.background,F.palette.white,F.button.backgroundHover,F.button.backgroundActive),Ne=t=>{const{disabled:r,isWaiting:n,waitingText:a,children:i}=t,o=_(t,ke);return e(_e,C({},o,{disabled:n||r,children:n&&a||i}))};let qe,Ae,Se=e=>e;const Me=o(ge)(qe||(qe=Se`
  padding: 88px 72px;
  font-size: 1.8rem;
  line-height: 3rem;
  display: block;
...
`),Z.stepCardPadding(),F.card.body.background,F.palette.pale,W(Le||(Le=Je`
    ...
    `)));let Re,Ve,Be,Fe,De,Ue,We=e=>e;const Ze=s(Re||(Re=We`
...
`)),Ye=o.div(Fe||(Fe=We`
  ...
  color: ${0};
`),e=>e.hasChildren?"space-between":"flex-end",F.palette.danger,F.palette.neutralThin),Xe=o.textarea(De||(De=We`
  display: block;
  font-family: inherit;
  font-size: 1.8rem;
  line-height: 3rem;
  ...
  ${0}
  background-color: ${0};
`),F.palette.neutral,F.palette.neutralDark,e=>e.isOverWordLimit&&Ze,e=>e.isOverWordLimit&&s(Ue||(Ue=We`
    border: 2px solid ${0};
  `),F.palette.danger),e=>e.readOnly&&F.palette.neutralCool);Xe.displayName="OSFreeResponseTextArea";const et=t=>e(Ne,C({},t,{children:"Cancel"})),tt=r=>{const{availablePoints:n,cancelHandler:a,defaultValue:i,infoRowChildren:o,isSubmitDisabled:s,pointsChildren:l,question:c,questionNumber:d,saveHandler:p,submitBtnLabel:m,textHasChanged:h,wordLimit:u}=r,b=k(i)>u,f={};return d&&(f["data-question-number"]=d),t(Ge,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(Ke,C({},f,{children:c.stem_html&&e(je,{type:"stem",html:c.stem_html,hidden:!1})})),e(Xe,C({},r,{isOverWordLimit:b,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(Ye,{hasChildren:!!o,children:[o,t("div",{children:[t("span",{children:[k(i)," words"]}),b&&t("span",{className:"word-limit-error-info",children:["Maximum ",u," words"]})]})]})]}),t(Qe,{children:[t("div",{className:"points",children:[t("strong",{children:["Points: ",n]}),l]}),t("div",{className:"controls",children:[e(et,{disabled:!h,onClick:a}),e(Ne,{"data-test-id":"submit-answer-btn",disabled:s||b,onClick:p,children:m})]})]})]})};tt.displayName="OSFreeResponse";let rt,nt,at,it,ot,st=e=>e;const lt=o.div(rt||(rt=st`
...
`)),dt=o.div(at||(at=st`
  ...
  font-size: 1.2rem;
  line-height: 1.8rem;
`),Z.popover),pt=r=>e(lt,C({},r.wrapperProps,{children:t(ct,{children:[r.children,t(dt,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),mt=o.div(it||(it=st`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),ht=o(m)(ot||(ot=st`
...
`)),Dt=o.button(Qt||(Qt=Vt`
  ...
  ${0}
  ${0}
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",F.palette.neutralDarker,e=>e.isActive?"box-shadow: 0px 1px 4px 0px #00000066;":null,e=>(e=>{switch(e){case"isStatus":return s(Pt||(Pt=Vt`
        background-color: ${0};
      `),F.palette.neutralBright);case"isCorrect":return s(zt||(zt=Vt`
        color: ${0};
        background-color: #E8F4D8;
      `),F.answer.correct);case"isIncorrect":return s(Lt||(Lt=Vt`
        color: ${0};
        background-color: #F8E8EA;
      `),F.answer.incorrect);default:return s(Jt||(Jt=Vt`
        background-color: ${0};
      `),F.palette.neutralBright)}})(e.variant)),Ut=o(m)(Rt||(Rt=Vt`
  background: ${0};
  color: #fff;
  position: absolute;
  bottom: 0.4rem;
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`),e=>e.color),Wt=({variant:t})=>{if(!t||"isCorrect"!==t&&"isIncorrect"!==t)return null;const r={isCorrect:{icon:w,color:F.answer.correct},isIncorrect:{icon:x,color:F.answer.incorrect}}[t];return e(Ut,{icon:r.icon,color:r.color,height:"16px",width:"16px"})},Zt=({index:r,isActive:n,step:a,goToStep:i})=>t(Ft,{children:[e(Dt,{variant:a.variant,isActive:n,onClick:()=>i(r,a),children:"isStatus"===a.variant?e(Ot,{}):r+1}),e(Wt,{variant:a.variant})]}),Gt=({steps:t,activeIndex:r,goToStep:n})=>e(Bt,{children:t.map((t,a)=>e(Zt,{index:a,isActive:a===r,step:t,goToStep:n},a))});let Kt;const Yt=o.div(Kt||(Kt=(e=>e)`
  max-width: 1000px;
...
`),F.palette.light),Xt=()=>e(Yt,{children:e(v,{uniqueKey:"OSLoader"})});export{X as Answer,te as AnswersTable,He as CompletionStatus,Ht as Exercise,tt as FreeResponseInput,Xe as FreeResponseTextArea,ge as InnerStepCard,Xt as Loader,we as OuterStepCard,Gt as ProgressBar,Zt as ProgressBarItem,Ee as Question,je as QuestionHtml,$e as StepCard,Dt as StyledItem,ye as TaskStepCard};
