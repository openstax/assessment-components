...
`),ye.palette.blue),Gr=({children:t,previewMode:r})=>e(r?Vr:Qr,{children:t}),Wr=({free_response:r,previewMode:n})=>{const[a,i]=o.useState(!1),[l,s]=o.useState(!1),d=o.useRef(null);return o.useLayoutEffect(()=>{n&&d.current&&s(!a&&d.current.scrollHeight>168)},[r,n,a]),r?t(Gr,{previewMode:n,children:[n?e(Jr,{ref:d,expanded:a,isOverflowing:l,children:r}):r,n&&(l||a)&&e(Ur,{onClick:()=>i(!a),children:a?"show less":"read more"})]}):null},Yr=({count:e})=>t("div",{children:[e," attempt",1===e?"":"s"," left"]}),Zr=()=>e("div",{children:"Unlimited quiz attempts left"}),Kr=({published_comments:r})=>r?t("div",{children:[e("strong",{children:"Feedback:"})," ",r]}):null,Xr=t=>e(pt,L({},t,{waitingText:"Saving…",isWaiting:t.isWaiting,"data-test-id":"submit-answer-btn",children:t.willContinue?"Submit & continue":0==t.attempt_number?"Submit":"Re-submit"})),en=t=>e(pt,L({},t,{"data-test-id":"continue-btn",children:t.canUpdateCurrentStep?"Continue":"Next"})),tn=o.forwardRef((r,n)=>{const{question:a,task:i,answer_id_order:l,onAnswerChange:s,feedback_html:d,correct_answer_feedback_html:c,is_completed:p,correct_answer_id:u,incorrectAnswerId:m,choicesEnabled:h,questionNumber:b,answer_id:g,hasMultipleAttempts:f,hasUnlimitedAttempts:w,attempts_remaining:x,published_comments:v,detailedSolution:k,canAnswer:y,needsSaved:$,attempt_number:C,apiIsPending:S,onAnswerSave:_,onNextStep:N,canUpdateCurrentStep:q,displaySolution:A,available_points:z,free_response:M,labelAnswers:E,show_all_feedback:I,tableFeedbackEnabled:T,hasFeedback:F,previewMode:L}=r,[H,O]=o.useState(!1);return o.useEffect(()=>{H&&p&&(N(b-1),O(!1))},[N,b,H,p]),t("div",{"data-test-id":"student-exercise-question",children:[e(Et,{ref:n,task:i,question:a,answerIdOrder:l,choicesEnabled:h,answer_id:g,questionNumber:b,onChange:s,feedback_html:d,correct_answer_feedback_html:c,correct_answer_id:p?u:null,incorrectAnswerId:m,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:A,labelAnswers:E,show_all_feedback:I,tableFeedbackEnabled:T,previewMode:L,children:e(Wr,{free_response:M,previewMode:L})}),L&&k||!L?e(Dt,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[t("div",{className:"points",role:"status",children:[z?t("strong",{children:["Points: ",z]}):null,t("span",{className:"attempts-left",children:[f&&x>0&&e(Yr,{count:x}),w?e(Zr,{}):null]}),e(Kr,{published_comments:v}),k&&t("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(ne,{html:k})]})]}),e("div",{className:"controls",children:y&&$||H?e(Xr,{disabled:S||!g||H,isWaiting:S||H,attempt_number:C,onClick:()=>{_(j(a.id)),F||O(!0)},willContinue:!F}):e(en,{onClick:()=>N(b-1),canUpdateCurrentStep:q})})]})}):null]})}),rn={extensions:[],showProcessingMessages:!1,skipStartupTypeset:!0,styles:{"#MathJax_MSIE_Frame":{left:"",right:0,visibility:"hidden"},"#MathJax_Message":{left:"",right:0,visibility:"hidden"}},tex2jax:{displayMath:[["‌‌‌","‌‌‌"]],inlineMath:[["​​​","​​​"]]}},nn=e=>{const t=(e=>Array.from(e.querySelectorAll(".MathJax math")))(e);return Array.from(e.querySelectorAll("math")).filter(e=>-1===t.indexOf(e))},on=e=>{const t=[];for(const r of Array.from(e.querySelectorAll("[data-math]:not(.math-rendered)"))){const e=r.getAttribute("data-math");r.classList.contains("math-marked")||(r.textContent="div"===r.tagName.toLowerCase()?`‌‌‌${e}‌‌‌`:`​​​${e}​​​`,r.classList.add("math-marked")),t.push(r)}return t},an=(e,t,r=5)=>{r>0&&(on(e).length||nn(e).length)?setTimeout(()=>{an(e,t,r-1)},200):t()},ln=(e,t)=>new Promise(r=>{(function(e,t){const r=on(e);t.MathJax.Hub.Queue(((e,t)=>()=>{x(e)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e),(e=>()=>{const t=[];for(const r of e)t.push(r.className+=" math-rendered")})(e))})(r,t),((e,t)=>()=>{const r=nn(e);x(r)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e))})(e,t))})(e,t),t.MathJax.Hub.Queue(()=>{an(e,r)})}),sn=w((e,t)=>g(ln,100,{leading:!0,trailing:!1}).bind(null,e,t));sn.cache=new v;const dn=async(e,t=window)=>(await cn(),t&&t.MathJax&&t.MathJax.Hub?e.querySelector("[data-math]:not(.math-rendered), math:not(.math-rendered)")?sn(e,t)():Promise.resolve():(console.warn("Warning: Expected MathJax to be initialized."),Promise.resolve())),cn=f((e=window)=>new Promise(t=>{const r=()=>{e.MathJax.HTML.Cookie.prefix="mathjax",e.MathJax.Hub.Configured(),e.MathJax.Hub.Register.StartupHook("End",()=>{t()})};if(!document.getElementById("MathJax-Script")){const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&delayStartupUntil=configured",e.id="MathJax-Script",e.async=!0,document.head.appendChild(e)}e.MathJax&&e.MathJax.Hub?(e.MathJax.Hub.Config(rn),e.MathJax.Hub.processSectionDelay=0,r()):(rn.AuthorInit=r,e.MathJax=rn)}));let pn,un,mn,hn,bn,gn=e=>e;const fn=u.div(pn||(pn=gn`
  ...
  ${0}
`),ye.palette.light,"2rem","2rem",ye.palette.neutral,ye.palette.neutralDarker,ye.palette.neutralDarker,e=>!e.desktop&&m(un||(un=gn`
    ${0}
    ${0}
  `),Se(mn||(mn=gn`
      display: none;
  ...
  `),ye.palette.neutral,ye.palette.light)),wn=({icons:r})=>{var n,o;if(!r)return null;const a=Object.values(r),i=a.some(({location:e})=>{var t,r;return null==(t=null==e||null==(r=e.toolbar)?void 0:r.mobile)||t}),l=a.some(({location:e})=>{var t,r;return null!=(t=null==e||null==(r=e.toolbar)?void 0:r.desktop)&&t}),s=null==(n=r.topic)?void 0:n.url,d=null==(o=r.errata)?void 0:o.url;return t(fn,L({},{mobile:i,desktop:l},{children:[s?t("a",{href:s,target:"_blank",children:[e(k,{icon:y}),e("span",{children:"View topic in textbook"})]}):null,d?t("a",{href:d,target:"_blank",children:[e(k,{icon:$}),e("span",{children:"Suggest a correction"})]}):null]}))};let xn,vn,kn,yn,$n,Cn,Sn,_n,Nn,qn=e=>e;const An=u.div(xn||(xn=qn`
  ...
  ${0}
  ${0}
`),ye.palette.mediumBlue,e=>!e.desktop&&m(vn||(vn=qn`
    ${0}
    ${0}
  `),Se(kn||(kn=qn`
      display: none;
...
`)),Mn=u.div(Sn||(Sn=qn`
  ...
  font-size: 1.4rem;
  line-height: 1.8rem;
`),_e.popover),En=r=>e(An,L({},r.wrapperProps,{mobile:r.mobile,desktop:r.desktop,"aria-label":r.text,children:t(zn,{children:[r.children,t(Mn,{className:"popover right",children:[e("div",{className:"arrow"}),e("div",{className:"content",children:r.text})]})]})})),In=u.div(_n||(_n=qn`
  max-width: 200px;
  display: flex;
  justify-content: space-between;
`)),Tn=u(k)(Nn||(Nn=qn`
  color: ${0};
  height: 1em;
`),ye.palette.darkGray),Fn=({exercise:t,icons:r})=>{const n={desktop:!0,mobile:!1},o=[],a=t.questions.every(e=>e.answers.length>0);let i;var l,s,d;return a&&t.questions.find(e=>e.formats.includes("free-response"))?i="In a two-step question, OpenStax asks for your own answer first, then gives multiple-choice options to help you assess your learnings. Recalling the answer to a question from memory helps you to retain things longer.":a&&(i="Select the best answer from the given list of distractors. Your instructor may or may not allow multiple attempts."),r.topic&&o.push(e(En,L({text:"View topic in textbook",wrapperProps:{as:"a",href:r.topic.url,target:"_blank"}},(null==(l=r.topic.location)?void 0:l.header)||n,{children:e(Tn,{icon:A})}),"topic")),r.errata&&o.push(e(En,L({text:"Suggest a correction",wrapperProps:{as:"a",href:r.errata.url,target:"_blank"}},(null==(s=r.errata.location)?void 0:s.header)||n,{children:e(Tn,{icon:z})}),"errata")),r.info&&i&&o.push(e(En,L({text:i},(null==(d=r.info.location)?void 0:d.header)||n,{children:e(Tn,{icon:M,height:"16px",width:"16px"})}),"type")),e(In,{children:o})};let Ln;const Hn=m(Ln||(Ln=(e=>e)`
...
`),ye.card.header.background,ye.card.header.background,ye.palette.white,ye.palette.neutralDarker),On=["numberOfQuestions","questionNumber","step","exercise","show_all_feedback","scrollToQuestion","exerciseIcons","overlayChildren","labelAnswers","previewMode","showScoring","onGradingSave"];let Dn,jn,Pn,Rn,Bn,Qn,Vn,Jn,Un,Gn,Wn=e=>e;const Yn=u(lt)(Dn||(Dn=Wn`
  font-size: calc(1.8rem * var(--content-text-scale));
...
`)),Kn=u.div(Pn||(Pn=Wn`
  ...
  ${0}
`),e=>e.desktopToolbarEnabled&&m(Rn||(Rn=Wn`
    ${0}
    ${0}
    ${0}
  `),Se(Bn||(Bn=Wn`
    ...
    `),Yn)),e=>e.mobileToolbarEnabled&&m(Jn||(Jn=Wn`
    ${0}
  `),$e(Un||(Un=Wn`
      ${0} + ${0} ${0} {
...
`)),vo="box-shadow: 0px 1px 4px 0px #00000066;",ko=u.button(mo||(mo=fo`
  display: flex;
  justify-content: center;
  align-items: center;
  width: ${0};
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",ye.palette.neutralDarker,e=>e.isActive?m(ho||(ho=fo`
    ${0}
    & + [data-icon] {
      bottom: 0;
      right: 0;
    }
  `),vo):null,e=>(e=>{switch(e){case"isStatus":return m(io||(io=fo`
        color: ${0};
        background-color: ${0};
      `),ye.palette.white,ye.palette.neutralDarker);case"isCorrect":return m(lo||(lo=fo`
        color: ${0};
        background-color: #E8F4D8;
      `),ye.answer.correct);case"isIncorrect":return m(so||(so=fo`
        color: ${0};
        background-color: #F8E8EA;
      `),ye.answer.incorrect);case"isIncomplete":return m(co||(co=fo`
        background-color: ${0};
      `),ye.palette.neutralBright);case"isPartialCredit":return m(po||(po=fo`
        color: ${0};
        background-color: ${0};
      `),ye.answer.partialCredit,ye.palette.yellow);default:return m(uo||(uo=fo`
        background-color: ${0};
      `),ye.palette.neutralLight)}})(e.variant),vo),yo=u(k)(bo||(bo=fo`
  color: ${0};
  position: absolute;
  bottom: 0.4rem;
  right: 0.3rem;
...
`),e=>e.color),$o=u.button(go||(go=fo`
  ...
  padding: 0.2rem;
  border-radius: 80%;
`),ye.palette.mediumBlue,ye.palette.white,e=>e.isActive?"3.8rem":"3.2rem"),Co=({variant:t})=>{if("isStatus"===t)return null;const r="0.1rem",n={isCorrect:{icon:E,background:ye.answer.correct,color:ye.palette.white,padding:r,label:"Correct"},isIncorrect:{icon:I,background:ye.answer.incorrect,color:ye.palette.white,padding:r,label:"Incorrect"},isIncomplete:{icon:C,background:ye.answer.neutral,color:ye.palette.white,padding:r,label:"Incomplete"},isPartialCredit:{icon:S,background:ye.answer.partialCredit,color:ye.palette.white,padding:"0.1rem 0.1rem 0.1rem 0.2rem",label:"Partial credit"},null:{icon:T,background:ye.answer.neutral,color:ye.answer.neutralDark,padding:r,label:"Not yet graded"}}[String(t)];return n?e(yo,{icon:n.icon,color:n.color,style:{background:n.background,padding:n.padding},height:"16px",width:"16px","aria-label":n.label,"aria-hidden":void 0}):null},So=({index:r,isActive:n,step:o,goToStep:a})=>t(xo,{children:[o.hasFeedback&&o.variant&&"isStatus"!==o.variant?e($o,{isActive:n,"aria-label":`Question ${r+1} - Feedback`}):null,e(ko,{variant:o.variant,isActive:n,onClick:()=>a(r,o),"aria-current":n?"location":"false","aria-label":"isStatus"===o.variant?"Assignment status":`Question ${r+1}`,children:"isStatus"===o.variant?e(ro,{}):r+1}),e(Co,{variant:o.variant})]}),_o=({steps:t,activeIndex:r,goToStep:n})=>e(wo,{"aria-label":"Breadcrumbs",children:t.map((t,o)=>e(So,{index:o,isActive:o===r,step:t,goToStep:n},o))});let No;const qo=u.div(No||(No=(e=>e)`
  max-width: 1000px;
...
`),ye.palette.light),Ao=()=>e(qo,{children:e(F,{uniqueKey:"OSLoader"})});let zo,Mo,Eo,Io=e=>e;const To=u.div(zo||(zo=Io`
  display: flex;
  width: fit-content;
`)),Fo=u.button(Mo||(Mo=Io`
    width: 7.4rem;
    height: 8.7rem;
    color: white;
    border: none;
...
`),ye.palette.mediumBlue,ye.palette.orange,ye.palette.neutralDarker),Lo=u(k)(Eo||(Eo=Io`
    border-radius: 50%;
    background-color: ${0};
...
`),ye.palette.neutralDarker,ye.palette.neutralLightest),oa=u.span(Bo||(Bo=ta`
  font-weight: 600;
  flex: 1;
`)),aa=u.span(Qo||(Qo=ta`
  font-size: calc(1.3rem * var(--content-text-scale));
...
`),ye.palette.neutralThin,ye.palette.neutralDarker),ia=u.span(Vo||(Vo=ta`
  display: inline-block;
  width: 0;
  height: 0;
  flex-shrink: 0;
...
`),({expanded:e})=>e?`\n      border-left: 5px solid transparent;\n      border-right: 5px solid transparent;\n      border-top: 6px solid ${ye.palette.neutralDark};\n    `:`\n      border-top: 5px solid transparent;\n      border-bottom: 5px solid transparent;\n      border-left: 6px solid ${ye.palette.neutralDark};\n    `),la=u.div(Jo||(Jo=ta`
  ...
  align-items: flex-start;
  border-top: 1px solid ${0};
`),ye.palette.neutralLighter),sa=u.div(Uo||(Uo=ta`
  flex: 1;
  padding: 1.6rem;
  min-width: 0;
`)),da=u.div(Go||(Go=ta`
  ...
  ${0}
`),ye.palette.neutralLighter,({expanded:e})=>e?"none":"16.8rem",ye.palette.neutralDark,({expanded:e,isOverflowing:t})=>!e&&t?m(Wo||(Wo=ta`
    display: -webkit-box;
    -webkit-line-clamp: 6;
    -webkit-box-orient: vertical;
    overflow: hidden;
  ...
  color: ${0};
  margin: 0 0 1rem 0;
`),ye.palette.neutralThin),pa=u.button(Zo||(Zo=ta`
  display: inline;
  background: none;
  border: none;
  color: ${0};
...
`),ye.palette.blue),ua=u.div(Ko||(Ko=ta`
  margin-top: 1.6rem;
`)),ma=u.div(Xo||(Xo=ta`
  font-size: calc(1.4rem * var(--content-text-scale));
  font-weight: bold;
  color: ${0};
`),ye.palette.neutralDarker),ha=u.div(ea||(ea=ta`
  font-size: calc(1.4rem * var(--content-text-scale));
  color: ${0};
  white-space: pre-wrap;
  margin-top: 0.4rem;
...
`),ye.palette.neutralDarker),ba=({student:n,freeResponse:o,questionId:i,maxScore:s,score:c,comment:p,onSave:u,disabled:m,gradingTimestamp:h,expanded:b,onToggle:g})=>{const f=void 0!==b,w=void 0!==c,[x,v]=l(!w),[k,y]=l(!1),[$,C]=l(!1),S=a(null),_=f?b:x;return d(()=>{S.current&&C(!k&&S.current.scrollHeight>168)},[o,k,_]),t(ra,{children:[t(na,{type:"button",onClick:()=>{f?null==g||g():v(e=>!e)},"aria-expanded":_,children:[e(ia,{expanded:_}),e(oa,{children:n.name}),t(aa,{children:[e("strong",{children:"Points:"})," ",w?c:"--"," out of ",s]})]}),t(la,{style:{display:_?void 0:"none"},children:[t(sa,{children:[o?t(r,{children:[e(da,{ref:S,expanded:k,isOverflowing:$,children:o}),($||k)&&e(pa,{type:"button",onClick:()=>y(e=>!e),children:k?"read less":"read more"})]}):e(ca,{children:"Unanswered"}),w&&t(ua,{children:[t(ma,{children:["Score: ",c,"/",s]}),p&&t(ha,{children:[e("span",{className:"feedback-label",children:"Comment:"})," ",p]})]})]}),e(or,{questionId:i,maxScore:s,score:c,comment:p,onSave:u,disabled:m,gradingTimestamp:h})]})]})};let ga,fa,wa,xa,va,ka,ya,$a,Ca,Sa,_a,Na,qa=e=>e;const Aa=u.div(ga||(ga=qa`
  border: 1px solid ${0};
  border-radius: 4px;
  overflow: hidden;
  margin-bottom: 2rem;
`),ye.palette.neutralLight),za=u.div(fa||(fa=qa`
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 1.2rem 1.6rem;
  background-color: ${0};
`),ye.card.header.background),Ma=u.button(wa||(wa=qa`
  display: flex;
  align-items: center;
  gap: 0.8rem;
  background: none;
...
`)),Ea=u.span(xa||(xa=qa`
  ...
  color: ${0};
  margin: 0;
`),ye.palette.neutralDarker),Ia=u.span(va||(va=qa`
  font-size: calc(1.3rem * var(--content-text-scale));
  font-weight: 600;
  color: ${0};
  background-color: ${0};
...
`),ye.palette.white,ye.palette.darkGray),Ta=u.span(ka||(ka=qa`
  font-weight: normal;
  margin: 0 0.4rem;
`)),Fa=u.span(ya||(ya=qa`
  font-weight: normal;
...
`),ye.palette.blue,ye.palette.mediumBlue),Ha=u.div(Ca||(Ca=qa`
  padding: 1.6rem 1.6rem 0;
  background-color: ${0};
`),ye.card.body.background),Oa=u.div(Sa||(Sa=qa`
  font-size: calc(1.4rem * var(--content-text-scale));
  color: ${0};
`),ye.palette.neutralDarker),Da=u.div(_a||(_a=qa`
  padding: 0.8rem 1.6rem 1.2rem;
  border-bottom: 1px solid ${0};
  background-color: ${0};
`),ye.palette.neutralLight,ye.card.body.background),ja=u.div(Na||(Na=qa`
  background-color: ${0};
`),ye.card.body.background),Pa=({questionNumber:n,questionStemHtml:o,students:a,questionId:i})=>{const[s,d]=l(!0),[c,p]=l(()=>(e=>{const t=new Set;return e.forEach(e=>{void 0===e.score&&t.add(String(e.student.userId))}),t})(a)),u=a.filter(e=>void 0!==e.score).length,m=a.every(e=>c.has(String(e.student.userId)));return t(Aa,{children:[t(za,{children:[t(Ma,{type:"button",onClick:()=>d(e=>!e),"aria-expanded":s,children:[e(ia,{expanded:s}),t(Ea,{children:["Question ",n,i&&t(r,{children:[e(Ta,{children:"|"}),t(Fa,{children:["ID: ",i]})]})]})]}),t(Ia,{children:[u,"/",a.length," Graded"]})]}),t("div",{style:{display:s?void 0:"none"},children:[e(Ha,{children:e(Oa,{children:e(ne,{html:o,block:!0})})}),e(Da,{children:e(La,{type:"button",onClick:e=>{e.stopPropagation(),p(m?new Set:new Set(a.map(e=>String(e.student.userId))))},children:m?"Collapse all answers":"Expand all answers"})}),e(ja,{children:a.map(t=>{const r=String(t.student.userId);return e(ba,L({},t,{expanded:c.has(r),onToggle:()=>{return e=r,void p(t=>{const r=new Set(t);return r.has(e)?r.delete(e):r.add(e),r});var e}}),r)})})]})]})};let Ra,Ba,Qa=e=>e;const Va=u.div(Ra||(Ra=Qa`
  display: flex;
  flex-direction: column;
`)),Ja=u.div(Ba||(Ba=Qa`
  padding: 4rem 0;
  ...
  font-size: calc(1.6rem * var(--content-text-scale));
  color: ${0};
`),ye.palette.neutralThin),Ua=({questions:t})=>{const r=o.useRef(null),n=o.useCallback(()=>{r.current&&dn(r.current)},[]);return e(R.Provider,{value:n,children:e(Va,{ref:r,children:0===t.length?e(Ja,{children:"All responses have been graded."}):t.map((t,r)=>e(Pa,L({},t),r))})})};export{Te as Answer,Le as AnswersTable,ia as ChevronIcon,_t as CompletionStatus,to as Exercise,jo as ExercisePreview,wn as ExerciseToolbar,Hr as FreeResponseInput,Wr as FreeResponseReview,Sr as FreeResponseTextArea,Ho as IncludeRemoveQuestion,et as InnerStepCard,Ao as Loader,Pa as NeedsGradingQuestion,Ua as NeedsGradingQueue,ba as NeedsGradingStudentRow,tt as OuterStepCard,_o as ProgressBar,So as ProgressBarItem,Et as Question,It as QuestionHtml,it as StepCard,ko as StyledItem,at as StyledOverlay,fn as StyledToolbar,lt as TaskStepCard};
