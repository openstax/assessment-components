...
`),Y.stepCardPadding(),U.card.body.background,((...e)=>s(z||(z=D`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(fe||(fe=xe`
    ...
    `),"8px")),Ce=r=>{let{questionNumber:n,numberOfQuestions:o,showTotalQuestions:a,stepType:i,isHomework:s,availablePoints:l,unpadded:c,className:d,children:p,questionId:m,multipartBadge:h,leftHeaderChildren:u,rightHeaderChildren:b,headerTitleChildren:f}=r,g=S(r,ae);return t($e,q({},g,{children:[h,t(ve,{className:d,children:[n&&s&&"exercise"===i&&t(ke,{children:[t("div",{children:[u,t("div",{className:"question-info",children:[f,e("span",{children:o>1?`Questions ${n} - ${n+o-1}`:`Question ${n}`}),a?t("span",{className:"num-questions",children:[" / ",o]}):null,e("span",{className:"separator",children:"|"}),t("span",{className:"question-id",children:["ID: ",m]})]})]}),l||b?t("div",{children:[l&&t("div",{className:"points",children:[l," Points"]}),b]}):null]}),e(ye,{unpadded:c,children:p})]})]}))};Ce.displayName="OSStepCard";const Ne=t=>{let{step:r,questionNumber:o,numberOfQuestions:a,children:i,className:s}=t,l=S(t,ie);return e(Ce,q({},l,{unpadded:!0,questionNumber:o,numberOfQuestions:a,stepType:"type"in r?r.type:"exercise",isHomework:!("task"in r)||void 0===r.task||"homework"===r.task.type,"data-task-step-id":r.id,className:n(`${"type"in r?r.type:"exercise"}-step`,s),questionId:r.uid,children:i}))};Ne.displayName="OSTaskStepCard";const _e=["disabled","isWaiting","waitingText","children"];let qe;const Se=i.button(qe||(qe=(e=>e)`
  background-color: ${0};
  color: ${0};
  font-size: 1.6rem;
  font-weight: 700;
...
`),U.button.background,U.palette.white,U.button.backgroundHover,U.button.backgroundActive),Ae=t=>{const{disabled:r,isWaiting:n,waitingText:o,children:a}=t,i=S(t,_e);return e(Se,q({},i,{disabled:n||r,children:n&&o||a}))};let Me,Ie,Te,Oe,Ee=e=>e;const He=l(Me||(Me=Ee`
  :root {
...
`),Y.stepCardPadding(),U.palette.pale,U.palette.neutral,U.palette.neutralLightBlue,"1rem","2.5rem","1rem","1rem","1rem","1rem",U.palette.neutralLighter,U.palette.neutralLightest,Y.answer(),"1rem","1rem","0.1s ease-in-out",Y.answerHover(),Y.answerChecked(),Y.answerChecked(),Y.answerIncorrect(),Y.answerCorrect(!0),Y.answerCorrectAnswer(),Y.answerIncorrect(),Y.answerIncorrect(!0),Y.popover(),"370px","0.9rem","1.1rem"),Qe=o.forwardRef((r,o)=>{let a,i;const{question:s,correct_answer_id:l,incorrectAnswerId:c,exercise_uid:d,className:p,questionNumber:m,context:h,task:u,hidePreambles:b}=r,{stem_html:f,collaborator_solutions:g=[],formats:w,stimulus_html:x}=s,v=!!l,$=n("openstax-question",p,{"has-correct-answer":v&&!((null!=u?u.is_deleted:void 0)&&"homework"===(null!=u?u.type:void 0)),"has-incorrect-answer":!!c});return null!=d&&(a=e("div",{className:"exercise-uid",children:d})),(()=>{const{displaySolution:e}=r,{collaborator_solutions:t=[]}=s;return e&&t&&t.find(e=>void 0!==e.content_html)})()&&(i=t("div",{className:"detailed-solution",children:[e("div",{className:"header",children:"Detailed solution:"}),e(I,{className:"solution",block:!0,html:g.map(e=>e.content_html).join("")})]})),t(Je,{ref:o,className:$,"data-question-number":m,"data-test-id":"question",children:[e(Ve,{type:"context",html:h,hidden:b}),e(Ve,{type:"stimulus",html:x,hidden:b}),e(Ve,{type:"stem",html:f,hidden:b,questionNumber:m}),r.children,e(oe,q({},r,{onChangeAnswer:r.onChange,hasCorrectAnswer:v})),i,r.displayFormats?e(Be,{formats:w}):void 0,a]})}),Ve=t=>{const{html:r="",type:n,hidden:o,questionNumber:a}=t;return!0!==o&&r.length>0?e(I,{html:r,"data-question-number":a,className:`question-${n}`,block:!0}):null},Be=({formats:r=[]})=>t("div",{className:"formats-listing",children:[e("div",{className:"header",children:"Formats:"}),r.map((t,r)=>e("span",{children:t},r))]});let Re,Fe,De=e=>e;const We=i.div(Re||(Re=De`
    ${0}
    display: flex;
    flex-wrap: wrap;
    justify-content: space-between;
    ...
    ${0}
`),Y.stepCardPadding(),U.card.body.background,U.palette.pale,K(Fe||(Fe=De`
...
`),U.palette.neutral,U.palette.neutralDark,e=>e.isOverWordLimit&&tt,e=>e.isOverWordLimit&&s(Xe||(Xe=et`
    border: 2px solid ${0};
  `),U.palette.danger),e=>e.readOnly&&U.palette.neutralCool);at.displayName="OSFreeResponseTextArea";const it=t=>e(Ae,q({},t,{children:"Cancel"})),st=r=>{const{availablePoints:n,cancelHandler:o,defaultValue:a,infoRowChildren:i,isSubmitDisabled:s,question:l,questionNumber:c,saveHandler:d,submitBtnLabel:p,textHasChanged:m,wordLimit:h}=r,u=_(a)>h,b={};return c&&(b["data-question-number"]=c),t(rt,{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(nt,q({},b,{children:l.stem_html&&e(Ve,{type:"stem",html:l.stem_html,hidden:!1})})),e(at,q({},r,{isOverWordLimit:u,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box"})),t(ot,{hasChildren:!!i,children:[i,t("div",{children:[t("span",{children:[_(a)," words"]}),u&&t("span",{className:"word-limit-error-info",children:["Maximum ",h," words"]})]})]})]}),t(We,{children:[n?e("div",{className:"points",children:t("strong",{children:["Points: ",n]})}):null,t("div",{className:"controls",children:[e(it,{disabled:!m,onClick:o}),e(Ae,{"data-test-id":"submit-answer-btn",disabled:s||u,onClick:d,children:p})]})]})]})};st.displayName="OSFreeResponse";const lt=({count:e})=>t("div",{children:[e," attempt",1===e?"":"s"," left"]}),ct=({published_comments:r})=>r?t("div",{children:[e("strong",{children:"Feedback:"})," ",r]}):null,dt=t=>e(Ae,q({},t,{waitingText:"Saving…",isWaiting:t.isWaiting,"data-test-id":"submit-answer-btn",children:0==t.attempt_number?"Submit":"Re-submit"})),pt=t=>e(Ae,q({},t,{"data-test-id":"continue-btn",children:t.canUpdateCurrentStep?"Continue":"Next"})),mt=({free_response:t})=>t?e(r,{children:e("div",{className:"free-response",children:t})}):null,ht=o.forwardRef((r,n)=>{const{question:o,task:a,answer_id_order:i,onAnswerChange:s,feedback_html:l,correct_answer_feedback_html:c,is_completed:d,correct_answer_id:p,incorrectAnswerId:m,choicesEnabled:h,questionNumber:u,answer_id:b,hasMultipleAttempts:f,attempts_remaining:g,published_comments:w,detailedSolution:x,canAnswer:v,needsSaved:$,attempt_number:k,apiIsPending:y,onAnswerSave:C,onNextStep:N,canUpdateCurrentStep:_,displaySolution:q,available_points:S,free_response:A,show_all_feedback:M,tableFeedbackEnabled:T}=r;return t("div",{"data-test-id":"student-exercise-question",children:[e(Qe,{ref:n,task:a,question:o,answerIdOrder:i,choicesEnabled:h,answer_id:b,questionNumber:u,onChange:s,feedback_html:l,correct_answer_feedback_html:c,correct_answer_id:d?p:null,incorrectAnswerId:m,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:q,show_all_feedback:M,tableFeedbackEnabled:T,children:e(mt,{free_response:A})}),e(We,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[t("div",{className:"points",children:[S?t("strong",{children:["Points: ",S]}):null,e("span",{className:"attempts-left",children:f&&g>0&&e(lt,{count:g})}),e(ct,{published_comments:w}),x&&t("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(I,{html:x})]})]}),e("div",{className:"controls",children:v&&$?e(dt,{disabled:y||!b,isWaiting:y,attempt_number:k,onClick:()=>{return C("string"==typeof(e=o.id)?parseInt(e,10):e);var e}}):e(pt,{onClick:()=>N(u-1),canUpdateCurrentStep:_})})]})})]})}),ut={extensions:[],showProcessingMessages:!1,skipStartupTypeset:!0,styles:{"#MathJax_MSIE_Frame":{left:"",right:0,visibility:"hidden"},"#MathJax_Message":{left:"",right:0,visibility:"hidden"}},tex2jax:{displayMath:[["‌‌‌","‌‌‌"]],inlineMath:[["​​​","​​​"]]}},bt=e=>{const t=(e=>Array.from(e.querySelectorAll(".MathJax math")))(e);return Array.from(e.querySelectorAll("math")).filter(e=>-1===t.indexOf(e))},ft=e=>{const t=[];for(const r of Array.from(e.querySelectorAll("[data-math]:not(.math-rendered)"))){const e=r.getAttribute("data-math");r.classList.contains("math-marked")||(r.textContent="div"===r.tagName.toLowerCase()?`‌‌‌${e}‌‌‌`:`​​​${e}​​​`,r.classList.add("math-marked")),t.push(r)}return t},gt=(e,t,r=5)=>{r>0&&(ft(e).length||bt(e).length)?setTimeout(()=>{gt(e,t,r-1)},200):t()},wt=(e,t)=>new Promise(r=>{(function(e,t){const r=ft(e);t.MathJax.Hub.Queue(((e,t)=>()=>{h(e)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e),(e=>()=>{const t=[];for(const r of e)t.push(r.className+=" math-rendered")})(e))})(r,t),((e,t)=>()=>{const r=bt(e);h(r)||t.MathJax.Hub.Queue(()=>t.MathJax.Hub.Typeset(e))})(e,t))})(e,t),t.MathJax.Hub.Queue(()=>{gt(e,r)})}),xt=m((e,t)=>d(wt,100,{leading:!0,trailing:!1}).bind(null,e,t));xt.cache=new u;const vt=p((e=window)=>new Promise(t=>{const r=()=>{e.MathJax.HTML.Cookie.prefix="mathjax",e.MathJax.Hub.Configured(),e.MathJax.Hub.Register.StartupHook("End",()=>{t()})};if(!document.getElementById("MathJax-Script")){const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_HTMLorMML-full&delayStartupUntil=configured",e.id="MathJax-Script",e.async=!0,document.head.appendChild(e)}e.MathJax&&e.MathJax.Hub?(e.MathJax.Hub.Config(ut),e.MathJax.Hub.processSectionDelay=0,r()):(ut.AuthorInit=r,e.MathJax=ut)}));let $t,kt,yt,Ct,Nt,_t=e=>e;const qt=i.div($t||($t=_t`
  position: absolute;
  background: #fff;
  width: 4.5rem;
  border: 1px solid ${0};
...
`)),Rt=i(b)(zt||(zt=Pt`
  color: ${0};
  height: 1em;
`),U.palette.darkGray),Ft=({exercise:t,icons:r})=>{const n={desktop:!0,mobile:!1},o=[],a=t.questions.every(e=>e.answers.length>0);let i;var s,l,c;return a&&t.questions.find(e=>e.formats.includes("free-response"))?i="In a two-step question, OpenStax asks for your own answer first, then gives multiple-choice options to help you assess your learnings. Recalling the answer to a question from memory helps you to retain things longer.":a&&(i="Select the best answer from the given list of distractors. Your instructor may or may not allow multiple attempts."),r.topic&&o.push(e(Vt,q({text:"View topic in textbook",wrapperProps:{as:"a",href:r.topic.url,target:"_blank"}},(null==(s=r.topic.location)?void 0:s.header)||n,{children:e(Rt,{icon:w})}),"topic")),r.errata&&o.push(e(Vt,q({text:"Suggest a correction",wrapperProps:{as:"a",href:r.errata.url,target:"_blank"}},(null==(l=r.errata.location)?void 0:l.header)||n,{children:e(Rt,{icon:x})}),"errata")),r.info&&i&&o.push(e(Vt,q({text:i},(null==(c=r.info.location)?void 0:c.header)||n,{children:e(Rt,{icon:v,height:"16px",width:"16px"})}),"type")),e(Bt,{children:o})},Dt=["numberOfQuestions","questionNumber","step","exercise","show_all_feedback","scrollToQuestion","exerciseIcons"];let Wt,Ut,Zt,Gt,Kt,Yt,Xt,er,tr,rr,nr=e=>e;const or=i(Ne)(Wt||(Wt=nr`
  font-size: calc(1.8rem * var(--content-text-scale));
...
`),e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"4rem":"3.2rem",e=>e.isActive?"0":"0 0.3rem",U.palette.neutralDarker,e=>e.isActive?s(xr||(xr=$r`
  ...
  `),Cr):null,e=>(e=>{switch(e){case"isStatus":return s(ur||(ur=$r`
        background-color: ${0};
