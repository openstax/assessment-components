...
`),ye.palette.darkGray,ye.palette.neutral,ye.palette.neutralDark),zr=t=>e(Er,L({},t,{children:"Cancel"})),Ir=n=>{const{is_completed:o,canAnswer:a,needsSaved:s,apiIsPending:c,free_response:p,onAnswerChange:u,onAnswerSave:m,onNextStep:h,questionNumber:b,question:g,wordLimit:f,score:w,feedback_html:x,submissionTimestamp:v,cancelHandler:k,previewMode:y=!1,onGradingSave:$,gradingTimestamp:C}=n,S="number"==typeof(null==w?void 0:w.raw)&&"number"==typeof(null==w?void 0:w.max)?`${w.raw}/${w.max}`:void 0,[_,N]=l(!1),[q,A]=l(!1),M=i(null),[E,z]=l(p||""),I=o&&a,T=o&&!a;d(()=>{I&&!s&&z(p||"")},[s,I,p]);const F=s&&(p||"")!==E,L=function(e){const t=e.trim();return t?t.split(/\s+/).length:0}(p||""),H=L>f;d(()=>{const e=()=>{T&&M.current&&A(!_&&M.current.scrollHeight>168)};return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[p,T,_]);const O=e=>{const t=e.target.value,r=t.trim();let n=t;if(r){const t=r.split(/\s+/);t.length>f&&(n=t.slice(0,f).join(" "),e.target.value=n)}u({id:P(g.id),question_id:P(g.id),type:"free-response",content_html:n,free_response:n,correctness:void 0})},j=()=>{m(P(g.id))};return t(xr,T?{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(vr,{children:g.stem_html&&e(It,{type:"stem",html:g.stem_html,hidden:!1})}),!y&&e($r,{children:"Your answer"}),y&&$?t(qr,{children:[t(Ar,{children:[e(Cr,{ref:M,expanded:_,isOverflowing:q,children:p||""}),(q||_)&&e(Sr,{onClick:()=>N(!_),children:_?"read less":"read more"}),y&&t("div",{style:{marginTop:"1.6rem"},children:[S&&t(_r,{role:"status",children:["Score: ",S]}),x&&t(Nr,{children:[e("span",{className:"feedback-label",children:"Feedback:"})," ",e(It,{type:"stem",html:x,hidden:!1})]})]})]}),y&&e(nr,{questionId:g.id,maxScore:(null==w?void 0:w.max)||1,score:null==w?void 0:w.raw,comment:x,onSave:$,gradingTimestamp:C})]}):t(r,{children:[e(Cr,{ref:M,expanded:_,isOverflowing:q,children:p||""}),(q||_)&&e(Sr,{onClick:()=>N(!_),children:_?"read less":"read more"}),y&&t("div",{style:{marginTop:"1.6rem"},children:[S&&t(_r,{role:"status",children:["Score: ",S]}),x&&t(Nr,{children:[e("span",{className:"feedback-label",children:"Feedback:"})," ",e(It,{type:"stem",html:x,hidden:!1})]})]})]})]}),!y&&e(jt,{children:t("div",{className:"step-card-footer-inner",children:[t("div",{children:[S&&t(_r,{role:"status",children:["Score: ",S]}),x&&t(Nr,{children:[e("span",{className:"feedback-label",children:"Feedback:"})," ",e(It,{type:"stem",html:x,hidden:!1})]})]}),e("div",{className:"controls",children:e(pt,{"data-test-id":"next-btn",onClick:()=>{h(b-1)},children:"Next"})})]})})]}:I?{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(vr,{children:g.stem_html&&e(It,{type:"stem",html:g.stem_html,hidden:!1})}),e(yr,{value:p||"",onChange:O,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box",disabled:y||c}),!y&&t(kr,{hasChildren:!!v,children:[v&&e("div",{children:t("span",{className:"last-submitted",children:["Last submitted on ",D(v)]})}),t("div",{children:[L>=f&&e("span",{className:"word-limit-error-info",children:"Word limit reached"}),t("span",{children:[" Remaining words: ",f-L]})]})]})]}),!y&&e(jt,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[e("div",{}),t("div",{className:"controls",children:[e(zr,{disabled:!F||c,onClick:e=>{u({id:P(g.id),question_id:P(g.id),type:"free-response",content_html:E,free_response:E,correctness:void 0}),k(e)}}),e(pt,{"data-test-id":"update-answer-btn",disabled:!F||c||H||0===(p||"").trim().length,isWaiting:c,waitingText:"Saving...",onClick:j,children:"Update"})]})]})})]}:{"data-test-id":"student-free-response",children:[t("div",{className:"step-card-body",children:[e(vr,{children:g.stem_html&&e(It,{type:"stem",html:g.stem_html,hidden:!1})}),y?$?t(qr,{children:[e(Ar,{children:e(Mr,{children:"Unanswered"})}),e(nr,{questionId:g.id,maxScore:(null==w?void 0:w.max)||1,score:null==w?void 0:w.raw,comment:x,onSave:$,gradingTimestamp:C})]}):e(Mr,{children:"Unanswered"}):e(yr,{value:p||"",onChange:O,"data-test-id":"free-response-box",placeholder:"Enter your response...","aria-label":"question response text box",disabled:y||c}),!y&&t(kr,{hasChildren:!!v,children:[v&&e("div",{children:t("span",{className:"last-submitted",children:["Last submitted on ",D(v)]})}),t("div",{children:[L>=f&&e("span",{className:"word-limit-error-info",children:"Word limit reached"}),t("span",{children:[" Remaining words: ",f-L]})]})]})]}),!y&&e(jt,{className:"step-card-footer",children:t("div",{className:"step-card-footer-inner",children:[e("div",{}),e("div",{className:"controls",children:e(pt,{"data-test-id":"submit-answer-btn",disabled:c||H||0===(p||"").trim().length,isWaiting:c,waitingText:"Saving...",onClick:j,children:"Submit"})})]})})]})};Ir.displayName="OSFreeResponse";let Tr,Fr,Lr,Hr,Or=e=>e;const jr="\n  padding: 1rem 2.5rem;\n  margin: 1rem 0 1rem 1rem;\n",Pr=u.div(Tr||(Tr=Or`
  ${0}
