import{jsx as e,jsxs as r,Fragment as t}from"react/jsx-runtime.js";import n from"classnames";import a,{createElement as o}from"react";import i,{css as s}from"styled-components";const l="abcdefghijklmnopqrstuvwxyz",d=function(e,r){return e.id===r};function c(e){const r=e.trim().match(/\b[-?(\w+)?]+\b/gi);return r?r.length:0}function m(){return m=Object.assign?Object.assign.bind():function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e},m.apply(this,arguments)}function p(e,r){if(null==e)return{};var t,n,a={},o=Object.keys(e);for(n=0;n<o.length;n++)r.indexOf(t=o[n])>=0||(a[t]=e[t]);return a}const h=["html","component","block"],u=r=>{let{html:t,component:n,block:o=!1}=r,i=p(r,h);return void 0!==n?a.cloneElement(n,m({html:t},i)):e(o?"div":"span",m({dangerouslySetInnerHTML:{__html:t}},i))},b=r=>e("aside",{children:e(u,{component:r.contentRenderer,className:n("question-feedback-content","has-html",r.className),html:r.children,block:!0})}),w=t=>{const a=n("question-feedback",t.position||"bottom");return r("aside",{className:a,children:[e("div",{className:"arrow","aria-label":"Answer Feedback"}),e(b,m({},t,{children:t.children}))]})},g=a=>{const{type:o,iter:i,answer:s,disabled:c,onKeyPress:m,qid:p,chosenAnswer:h,correctAnswerId:w,incorrectAnswerId:g,hasCorrectAnswer:f,answered_count:x,contentRenderer:$,show_all_feedback:k}=a;let v,y,N;const _=((e,r)=>Boolean((r||[]).find(r=>r==e.id)))(s,h),C=function(e,r){if(!e.id&&!r)return e.isCorrect;let t=e.id===r;return null!=e.correctness&&(t="1.0"===e.correctness),t}(s,w),q=d(s,g),S=e("div",{className:"correct-incorrect",children:C&&a.correctIncorrectIcon}),A=n("answers-answer",{disabled:c,"answer-checked":_,"answer-correct":C&&"student-mpp"!==o,"answer-incorrect":g&&d(s,g)});let O,I,H=`${_?"Selected ":""}Choice ${l[i]}`;if(f&&(H+=`(${C?"Correct":"Incorrect"} Answer)`),H+=":",f||"teacher-review"===o||"teacher-preview"===o||"student-mpp"===o||({onChangeAnswer:O}=a),O&&(I=e("input",{type:"radio",className:"answer-input-box",checked:_,id:`${p}-option-${i}`,name:`${p}-options`,onChange:O,disabled:c})),k&&s.feedback_html&&(y=e(b,{contentRenderer:$,children:s.feedback_html},"question-mc-feedback")),"teacher-review"===o){let t=0;s.selected_count&&x&&(t=Math.round(s.selected_count/x*100)),N=e("span",{className:"selected-count","data-percent":`${t}`,children:s.selected_count}),v=r("div",{className:"review-wrapper",children:[r("div",{className:n("review-count",{green:C,red:!C}),children:[N,e("span",{className:n("letter",{green:C,red:!C}),children:l[i]})]}),r("div",{className:"answer-answer",children:[e(u,{className:"answer-content",component:$,html:s.content_html}),y]})]})}else v=r(t,{children:["teacher-preview"===o&&S,N,I,r("label",{onKeyPress:m,htmlFor:`${p}-option-${i}`,className:"answer-label",children:[e("span",{className:"answer-letter-wrapper",children:e("button",{onClick:O,"aria-label":H,className:"answer-letter",disabled:c||q,"data-test-id":`answer-choice-${l[i]}`,children:l[i]})}),r("div",{className:"answer-answer",children:[e(u,{className:"answer-content",component:$,html:s.content_html}),y]})]})]});return e("div",{className:"openstax-answer",children:e("section",{role:"region",className:A,children:v})})};g.displayName="OSAnswer";const f="student",x=t=>{let n=0;const{question:a,hideAnswers:o,type:i=f,answered_count:s,choicesEnabled:l,correct_answer_id:d,incorrectAnswerId:c,answer_id:p,feedback_html:h,correct_answer_feedback_html:u,show_all_feedback:b=!1,hasCorrectAnswer:x,onChangeAnswer:$,onKeyPress:k,answerIdOrder:v,instructions:y}=t;if(o)return null;const{id:N}=a,_=[],C={qid:N||"auto-"+n++,correctAnswerId:d,incorrectAnswerId:c,hasCorrectAnswer:x,chosenAnswer:[p],onChangeAnswer:$,type:i,answered_count:s,disabled:!l,show_all_feedback:b,onKeyPress:k},q=(v?(e=>{const{answers:r}=a;return r.slice().sort((r,t)=>e.indexOf(r.id)-e.indexOf(t.id))})(v):a.answers).map((r,t)=>{const n=Object.assign({},{answer:r,iter:t,key:`${C.qid}-option-${t}`},C);return r.id===c&&h?_.push({index:t,html:h}):r.id===d&&u&&_.push({index:t,html:u}),e(g,m({},n))});return _.forEach((r,n)=>{const a=r.index+n+1;q.splice(a,0,e(w,{contentRenderer:t.contentRenderer,children:r.html},a))}),r("div",{className:"answers-table",children:[y,q]})};let $,k,v,y,N,_,C,q,S,A,O,I,H,P=e=>e;const T={red:"#ca2026",danger:"#c2002f",darkRed:"#c22032",lightRed:"#e298a0",green:"#77af42",lightGreen:"#8bc753",darkGreen:"#63a524",paleYellow:"#ffffbb",teal:"#0dc0de",blue:"#007da4",lightBlue:"#34bdd8",neutralLightBlue:"#0dc0dc",tangerine:"#ffbd3e",gray:"#5e5e5e",darkGray:"#757575",pale:"#d5d5d5",light:"#e4e4e4",white:"#ffffff",neutralLightest:"#f9f9f9",neutralCool:"#f6f7f8",neutralBright:"#f5f5f5",neutralLighter:"#f1f1f1",neutralLight:"#e5e5e5",neutralMedium:"#a0a0a0",neutral:"#818181",neutralThin:"#6f6f6f",neutralDark:"#5f6163",neutralDarker:"#424242",black:"#000000",orange:"#D4450C"},z={palette:T,answer:{color:T.lightBlue,correct:{color:T.green,background:"#77af42"},incorrect:{color:T.red,background:T.red},checked:T.lightBlue,hover:T.neutralDark,label:{color:T.neutralMedium,colorHover:T.neutralDark,colorSelected:T.lightBlue},feedback:{arrowOuterColor:"rgba(0, 0, 0, 0.25)",popover:{borderColor:"rgba(0, 0, 0, 0.2)"}}},card:{background:"#daf3f8"},button:{background:T.orange,backgroundHover:"#E74B0D",backgroundActive:"#C5400B"},freeResponse:{color:T.neutralDark,background:T.neutralLighter}},j=(...e)=>s($||($=P`@media(max-width: ${0}px) { ${0} }`),600,s(...e)),B=(...e)=>s(k||(k=P`@media(max-width: ${0}px) { ${0} }`),999,s(...e)),L=(...e)=>s(v||(v=P`@media(min-width: ${0}px) { ${0} }`),1e3,s(...e)),R={answer:()=>s(N||(N=P`
  ...
  `),z.answer.label.color,"4rem","4rem","4rem","4rem","4rem",z.answer.label.colorHover,"0.1s ease-in-out","0.1s ease-in-out","0.1s ease-in-out",z.palette.white),answerColor:e=>s(_||(_=P`
    color: ${0};
    .answer-letter {
       border-color: ${0};
       background-color: ${0};
  ...
  `),e.color,e.color,e.background,z.palette.white),answerChecked:()=>R.answerColor({color:z.answer.checked,background:z.answer.checked}),answerCorrect:()=>R.answerColor(z.answer.correct),answerIncorrect:()=>R.answerColor(z.answer.incorrect),answerHover:()=>s(C||(C=P`
    color: ${0};
    .answer-letter {
      border-color: ${0};
    }
...
`),R.stepCardPadding(),((...e)=>s(y||(y=P`@media(max-width: ${0}px) { ${0} }`),600,s(...e)))(Ne||(Ne=qe`
    ...
    `),"8px")),He=t=>{let{questionNumber:n,numberOfQuestions:a,stepType:o,isHomework:i,availablePoints:s,unpadded:l,className:d,children:c,questionId:h,multipartBadge:u,leftHeaderChildren:b,rightHeaderChildren:w,headerTitleChildren:g}=t,f=p(t,he);return r(Ae,m({},f,{children:[u,r(Se,{className:d,children:[n&&i&&"exercise"===o&&r(Oe,{children:[r("div",{children:[b,r("div",{className:"question-info",children:[g,r("span",{children:["Question ",n]}),r("span",{className:"num-questions",children:[" / ",a]}),e("span",{className:"separator",children:"|"}),r("span",{className:"question-id",children:["ID: ",h]})]})]}),r("div",{children:[s&&r("div",{className:"points",children:[s," Points"]}),w]})]}),e(Ie,{unpadded:l,children:c})]})]}))};He.displayName="OSStepCard";const Pe=r=>{let{step:t,questionNumber:a,numberOfQuestions:o,children:i,className:s}=r,l=p(r,ue);return e(He,m({},l,{unpadded:!0,questionNumber:a,numberOfQuestions:o,stepType:"type"in t?t.type:"exercise",isHomework:!("task"in t)||void 0===t.task||"homework"===t.task.type,"data-task-step-id":t.id,availablePoints:t.available_points,className:n(`${"type"in t?t.type:"exercise"}-step`,s),questionId:t.uid,children:i}))};Pe.displayName="OSTaskStepCard";const Te=({count:e})=>r("div",{children:[e," attempt",1===e?"":"s"," left"]}),ze=({published_comments:t})=>t?r("div",{children:[e("strong",{children:"Feedback:"})," ",t]}):null,je=r=>e(G,m({},r,{waitingText:"Saving…",isWaiting:r.isWaiting,"data-test-id":"submit-answer-btn",children:0==r.attempt_number?"Submit":"Re-submit"})),Be=r=>e(G,{onClick:r.onNextStep,"data-test-id":"continue-btn",children:r.canUpdateCurrentStep?"Continue":"Next"}),Le=({free_response:r})=>r?e(t,{children:e("div",{className:"free-response",children:r})}):null,Re=t=>{const{question:n,task:a,answer_id_order:o,onAnswerChange:i,feedback_html:s,correct_answer_feedback_html:l,is_completed:d,correct_answer_id:c,incorrectAnswerId:m,choicesEnabled:p,questionNumber:h,answer_id:b,hasMultipleAttempts:w,attempts_remaining:g,published_comments:f,detailedSolution:x,canAnswer:$,needsSaved:k,attempt_number:v,apiIsPending:y,onAnswerSave:N,onNextStep:_,canUpdateCurrentStep:C,displaySolution:q,available_points:S,free_response:A}=t;return r("div",{"data-test-id":"student-exercise-question",children:[e(F,{task:a,question:n,answerIdOrder:o,choicesEnabled:p,answer_id:b,questionNumber:h,onChange:i,feedback_html:s,correct_answer_feedback_html:l,correct_answer_id:d?c:null,incorrectAnswerId:m,className:"step-card-body",hideAnswers:!1,displayFormats:!1,displaySolution:q,children:e(Le,{free_response:A})}),r(X,{className:"step-card-footer",children:[r("div",{className:"points",children:[r("strong",{children:["Points: ",S]}),e("span",{className:"attempts-left",children:w&&g>0&&e(Te,{count:g})}),e(ze,{published_comments:f}),x&&r("div",{children:[e("strong",{children:"Detailed solution:"})," ",e(u,{html:x})]})]}),e("div",{className:"controls",children:$&&k?e(je,{disabled:y||!b,isWaiting:y,attempt_number:v,onClick:N}):e(Be,{onNextStep:_,canUpdateCurrentStep:C})})]})]})},De=["numberOfQuestions","questionNumber","step","exercise","canAnswer","needsSaved"];let Ee;const Fe=i(Pe)(Ee||(Ee=(e=>e)`
  font-size: 1.8rem;
  line-height: 3rem;
`)),Qe=({exercise:n})=>r(t,{children:[n.context&&e(u,{className:"step-card-body exercise-context",block:!0,html:n.context}),n.stimulus_html&&e(u,{className:"step-card-body exercise-stimulus",block:!0,html:n.stimulus_html})]}),We=t=>{let{numberOfQuestions:n,questionNumber:a,step:i,exercise:s,canAnswer:l,needsSaved:d}=t,c=p(t,De);return r(Fe,{step:i,questionNumber:a,numberOfQuestions:n,children:[e(Qe,{exercise:s}),s.questions.map(e=>{var r;const t=m({},"feedback_html"in i?i:c.questionStates[e.id]);return o(Re,m({},c,t,{exercise_uid:s.uid,key:e.id,question:e,questionNumber:a,choicesEnabled:l,canAnswer:l,needsSaved:d,canUpdateCurrentStep:l,displaySolution:!0,detailedSolution:null==(r=t.solution)?void 0:r.content_html}))})]})};export{g as Answer,x as AnswersTable,We as Exercise,pe as FreeResponseInput,ce as FreeResponseTextArea,Se as InnerStepCard,Ae as OuterStepCard,F as Question,Q as QuestionHtml,He as StepCard,Pe as TaskStepCard};
