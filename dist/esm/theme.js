...
export const mixins = {
  ...
  `,
    answerColor: (color, invertBubble = false) => css `
    .answer-letter-wrapper::before {
  ...
  `,
    ...
    answerCorrect: (checked) => mixins.answerColor(colors.answer.correct, checked),
    answerIncorrect: (checked) => mixins.answerColor(colors.answer.incorrect, checked),
    answerHover: () => css `
