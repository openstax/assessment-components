...
`;
// tslint:disable-next-line:variable-name
const CloseIcon = () => (_jsxs("svg", { width: '42', height: '42', viewBox: '0 0 42 42', xmlns: 'http://www.w3.org/2000/svg', children: [_jsx("rect", { x: '1', y: '1', width: '40', height: '40', rx: '20', stroke: 'white', fill: 'none' }), _jsx("line", { x1: '16', y1: '16', x2: '26', y2: '26', stroke: 'white', strokeWidth: '2', strokeLinecap: 'round' }), _jsx("line", { x1: '26', y1: '16', x2: '16', y2: '26', stroke: 'white', strokeWidth: '2', strokeLinecap: 'round' })] }));
// tslint:disable-next-line:variable-name
const MediaModal = ({ isOpen, onClose, children }) => {
    ...
    if (!isOpen)
        return null;
    return (_jsx(Overlay, { onClick: onClose, children: _jsx(ModalWrapper, { "aria-modal": "true", role: "dialog", children: _jsxs(ContentContainer, { ref: modalRef, onClick: (e) => e.stopPropagation(), tabIndex: -1, children: [_jsx(FloatingCloseButton, { onClick: onClose, "aria-label": "Close media preview", children: _jsx(CloseIcon, {}) }), _jsx(ScrollableContent, { children: children })] }) }) }));
};
