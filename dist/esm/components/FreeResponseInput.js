...
const ResponseInfoRow = ({ submissionTimestamp, draftTimestamp, wordCount, wordLimit }) => {
    ...
    const status = showDraft
        ...
        : submissionTimestamp !== undefined
            ...
            : undefined;
    return (_jsxs(InfoRow, { hasChildren: !!status, children: [status && _jsx("div", { children: _jsx("span", { className: "last-submitted", children: status }) }), _jsxs("div", { children: [wordCount >= wordLimit && _jsx("span", { className: "word-limit-error-info", children: "Word limit reached" }), _jsxs("span", { children: [" Remaining words: ", wordLimit - wordCount] })] })] }));
};
export const FreeResponseInput = (props) => {
    ...
    const [originalSubmittedValue, setOriginalSubmittedValue] = useState((_a = submittedResponse !== null && submittedResponse !== void 0 ? submittedResponse : free_response) !== null && _a !== void 0 ? _a : '');
