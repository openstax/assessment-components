...
function countWords(text) {
  var trimmedText = text.trim(); //https://css-tricks.com/build-word-counter-app/
...
var Feedback = function Feedback(props) {
  ...
  var wrapperClasses = cn('question-feedback', position);
  return jsxs("aside", {
...
var Answer = function Answer(props) {
  ...
  var ariaLabel = (isChecked ? 'Selected ' : '') + "Choice " + ALPHABET[iter]; // somewhat misleading - this means that there is a correct answer,
...
var breakpoints = {
  mobile: function mobile() {
    return css(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteralLoose(["@media(max-width: ", "px) { ", " }"])), BREAKPOINTS.mobile, css.apply(void 0, [].slice.call(arguments)));
  },
  tablet: function tablet() {
    return css(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteralLoose(["@media(max-width: ", "px) { ", " }"])), BREAKPOINTS.tablet, css.apply(void 0, [].slice.call(arguments)));
  },
  desktop: function desktop() {
    return css(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteralLoose(["@media(min-width: ", "px) { ", " }"])), BREAKPOINTS.desktop, css.apply(void 0, [].slice.call(arguments)));
  },
  only: {
    mobile: function mobile() {
      return css(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteralLoose(["@media(max-width: ", "px) { ", " }"])), BREAKPOINTS.mobile, css.apply(void 0, [].slice.call(arguments)));
    }
  },
  margins: {
    mobile: '8px',
...
var Question = function Question(props) {
  ...
  var classes = cn('openstax-question', className, {
...
var StepCardFooter = styled.div(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteralLoose(["\n    ", "\n    border-top: 1px solid ", ";\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: space-between;\n    font-size: 1.4rem;\n    line-height: 2rem;\n\n    > * {\n        flex-grow: 1;\n    }\n\n    button {\n        width: 160px;\n        height: 48px;\n    }\n\n    .points {\n        margin-bottom: 1.6rem; // Replace with https://caniuse.com/?search=gap soon\n\n        .attempts-left {\n            color: #F36B32;\n        }\n    }\n\n    .controls {\n        display: flex;\n        flex-flow: column wrap-reverse;\n        margin-left: 1.6rem; // Replace with https://caniuse.com/?search=gap soon\n\n        button + button {\n            margin: 0.8rem 0 0 0;\n        }\n    }\n\n    ", "\n"])), mixins.stepCardPadding(), colors.palette.pale, breakpoints.desktop(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteralLoose(["\n        padding: 32px 140px;\n        flex-wrap: nowrap;\n\n        .points {\n            max-width: 400px;\n        }\n\n        .controls {\n            flex-flow: row;\n            justify-content: flex-end;\n\n            button + button {\n                margin: 0 0 0 0.8rem;\n            }\n        }\n    "]))));

var _templateObject$2, _templateObject2$1, _templateObject3$1, _templateObject4$1, _templateObject5$1, _templateObject6$1;
var TextAreaErrorStyle = css(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteralLoose(["\n  background-color: #f5e9ea;\n"])));
var StyledFreeResponse = styled.div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteralLoose(["\n  display: flex;\n  flex-direction: column;\n\n  .step-card-body {\n    ", "\n  }\n"])), mixins.stepCardPadding());
var SyledQuestionStem = styled.div(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteralLoose(["\n  font-size: 2rem;\n  line-height: 1.68em;\n  position: relative;\n"])));
var InfoRow = styled.div(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteralLoose(["\n  margin: 8px 0;\n  display: flex;\n  justify-content: ", ";\n  line-height: 1.6rem;\n\n  .word-limit-error-info {\n    color: ", ";\n  }\n\n  div > span {\n    font-size: 12px;\n    line-height: 16px;\n\n    + span {\n      margin-left: 1rem;\n    }\n  }\n\n  .last-submitted + * {\n    margin-top: 0.8rem;\n  }\n\n  color: ", ";\n"])), function (props) {
  return props.hasChildren ? 'space-between' : 'flex-end';
}, colors.palette.danger, colors.palette.neutralThin);
var FreeResponseTextArea = styled.textarea(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteralLoose(["\n  display: block;\n  font-family: inherit;\n  font-size: 1.8rem;\n  line-height: 3rem;\n  width: 100%;\n  min-height: 10.5em;\n  line-height: 1.5em;\n  margin: 2.5rem 0 0 0;\n  padding: 0.5em;\n  border: 1px solid ", ";\n  color: ", ";\n  ", ";\n  ", "\n  background-color: ", ";\n"])), colors.palette.neutral, colors.palette.neutralDark, function (props) {
  return props.isOverWordLimit && TextAreaErrorStyle;
}, function (props) {
  return props.isOverWordLimit && css(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteralLoose(["\n    border: 2px solid ", ";\n  "])), colors.palette.danger);
}, function (props) {
...
var _templateObject;
var StyledTaskStepCard = styled(TaskStepCard)(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  font-size: 1.8rem;\n  line-height: 3rem;\n"])));
...
var Exercise = function Exercise(_ref2) {
  ...
  return jsxs(StyledTaskStepCard, {
    ...
    children: [jsx(Preamble, {
      ...
      return /*#__PURE__*/createElement(ExerciseQuestion, _extends({}, props, step, {
