...
export declare const Exercise: import("styled-components").StyledComponent<({ numberOfQuestions, questionNumber, step, exercise, show_all_feedback, scrollToQuestion, exerciseIcons, overlayChildren, labelAnswers, previewMode, showScoring, rightSideSlot, ...props }: {
    className?: string | undefined;
    previewMode?: boolean | undefined;
    showScoring?: boolean | undefined;
