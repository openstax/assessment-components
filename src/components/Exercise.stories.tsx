...
export const FreeResponseGradingWithAnswer = () => {
  ...
  const questionStates = {
    'fr-grade-2': {
      ...
      answer_id_order: [],
      answer_id: undefined,
      freeResponse: 'The cell cycle consists of interphase and mitotic phase. Interphase includes G1 (cell growth), S (DNA replication), and G2 (preparation for division). The mitotic phase includes mitosis (nuclear division with prophase, metaphase, anaphase, and telophase) and cytokinesis (cytoplasm division). This cycle allows cells to grow and reproduce.',
...
export const FreeResponsePreviewWithoutGrading = () => {
  ...
  const questionStates = {
    'fr-preview-1': {
      ...
      answer_id_order: [],
      answer_id: undefined,
      freeResponse: 'Enzymes are biological catalysts that speed up chemical reactions by lowering the activation energy required. They have specific active sites that bind to substrates, forming enzyme-substrate complexes. After the reaction, products are released and the enzyme can be reused.',
