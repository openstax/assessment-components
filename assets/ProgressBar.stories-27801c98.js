...
`,k=e=>{switch(e){case"isStatus":return d`
      ...
      `;default:return d`
        background-color: ${c.palette.neutralBright};
      `}},v="box-shadow: 0px 1px 4px 0px #00000066;",y=u.button`
  display: flex;
  justify-content: center;
  align-items: center;
...
`,$=u(b)`
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`,M=({variant:e})=>{if(!e||e!=="isCorrect"&&e!=="isIncorrect")return null;const r={isCorrect:{icon:f.faCheck,color:c.answer.correct,label:"Correct"},isIncorrect:{icon:g.faXmark,color:c.answer.incorrect,label:"Incorrect"}}[e];return t($,{icon:r.icon,color:r.color,height:"16px",width:"16px","aria-label":r.label,"aria-hidden":void 0})},S=({index:e,isActive:r,step:a,goToStep:i})=>C(V,{children:[t(y,{variant:a.variant,isActive:r,onClick:()=>i(e,a),"aria-current":r?"location":"false","aria-label":a.variant==="isStatus"?"Assignment status":`Question ${e+1}`,children:a.variant==="isStatus"?t(p,{}):e+1}),t(M,{variant:a.variant})]}),m=({steps:e,activeIndex:r,goToStep:a})=>t(I,{"aria-label":"Breadcrumbs",children:e.map((i,n)=>t(S,{index:n,isActive:n===r,step:i,goToStep:a},n))}),P=new Array(8).fill({variant:null}),A=["isIncorrect","isCorrect","isIncorrect","isIncorrect",null,null,null,null,"isStatus"],h={activeIndex:0,goToStep:(e,r)=>console.log(e,r),steps:A.map(e=>({variant:e}))},B=()=>t(m,{...h,steps:[...P,{variant:"isStatus"}]}),N=()=>t(m,{...h,activeIndex:4}),E=()=>t(m,{...h,activeIndex:2}),F=()=>t(m,{...h,activeIndex:8});typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{B as Default,N as InProgress,E as Review,F as StatusStep};
