...
`,r=i.exercises,f=r.reduce((e,t)=>({...e,[t.uuid]:e.questionCounter+1,questionCounter:e.questionCounter+t.questions.length}),{questionCounter:0}),u=e=>e.map(t=>{var n;return{id:t.id,correct_answer_id:((n=t.answers.find(a=>a.correctness==="1.0"))==null?void 0:n.id)||""}}),y={available_points:"1.0",is_completed:!0,answer_id:"1",free_response:"",feedback_html:"",correct_answer_feedback_html:"",attempts_remaining:0,attempt_number:1,incorrectAnswerId:0},E=()=>s(m,{children:[i.title&&s("h2",{children:["Exercises for ",i.title]},void 0,!0,{fileName:o,lineNumber:64,columnNumber:20},void 0),r.map(e=>{const t={id:1,uid:e.uid,available_points:"1.0"},n=u(e.questions).reduce((a,c)=>{const{id:d,correct_answer_id:l}=c;return{...a,[d]:{...y,correct_answer_id:l}}},{});return s(b,{children:s(p,{canAnswer:!0,needsSaved:!0,hasMultipleAttempts:!1,onAnswerChange:()=>{},onAnswerSave:()=>{},onNextStep:()=>{},apiIsPending:!1,canUpdateCurrentStep:!1,exercise:e,step:t,questionNumber:f[e.uuid],numberOfQuestions:r.length,questionStates:n,show_all_feedback:!0},e.uid,!1,{fileName:o,lineNumber:80,columnNumber:11},void 0)},e.uid,!1,{fileName:o,lineNumber:79,columnNumber:9},void 0)})]},void 0,!0);typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{E as Default};
