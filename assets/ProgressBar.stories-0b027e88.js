...
`,k=e=>{switch(e){case"isStatus":return d`
      ...
      `;default:return d`
        background-color: ${c.palette.neutralBright};
      `}},f="box-shadow: 0px 1px 4px 0px #00000066;",y=u.button`
  display: flex;
  justify-content: center;
  align-items: center;
...
`,$=u(p)`
  ...
  font-size: 1.2rem;
  border-radius: 50%;
`,M=({variant:e})=>{if(!e||e!=="isCorrect"&&e!=="isIncorrect")return null;const r={isCorrect:{icon:v.faCheck,color:c.answer.correct},isIncorrect:{icon:g.faXmark,color:c.answer.incorrect}}[e];return a($,{icon:r.icon,color:r.color,height:"16px",width:"16px"})},S=({index:e,isActive:r,step:t,goToStep:i})=>C(I,{children:[a(y,{variant:t.variant,isActive:r,onClick:()=>i(e,t),"aria-current":r?"location":"false","aria-label":t.variant==="isStatus"?"Assignment status":`Question ${e+1}`,children:t.variant==="isStatus"?a(b,{}):e+1}),a(M,{variant:t.variant})]}),m=({steps:e,activeIndex:r,goToStep:t})=>a(V,{"aria-label":"Breadcrumbs",children:e.map((i,n)=>a(S,{index:n,isActive:n===r,step:i,goToStep:t},n))}),P=new Array(8).fill({variant:null}),A=["isIncorrect","isCorrect","isIncorrect","isIncorrect",null,null,null,null,"isStatus"],h={activeIndex:0,goToStep:(e,r)=>console.log(e,r),steps:A.map(e=>({variant:e}))},B=()=>a(m,{...h,steps:[...P,{variant:"isStatus"}]}),N=()=>a(m,{...h,activeIndex:4}),E=()=>a(m,{...h,activeIndex:2}),F=()=>a(m,{...h,activeIndex:8});typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{B as Default,N as InProgress,E as Review,F as StatusStep};
