...
`,C=(e,r)=>{switch(e){case"isStatus":return s`
        color: ${r?o.palette.white:o.palette.darkGray};
        background-color: ${r?o.palette.darkGray:o.palette.neutralLight};
        border: none;
  ...
  font-weight: bold;
  cursor: pointer;
  ${e=>C(e.variant,e.isActive)}
`,h=({index:e,isActive:r,step:n,goToStep:c})=>t(g,{children:t(N,{variant:n.variant,isActive:r,onClick:()=>c(e,n),children:n.variant==="isStatus"?t(f,{},void 0,!1,{fileName:a,lineNumber:92,columnNumber:38},void 0):e+1},void 0,!1,{fileName:a,lineNumber:91,columnNumber:5},void 0)},void 0,!1,{fileName:a,lineNumber:90,columnNumber:3},void 0),l=({steps:e,activeIndex:r,goToStep:n})=>t(v,{children:e.map((c,d)=>t(h,{index:d,isActive:d===r,step:c,goToStep:n},d,!1,{fileName:a,lineNumber:97,columnNumber:31},void 0))},void 0,!1,{fileName:a,lineNumber:96,columnNumber:132},void 0);var i="/home/runner/work/assessment-components/assessment-components/src/components/ProgressBar.stories.tsx";const w=new Array(8).fill({variant:null}),x=["isIncorrect","isCorrect","isIncorrect","isIncorrect",null,null,null,null,"isStatus"],m={activeIndex:0,goToStep:(e,r)=>console.log(e,r),steps:x.map(e=>({variant:e}))},y=()=>t(l,{...m,steps:[...w,{variant:"isStatus"}]},void 0,!1,{fileName:i,lineNumber:12,columnNumber:30},void 0),k=()=>t(l,{...m,activeIndex:4},void 0,!1,{fileName:i,lineNumber:13,columnNumber:33},void 0),I=()=>t(l,{...m,activeIndex:2},void 0,!1,{fileName:i,lineNumber:14,columnNumber:29},void 0),S=()=>t(l,{...m,activeIndex:8},void 0,!1,{fileName:i,lineNumber:15,columnNumber:33},void 0);typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{y as Default,k as InProgress,I as Review,S as StatusStep};
