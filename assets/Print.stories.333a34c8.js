...
`,r=i.exercises,u=e=>e.map(t=>{var a;return{id:t.id,correct_answer_id:((a=t.answers.find(n=>n.correctness==="1.0"))==null?void 0:a.id)||""}}),y={available_points:"1.0",is_completed:!0,answer_id:"1",free_response:"",feedback_html:"",correct_answer_feedback_html:"",attempts_remaining:0,attempt_number:1,incorrectAnswerId:0},S=()=>s(p,{children:[i.title&&s("h2",{children:["Exercises for ",i.title]},void 0,!0,{fileName:o,lineNumber:62,columnNumber:20},void 0),r.map((e,t)=>{const a={id:1,uid:e.uid,available_points:"1.0"},n=u(e.questions).reduce((c,d)=>{const{id:l,correct_answer_id:h}=d;return{...c,[l]:{...y,correct_answer_id:h}}},{});return s(f,{children:s(b,{canAnswer:!0,needsSaved:!0,hasMultipleAttempts:!1,onAnswerChange:()=>{},onAnswerSave:()=>{},onNextStep:()=>{},apiIsPending:!1,canUpdateCurrentStep:!1,exercise:e,step:a,questionNumber:t+1,numberOfQuestions:r.length,questionStates:n,show_all_feedback:!0},e.uid,!1,{fileName:o,lineNumber:78,columnNumber:11},void 0)},e.uid,!1,{fileName:o,lineNumber:77,columnNumber:9},void 0)})]},void 0,!0);typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{S as Default};
